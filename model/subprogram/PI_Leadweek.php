 <?php  
      ...
      if (($Leadweek!="" && $Leadweek!="&nbsp;" && $Leadweek<=$yearWeek ) || ($Leadtime!="" && $Leadtime!="&nbsp;" )){
         ...
         if ($PIWeek>0){
		      ...
		      $Leadweek="<div style='color:$PI_Color;'>$weekName</div><div style='font-size:10px;color:#AAAAAA'>$dateSTR</div>";
		      $Leadweek_Span="<span style='color:$PI_Color;'>$weekName</span><span style='font-size:10px;color:#555555'>($dateSTR)</span>";
	      }
      }else{
	      
	      $Leadweek ="<span class='redB'>未设置</span>";
      }
?>