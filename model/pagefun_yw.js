...
function ShowCutHide(e,f,Cut_Rows,POrderId,StuffId,OrderQty,RowId,Id){  
//显示或隐藏产品配件BOM关系表
	e.style.display=(e.style.display=="none")?"":"none";
	var yy=f.src;
	if (yy.indexOf("showtable")==-1){
		...
		if(POrderId!=""){			
			var url="../admin/yw_order_cutbom_ajax.php?POrderId="+POrderId+"&StuffId="+StuffId+"&RowId="+RowId+"&OrderQty="+OrderQty; 
			//alert(url);
...
function GetDateToWeek(strDate){
   var week ="";
    if (strDate!=""){
		    var totalDays = 0;
		    now = getDate(strDate);
