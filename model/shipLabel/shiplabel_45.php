...
if ($TestSign==1){
	$eCode="00137636";
	$Description="CO CLEAR SAM S6, GE<br>CO CLEAR SAM S6, YEs(ABCDEFG)";
	$OrderPO="2157331";
	$BoxPcs=1;
	$InBoxPcs=15;
...
$otherDescription="";
$tmpArrayD=explode("(", $Description);
if(count($tmpArrayD)>1){
	$Description=$tmpArrayD[0];
	$krightDArray=explode(")",$tmpArrayD[1]);
	$otherDescription=$krightDArray[0];
}
            ...
            <TR height='43'>
             ...
             <TR height='10'>
              ...
              <TR height='40'>
               ...
               <TR height='40'>
                  <TD  width='220' colspan='3'><div style='$DivStyle width:325;height:40;'><span style='margin:2px 0px 0px 5px;display:block;'>$Description</span></div> </TD>
              </TR>
              <TR height=''>
                  <td colspan='4'>
               ...
               <TR height='15'>
                  <TD  colspan='4'><span style='font-family:Arial;font-size:14px;font-weight:bold;' >www.hama.com  &nbsp; &nbsp; &nbsp; &nbsp; $otherDescription </span></TD>
              </TR>  	
             </TBODY>	
</TABLE>";
//echo "</div>";
