                 ...
                 <TD  width='278' align='center'  valign='Top'>
                     <TABLE style='WORD-WRAP: break-word'  cellSpacing=0 cellPadding=0 width='275' border=0>
                        <TR >
                         ...
                         <TR>
				            <TD class='td_line52' width='60'><span class='Font_title'>&nbsp;Qty:</span></TD>
                          ...
                          <TR>
                           ...
                           <TR>
				              ...
				              <TD class='td_line30'colspan='2'>
                                    <span class='Font_val'>$OrderPO</span>&nbsp;&nbsp;&nbsp;<span class='Font_title'>&nbsp;</span>
                              </TD>
			              </TR>    
						   <TR>
				              <TD colspan='3' class='td_line30' ><span class='Font_title'>SUPPLIER NAME:WHITE DIAMONDS</span></TD>
			              </TR>     
                       </TABLE>   
                </TD>
                 <TD width='8' class='td_right'>&nbsp;</TD> 
                  <TD   width='266' align='center' valign='Top'>
					  ...
					  <TR height='60'>
				         ...
				         <TR height='65'>
				             <TD  colspan='4' align=center>
                                 <div class='dashed_div'><span class='Font_val'>SHIP TO: ASCENDEO</span></div>
                            </TD>
			            </TR>   		
		             </TABLE>
                  </TD>        
