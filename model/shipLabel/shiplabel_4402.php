	       ...
	       <tr>
              ...
              <tr>
                ...
                <table  width='100%' height='100%' border='0' cellSpacing=0 cellPadding=0 style='WORD-WRAP: break-word;font-size:14px;'>
                	...
                	<tr>
                    <td height='75' style='font-size:32px;font-weight:bold'>&nbsp;$EoNo - Cartons:$BoxTotal <br />&nbsp;QD Cellular(Pty) Ltd</td>
                    </tr>
                                                                                
                </table>
                
                </td>
                <td class='A0011' align='center' style='font-size:20px; font-weight:bold'><img src='../model/shipLabel/$cPic'  height='180' /></td>
             </tr>
         </table>";
//echo "</div>"; <td class='A0011' align='center' style='font-size:20px; font-weight:bold'><img src='../model/shipLabel/asiaxessQ.png'  height='180' /></td>
?>