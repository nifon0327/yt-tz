      ...
      //if($LabelModel==3){$numberTemp=$PackingRemark*$BoxPcs;$SPR=" SPR($numberTemp PCS)";}
		...
		if(is_numeric($BoxCode0)){	
			...
			if(is_numeric($BoxCode1)){
				$BoxCodeTable="<table width='100%'  cellspacing='0'><tr><td align='center' valign='top'><iframe frameborder=0 marginheight=0 marginwidth=0 scrolling=no width='120' height='40'  src='ean_13code.php?Code=$BoxCode1&lw=1&hi=25'></iframe></td></tr><tr><td height='22' valign='bottom' scope='col'><div align='center' style='font-size:20px' class='codebig'>$Made
				</div></td></tr></table>";
			  }
			 else{
