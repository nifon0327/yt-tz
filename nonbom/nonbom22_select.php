...
ChangeWtitle("$SubCompany 非BOM个人报废记录查询");			//需处理
...
<TR>
                  <TD align="right">报废人员
                    <input name="Field[]" type="hidden" id="Field[]" value="BfNumber">
                  </TD>
                  <TD align="center">
                    <select name="fun[]" id="fun[]" style="width: 60px;">
				  ...
				  <select name=value[] id="value[]" style="width: 380px;">
                    ...
                    <?php 
                        $CheckOutResult=mysql_query("SELECT M.Number,M.Name FROM $DataIn.nonbom8_bf  B
                         LEFT JOIN $DataPublic.staffmain M ON M.Number=B.BfNumber WHERE M.Estate=1",$link_id);
