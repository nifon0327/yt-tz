...
//步骤2：
ChangeWtitle("$SubCompany 非BOM采购预付订金查询");			//需处理
...
//步骤4：需处理
$CheckTb="$DataIn.nonbom11_djsheet";
?>
			...
			?>
                <TR>
                  ...
                  <TD><select name=value[] id="value[]" style="width:380px">
                      <option value="" selected>全部</option>
						<?php 
						$checkSql = "SELECT A.CompanyId,B.Forshort,C.Symbol 
						...
						GROUP BY A.CompanyId ORDER BY B.Forshort";
