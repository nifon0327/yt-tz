...
$Parameter="Id,$Id,funFrom,$funFrom,From,$From,Pagination,$Pagination,Page,$Page,GoodsId,$GoodsId,oldQty,$Qty,ActionId,158";
//步骤5：//需处理
?>
	...
	<tr><td class="A0011">
      <table width="100%"  border="0" align="center" cellspacing="0" >
		...
		<tr>
			...
			<td valign="middle" scope="col" ><?php echo $GoodsName.$Info?><input  id="PropertySign" name="PropertySign" type="hidden" value="<?php echo $PropertySign?>"></td>
		</tr>
        <!--<tr>
     ...
     <tr>
       ...
       <tr>
			<td align="right" >本次报废：</td>
			<td  ><input  id="thisbfQty" name="thisbfQty" type="text" size="14" onblur="CheckNum(this,<?php echo $MaxQty?>)"></td>
		</tr>
        ...
        <tr>
          ...
          <td ><textarea name="Remark" rows="3" id="Remark" style="width: 380px;" dataType='Require' msg='未填写'></textarea></td>
        </tr>
	  </table>
</td></tr></table>
	...
	<tr>
		...
		<td colspan="5" align="center" class="A0111" id="ShowInfo">	
                   ...
                   while($ListRows= mysql_fetch_array($sListResult)){
                          ...
                          echo"<tr bgcolor='$theDefaultColor'><td  align='center' height='20' width='50' class='A0101'><input name='bfCode[]' type='checkbox' id='bfCode$i' value='$BarCode'  $disabledStr ></td>";
