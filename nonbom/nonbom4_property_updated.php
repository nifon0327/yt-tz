...
//步骤2：
$Log_Item="非BOM配件属性";		//需处理
$upDataSheet="$DataPublic.nonbom4_propertytype";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		$Name=FormatSTR($Name);
		$SetStr="TypeName='$Name',TypeColor='$SelColor',rColor='$RGB[r]',gColor='$RGB[g]',bColor='$RGB[b]',Date='$DateTime',Operator='$Operator',Locks='0'";
