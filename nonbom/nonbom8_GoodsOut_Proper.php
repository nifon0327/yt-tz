...
C.mStockQty,C.oStockQty,D.TypeName,A.Date ,W.Name AS WorkName,A.GetNumber,G.Name AS GetName
	...
	WHERE A.Id  IN ($Ids)  LIMIT 1",$link_id));
...
$Parameter="Ids,$Ids,funFrom,$funFrom,From,$From,Pagination,$Pagination,Page,$Page,GoodsId,$GoodsId,oldQty,$Qty,Estate,$Estate,ActionId,130";
?>
