...
//步骤2：
ChangeWtitle("$SubCompany 非bom配件个人申领");//需处理
...
$myRow=mysql_fetch_array(mysql_query("SELECT Name FROM $DataPublic.staffmain  WHERE Number='$Login_P_Number'",$link_id));
$Name=$myRow["Name"];
//步骤4：需处理
?>
...
<tr><td class="A0011">
	<table width="850" border="0" align="center" cellspacing="0" id="NoteTable" >
        ...
        <tr>
			<td height="22" colspan="2" align="right" valign="middle" scope="col">可用库存</td>
      ...
      <!--  <tr valign="top">
          ...
          <td colspan="5"><input name="checkBack[]" type="text" id="Qty3" style="width: 380px;"  title="必填项,输入正整数" datatype='Number'  msg="没有填写或格式错误" value="" readonly="readonly"/></td>
           ...
           <td colspan="7"><select name='WorkAdd' id='WorkAdd' style='width:380px' dataType='Require' msg='未选择'><option value="" selected>--请选择--</option>
				 <?php 
       ...
       <tr>
        ...
        <tr >
            ...
            <td colspan="5"> <input name="Name" type="text" id="Name" style="width:380px;"  dataType='Require' msg='未填写' value="<?php echo $Name?>" readonly>
                <input name='Number' type='hidden' id='Number'  value="<?php echo $Login_P_Number ?>">
			</td>
       </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
 <input name="Button1" id="Button1" type="button" value="申&nbsp;&nbsp;领" onClick="Validator.Validate(document.getElementById(document.form1.id),3,'',0)"/></label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="Button2" id="Button2" type="button" value="申&nbsp;&nbsp;购" onClick="BuyNewGoods()" style="display:none;"/></td>
        </tr>
        <tr>
          <td colspan="7"><span class="redB">申领列表如下：</span></td>
        </tr>
        <tr bgcolor="#CCCCCC">
        ...
        <tr>
          <td colspan="7" height="200" class="A0100"><div style="width:100%;height:100%;overflow-x:hidden;overflow-y:scroll; margin-top:-1px;">
        ...
        <tr>
          <td colspan="7" height="50"><span class="blueB">申购列表如下：</span></td>
        </tr>
        ...
        <tr bgcolor="#CCCCCC">
          ...
          <td width="220" align="center" class="A1101">名称</td>
          <td width="40" align="center" class="A1101">单位</td>
          <td width="50" align="center" class="A1101">申购数量</td>
          <td width="100" align="center" class="A1101">申购人</td>
          <td width="330" align="center" class="A1100">备注</td>
        </tr>
        
        <tr>
          <td colspan="7" height="200" class="A0100"><div style="width:100%;height:100%;overflow-x:hidden;overflow-y:scroll; margin-top:-1px;">
          <table width="850" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="BuyNewTB">
          	<tr>
            	<td width="41'"></td>
          		<td width="71"></td>
          		<td width="218"></td>
...
function checkGoods(){
	...
	var url="nonbom5_ajax.php?checkName="+encodeURI(TempName)+"&sid="+Math.random(); 
			...
			if(BackData!=""){
				...
				for(var i=0;i<obj.length;i++){
					obj[i].value=DataArray[i];
                       if(obj[i].id=="oQty" && DataArray[i]==0){
...
function  BuyNewGoods(){
                var  GoodsId=document.getElementById("GoodsId").value;
                 var  GoodsName=document.getElementById("GoodsName").value;
                 var  Unit=document.getElementById("Unit").value;
                 var  newNumber=document.getElementById("Number").value;
				var returnValue =window.showModalDialog("nonbom8_single_buynew.php?GoodsId="+GoodsId+"&GoodsName="+GoodsName,window,"dialogWidth=500px;dialogHeight=300px");
				//alert ("1");
				//alert(returnValue);
	...
	if (returnValue && returnValue!=undefined){
             ...
             var NewQty=tempArray[0];
             var NewCompanyId=tempArray[1];
             var NewmainType=tempArray[2];
             var NewBuyerId=tempArray[3];
             var NewPrice=tempArray[4];
             var NewRemark=tempArray[5];
	        var url="nonbom5_save.php?GoodsId="+GoodsId+"&Qty="+NewQty+"&Price="+NewPrice+"&CompanyId="+NewCompanyId+"&BuyerId="+NewBuyerId+"&Remark="+encodeURI(NewRemark)+"&sid="+Math.random(); 
	alert(returnValue)
	var ajax=InitAjax(); 
	ajax.open("GET",url,true); 
	ajax.onreadystatechange =function(){
		if(ajax.readyState==4 && ajax.status == 200){
			if(ajax.responseText==1){
				//输出至列表％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％
				//A、表格行处理
				var RowNum=(BuyNewTB.rows[1].cells[0].innerText)*1+1;	//新增行的序号
				var addRow=BuyNewTB.insertRow(1);						//首行处新增一行
				oTD=addRow.insertCell(0);
					oTD.height="25";	
					oTD.align="center";
					oTD.className ="A0101";
				...
				oTD=addRow.insertCell(4);
					oTD.align="center";
					oTD.className ="A0101";
					oTD.innerHTML=NewQty;						//数量
				oTD=addRow.insertCell(5);
					oTD.align="center";
					oTD.className ="A0101";
					oTD.innerHTML=newNumber;					//申购人

				oTD=addRow.insertCell(6);
					oTD.align="center";
					oTD.className ="A0100";
					oTD.innerHTML=NewRemark;				//备注
				//超出100行则删除最后一行
				var LastRow=BuyNewTB.rows.length;
				if(BuyNewTB.rows[LastRow-1].cells[0].innerText*1==0){
					BuyNewTB.deleteRow(LastRow-1);
					}	
			//％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％％
			 	}
			   }
