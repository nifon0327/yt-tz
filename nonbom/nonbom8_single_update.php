...
//步骤2：
ChangeWtitle("$SubCompany 更新非bom配件个人申领记录");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT A.GoodsId,A.Qty,A.WorkAdd,A.Remark,A.Locks,A.Estate,B.GoodsName,B.BarCode,B.Unit,C.wStockQty,
C.mStockQty,C.oStockQty,D.TypeName,A.Date 
...
if($Estate==0){
	$Info="<span class='redB'>物品已发放，不能更新.</span>";
	$SaveSTR="NO";
	}
	...
	<tr><td class="A0011">
      <table width="100%" height="250" border="0" align="center" cellspacing="0" id="NoteTable" >
		<tr>
			...
			<td valign="middle" scope="col" class="blueB"><?php echo $GoodsName;?></td>
		</tr>
        <tr>
