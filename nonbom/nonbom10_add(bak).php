...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
	<table width="850" border="0" align="center" cellspacing="0" id="NoteTable" >
        ...
        <tr>
			<td height="22" colspan="2" align="right" valign="middle" scope="col">报废数量</td>
        ...
        <tr>
          <td colspan="2" align="right" valign="top">报废备注</td>
        ...
        <tr>
          ...
          <td colspan="5" align="center"><label>
            <input name="Button" type="button" value="报废" onClick="Validator.Validate(document.getElementById(document.form1.id),3,'',0)"/>
          </label></td>
        </tr>
        <tr>
          <td colspan="7">报废列表如下：</td>
        </tr>
        <tr bgcolor="#CCCCCC">
          ...
          <td width="50" align="center" class="A1101">报废数量</td>
...
function checkThisPage(){
	...
	if(TempQty<=TempwQty && TempQty<=TempoQty && TempQty>0){
		...
		var url="nonbom10_save.php?GoodsId="+TempGoodsId+"&Qty="+TempQty+"&Remark="+TempRemark+"&sid="+Math.random(); 
		var ajax=InitAjax(); 
		ajax.open("GET",url,true); 
		ajax.onreadystatechange =function(){
			if(ajax.readyState==4 && ajax.status == 200){
