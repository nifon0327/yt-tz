...
ChangeWtitle("$SubCompany 非bom领用配件转出");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_turn";	
	...
	<tr><td class="A0011">
     ...
     <tr>
       ...
       <tr>
			...
			<td  ><input  id="turnQty" name="turnQty" type="text" style="width:100px;" onblur="CheckNum(this,<?php echo $MaxQty?>)"></td>
		</tr>

        <tr >
            <td align="right" >接收人员：</td>
            <td> <input name="InName" type="text" id="InName" style="width:300px;"  >
                <input name='InNumber' type='hidden' id='InNumber' >
			</td>
       </tr>
	...
	<tr>
		...
		<td colspan="5" align="center" class="A0111" id="ShowInfo">	
                   ...
                   while($ListRows= mysql_fetch_array($sListResult)){
                          ...
                          echo"<tr bgcolor='$theDefaultColor'><td  align='center' height='20' width='50' class='A0101'><input name='turnCode[]' type='checkbox' id='turnCode$i' value='$BarCode'  $disabledStr ></td>";
