...
$upDataSheet="$DataPublic.nonbom3_retailer";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$SetStr="Company='$Company',Linkman='$Linkman',Tel='$Tel',Currency='$Currency',Remark='$Remark',Date='$DateTime',Operator='$Operator',Locks='0'";
