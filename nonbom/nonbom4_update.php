...
//步骤3：//需处理
$upData = mysql_fetch_array(mysql_query("SELECT A.GoodsId,A.GoodsName,A.Price,A.Unit,A.TypeId,A.Attached,A.CkId,A.nxId,A.pdDate,A.brand,
        ...
        <td class="A0011">
            <table width="750" height="95" border="0" align="center" cellspacing="5" id="NoteTable">
                ...
                <tr>
                    ...
                    <td>
                        <input name="NameRule" id="NameRule" value="<?php echo $NameRule; ?>"
                               style="width:380px;border:0px;color:red" readonly/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="brand" type="text" id="brand" style="width:380px;" dataType="Require" msg="未填写" value="<?php echo $brand ?>" >
                    </td>
                </tr>

                <tr>
                    <td align="right">默认供应商</td>
                    <td><input name="Forshort" type="text" id="Forshort" style="width:380px;" dataType="Require" msg="未填写" value="<?php echo $CompanyId . "-" . $Forshort ?>" onclick="ChooseCompany()" onblur="LoseFocus()">
                        <input name='CompanyId' type='hidden' id='CompanyId' value="<?php echo $CompanyId ?>">
                        <input type="checkbox" id="DefaultCompany" name="DefaultCompany" onclick="SetDefaultCompany(this,1)">
                    </td>
                </tr>
             ...
             LEFT JOIN $DataPublic.nonbom3_retailermain  M  ON D.CompanyId=M.CompanyId WHERE D.GoodsId=$GoodsId", $link_id);
                ...
                <tr <?php echo $HiddenStr ?> id='GetSignHidden'>
                    ...
                    <td scope="col">
                        <input name="GetSign[]" type="checkbox" value="1" onclick="checkSign(1)" <?php echo $GetSign1 ?>>
                        <span class="redB">是</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="GetSign[]" type="checkbox" value="0" onclick="checkSign(0)" <?php echo $GetSign0 ?> >
                        <span class="blueB">否</span>
                </tr>
                <tr <?php echo $HiddenStr ?> id='GetQtyHidden'>
                    ...
                    <td valign="middle" scope="col">
                        <input name="GetQty" type="text" id="GetQty" style="width: 380px;" value="<?php echo $GetQty ?>"/>
                        <span class="redB">(下单数量多少PCS)</span>
                    </td>
                </tr>
			  ...
			  <td scope='col'><input name='oldAttached' type='checkbox' id='oldAttached' value='1'><LABEL for='oldAttached'> 删除已传图片</LABEL></td></tr>";
                ...
                <tr>
                    ...
                    <td><select name="AssetType" id="AssetType" style="width: 380px;" dataType="Require" msg="未选择资产类型"
                                onchange="ShowDepreciation(this)">
                ...
                <tr>
                    ...
                    <td><input name="WxForshort" type="text" id="WxForshort" style="width:380px;"
                               value="<?php echo $WxForshort ?>">
