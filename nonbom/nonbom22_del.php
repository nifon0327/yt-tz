...
LEFT JOIN nonbom8_bffixed F ON F.BarCode=C.BarCode
LEFT JOIN nonbom8_bf  B ON B.Id=F.BfId
SET C.Estate=2
...
LEFT JOIN $DataIn.nonbom8_bffixed F ON F.BfId=B.Id
WHERE  B.Id IN ($Ids) AND B.Estate=1";
