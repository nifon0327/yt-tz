...
$ColsNumber=5;				
$tableMenuS=600;
ChangeWtitle("$SubCompany 非BOM配件属性设置");
$funFrom="nonbom4_property";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|50|序号|50|属性名称|100|文字颜色|100|可用|60|操作员|80";
...
$mySql="SELECT * FROM $DataPublic.nonbom4_propertytype Ａ WHERE 1 $SearchRows ORDER BY Ａ.Id";
