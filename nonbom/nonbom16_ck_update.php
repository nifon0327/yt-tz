...
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT Name,Number,Remark,TypeId FROM $DataPublic.nonbom0_ck WHERE Id='$Id' LIMIT 1",$link_id));
$Name=$upData["Name"];
$Number=$upData["Number"];
$Remark=$upData["Remark"];
$TypeId=$upData["TypeId"];
$TypeIdStr="TypeId".$TypeId;
$$TypeIdStr="selected";
//步骤4：
      ...
      <table width="750" height="140" border="0" align="center" cellspacing="5">
		...
		<tr>
			...
			<td valign="middle" scope="col"><select name="TypeId"  id="TypeId" style="width:380px;" dataType="Require"  msg="未选择">
              ...
              <option value="0" <?php echo $TypeId0?>>共享</option>
              <option value="1" <?php echo $TypeId1?>>仓库</option>
              <option value="2"  <?php echo $TypeId2?>>使用地点</option>
            </select>
			</td>
		</tr>
