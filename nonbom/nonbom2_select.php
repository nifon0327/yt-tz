...
//步骤2：
ChangeWtitle("$SubCompany 非BOM配件子分类");			//需处理
...
//步骤4：需处理
$CheckTb="$DataPublic.nonbom2_subtype";
?>
		...
		<td class="A0011">
          ...
          value=!=>!=</OPTION>
                ...
                value="isStr" />
                  ...
                  <TR>
                  <TD width="105" align="right">命名规则
                      <input name="Field[]" type="hidden" id="Field[]" value="NameRule">
                  </TD>
                  <TD width="87" align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <option value="LIKE" selected>包含</option>
          ...
          value=!=>!=</OPTION>
                ...
                <TR>
                  <TD align="right">主分类
                    <input name="Field[]" type="hidden" id="Field[]" value="mainType">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          ...
          value="<=">&lt;=</OPTION>
                ...
                <tr>
                  <td align="right">采 购 员
                    <input name="Field[]2" type="hidden" id="Field[]2" value="BuyerId" /></td>
                ...
                <tr>
                  <td align="right">申购初审
                    <input name="Field[]2" type="hidden" id="Field[]2" value="CheckerId" /></td>
                  <td align="center"><select name="fun[]2" id="fun[]2" style="width: 60px;">
                    <option value="=" selected="selected">=</option>
                    <option value="!=">!=</option>
                  </select></td>
