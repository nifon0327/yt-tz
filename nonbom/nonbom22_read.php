...
$ColsNumber=10;
ChangeWtitle("$SubCompany 非bom配件个人领用报废记录");
$funFrom="nonbom22";
$From=$From==""?"read":$From;
$Th_Col="选项|60|序号|30|分类|80|编码|50|非bom配件名称|350|单位|40|报废数量|60|报废原因|250|附件|40|报废人|60|报废时间|70|状态|50";
...
if($Single==1){
	$SearchRows=" AND  A.BfNumber='$Login_P_Number'";
   }
...
LEFT JOIN $DataPublic.staffmain M ON M.Number=A.BfNumber
