...
$funFrom="nonbom23_total";
$From=$From==""?"read":$From;
$TurnSign=$TurnSign==""?2:$TurnSign;
      $Th_Col="选项|60|序号|30|分类|80|编码|50|非bom配件名称|350|单位|40|转出数量|60|转出原因|250|转出时间|70|转出人员|60|接收人员|60|状态|50";
     $ActioToS="1";
	...
	do{
       ...
       if($CheckCodeId!=""){
		...
		$ValueArray=array(
			...
			array(0=>$OutName,1=>"align='center'"),
			array(0=>$InName,1=>"align='center'"),
