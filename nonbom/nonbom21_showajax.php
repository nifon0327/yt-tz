...
echo "<table width='680' border='0' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF' >
      ...
      <td height='80' colspan='2' align='center'  style='Font-size:18px;'>&nbsp;</td>
       ...
       <td width='60'>退回数量:</td> <td width='170'>$backQty</td> 
       </tr></table>";
echo"
...
<td class='A0101' width='250' align='center'>退回原因</td>
<td class='A0101' width='80' align='center' >退回数量</td>
<td class='A0101' width='80' align='center'>退回时间</td>
<td class='A0101' width='60' align='center'>退回人</td>
...
if($FixedRow=mysql_fetch_array($FixedResult)){
       ...
       do{
                ...
                $GoodsNum  =$FixedRow["GoodsNum"];   
                 ...
                 $NumsResult=mysql_fetch_array(mysql_query("SELECT COUNT(*) AS Nums FROM $DataIn.nonbom8_rebackfixed F  LEFT JOIN $DataIn.nonbom8_reback B  ON B.Id=F.BackId WHERE BillNumber=$BillNumber ",$link_id));
