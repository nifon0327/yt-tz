...
$ColsNumber=10;
ChangeWtitle("$SubCompany 非bom配件个人领用退回仓库记录审核");
$funFrom="nonbom21";
$From=$From==""?"m":$From;
$Th_Col="选项|60|序号|30|分类|80|编码|50|非bom配件名称|350|单位|40|退仓数量|60|退仓原因|250|附件|40|退仓时间|70|状态|50|申请退回人|70";
...
$mySql="SELECT A.Id,A.GoodsId,A.Qty,B.GoodsName,B.Attached,B.Unit,C.TypeName,A.Date,A.Estate,A.Operator,A.Remark,E.Name AS BackName,A.Picture
...
LEFT JOIN $DataPublic.staffmain E ON E.Number=A.BackNumber
      ...
      $Picture=$myRow["Picture"];
       if($Picture!=""){
		...
		$ValueArray=array(
			...
			array(0=>$BackName,1=>"align='center'")
			);
		$checkidValue=$Id;
