...
//步骤2：
ChangeWtitle("$SubCompany 非BOM配件供应商");			//需处理
...
//步骤4：需处理
$CheckTb="$DataPublic.nonbom3_retailer";
?>
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
                <TR>
                  <TD width="105" align="right"><p>供应商编号
                      <input name="Field[]" type="hidden" id="Field[]" value="CompanyId">
                  </TD>
                  <TD width="87" align="center"><select name="fun[]2" id="fun[]2" style="width: 60px;">
                    <option value="=" 
          ...
          value="&lt;=">&lt;=</option>
                ...
                value="umisStr" />
                         ...
                         <TR>
                  <TD width="105" align="right"><p>供应商名称
          ...
          value=!=>!=</OPTION>
                ...
                value="isStr" />
                         ...
                         <TR>
                  <TD width="105" align="right"><p>联系人
          ...
          value=!=>!=</OPTION>
                ...
                value="isStr" />
                         ...
                         <TR>
                  <TD width="105" align="right"><p>联系电话
