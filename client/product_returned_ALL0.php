	...
	do {
		...
		*/
		...
		if($ReturnedQty>0 && $ShipQtySum>0){
			...
			$ReturnedP=
			$TempInfo2="style='CURSOR: pointer;' onclick='ViewChart($ProductId,2)' title=\" Qty：$ReturnedQty  Rate：$ReturnedPercent ‰\"";
			}
		else{
			//$ReturnedQty="&nbsp;";
			$TempInfo2="";
...
if($flag==1){
	...
	echo "<tr>";
	echo "<td class='A0111' width=220 align='center' height='30'>Qty:</td>";
	echo "<td class='A0101' width=250 align='center' height='30'>$SumToTal</td>";	
	echo "<td class='A0101' align='center' height='30'>Total Amount:</td>";
