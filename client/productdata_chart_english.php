...
<table width="897" border="0" cellpadding="0" cellspacing="0" style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word'>
  <tr align="center" bgcolor="#CCCCCC">
    <td width="100" class="A1111" height="20">No.</td>
  	<td width="197" class="A1101">Y/M</td>
    <td width="200" class="A1101">Order Qty</td>
    <td width="200" class="A1101">Shipped Qty</td>
	<td width="200" class="A1101">Pending</td>
  </tr>
  <tr>
		...
		$shipSum=0;
		  if($checkRow=mysql_fetch_array($checkSql)){
			do{
				...
				echo"<tr align=\"center\"><td class=\"A0101\" height=\"20\" width=\"100\">$i</td>
			...
			echo"<tr><td height=\"20\" align=\"center\" width=\"750\">No.List</td></tr>";
			}
		?>
	</table>
	</div>
	...
	if($i>1){
		...
		$unQty=$unQty==0?"0":"<span class=\"redB\">".$unQty."</span>";
		$shipSum=$shipSum==0?"0":"<span class=\"greenB\">".$shipSum."</span>";
		$orderSum=$orderSum==0?"0":"<span class=\"blueB\">".$orderSum."</span>";
		echo"<tr align=\"center\" bgcolor=\"#CCCCCC\"><td class=\"A0111\" height=\"20\">Total:</td><td class=\"A0101\">&nbsp;</td><td class=\"A0101\">$orderSum</td><td class=\"A0101\">$shipSum</td><td class=\"A0101\">$unQty</td><td  class=\"A1101\">&nbsp;</td>";
		}
	?>
</table>
<?php   
	...
	if($checkReturnedRow=mysql_fetch_array($checkReturnedSQL)){
		...
		$ListTR.="<tr bgcolor=\"#CCCCCC\" height=\"20\">
			<td class=\"A0111\" align=\"center\">Total</td>
    ...
    <td width=\"100\" align=\"center\">Rates:$ReturnedPercent</td>
	<td colspan=\"2\"  align=\"right\">$eCode</td>
  	</tr>
  	<tr align=\"center\" bgcolor=\"#CCCCCC\">
    <td class=\"A1111\" height=\"20\">No.</td>
  	<td class=\"A1101\">Y/M</td>
    <td class=\"A1101\">Rejected QTY</td>
    <td class=\"A1101\">Price</td>
	<td class=\"A1101\">Amount</td>
  	</tr> $ListTR";
	}
