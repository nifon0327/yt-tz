...
//$Th_Col="选项|40|序号|30|月份|50|部门|50|职位|50|员工ID|50|姓名|50|应到<br>工时|38|实到<br>工时|38|1.5倍<br>工时|38|2倍<br>工时|38|迟到<br>次数|38|迟到<br>次数|38|事假|38|病假|38|有薪|45|无薪|45|缺勤<br>工时|38|无效<br>工时|38|旷工<br>工时|38|有薪<br>工时|38|夜班<br>次数|38";
...
if($From!="slist"){
	$SearchRows ="";
	$date_Result = mysql_query("SELECT Month FROM $DataIn.kqdataother WHERE 1 group by month order by Id DESC",$link_id);
