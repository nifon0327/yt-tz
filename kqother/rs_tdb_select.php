...
//步骤2：
ChangeWtitle("$SubCompany 部门调动资料查询");			//需处理
...
<TR>
          ...
          selected>=</OPTION>
                  ...
                  <TD width="343"><select name=value[] id="value[]" style="width: 274px;">
                    <option value="" selected>全部</option>
					<?php 
					$outResult=mysql_query("SELECT Id,Name FROM $DataPublic.branchdata WHERE Estate=1 order by Id",$link_id);
