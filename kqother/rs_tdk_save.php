...
if($DataIn !== 'ac'){
	...
	$inRecode = "INSERT INTO $DataPublic.redeployk SELECT NULL,Number,'$KqSign','$ActionIn','$Month','$Remark','$Date','0','$Operator', 0, '$Operator', '$Date', '$Operator', '$Date' FROM $DataPublic.staffmain WHERE 1 $NumberSTR ";
}
