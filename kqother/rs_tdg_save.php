...
for($i=0;$i<$Count;$i++){
	...
	if($DataIn !== 'ac')
		...
		$inRecode = "INSERT INTO $DataPublic.redeployg SELECT NULL,'$Number',Grade,'$Grade','$Month','$Remark','$Date','0','$Operator', 1, 0, '$Operator', '$Date', '$Operator', '$Date' FROM $DataPublic.staffmain WHERE 1 AND Number='$Number' AND Grade!='$Grade'";
	}
