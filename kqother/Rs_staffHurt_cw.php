...
$funFrom="Rs_staffHurt";		//必选参数：功能模块
...
switch($Estate){
	case "0":			//已结付处理
		ChangeWtitle($SubCompany.$Log_Item."已结付记录");
			$Th_Col="更新|35|结付日期|75|结付凭证|35|结付备注|35|结付总额|70|结付银行|100|选项|40|序号|40|员工姓名|60|部门|80|职位|60|入职日期|70|金额|60|工伤日期|80|工伤凭证|30|费用凭证|30|状态|60";
		$EstateSTR0="selected";
		$ActioToS="1,15,16";
		$MergeRows=6;
