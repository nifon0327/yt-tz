...
if($_POST['ListId']){//如果指定了操作对象
	...
	for($i=0;$i<$Counts;$i++){
         ...
         $inRecode ="INSERT INTO $DataIn.cw18_workhurtsheet(Id, Mid,CheckT,Number,Month,AllAmout,SSecurityAmout,PSecurityAmout,Amount,Remark,Attached,HostpitalInvoice,SSecurityInvoice,HurtDate,Date,Estate,Locks,Operator)VALUES(NULL,0,'$CheckTime','$thisId','$Month','$AllAmout','$SSecurityAmout','$PSecurityAmout','$Amount','$Remark','$Attached','$HostpitalInvoice','$SSecurityInvoice','$HurtDate','$Date',1,0,'$Operator')";
