...
if($Id!=""){
	...
	//取得送货楼层
    $FloorResult=mysql_query("SELECT F.SendFloor FROM $DataIn.stuffdata F  					            LEFT JOIN $DataIn.cg1_stocksheet H ON F.StuffId=H.StuffId 
    ...
    <tr align="left" valign="top">
      	<td colspan=2 class="A1000">
			<table border=0 cellpadding=0 cellspacing=0 style="TABLE-LAYOUT: fixed; WORD-WRAP: break-word">
			  ...
			  <tr>
				...
				<td class="A0100" style="width:500px"><?php  echo $StuffCname;?></td>
		  ...
		  <?php 
            ...
            <tr>
              ...
              <td colspan="5" class="A0100" align="right"><?php  echo $PreChar?> <?php  echo $TotalAmount?><br>(大写:<?php  echo $out;?>)</td>
            </tr>
			<tr>
