...
* 
*/ 
class  NewReadedModel extends MC_Model {
...
*/  
	public function save_item($params) {
		...
		*/	
		...
		$checkHas = " select Id from new_readed where Reader=$liker and NewId=$newidIn ";
		...
		$this->db->trans_begin();
		$query=$this->db->update('new_readed', $data);
		...
		if ($this->db->trans_status() === FALSE){
			 ...
			 $this->db->trans_begin();
		$query     = $this->db->insert('new_readed', $data); 
