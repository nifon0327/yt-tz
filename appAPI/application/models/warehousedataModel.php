...
class  WarehousedataModel extends MC_Model {
    ...
    {
	    $sql = 'SELECT Id,Name,CheckSign,BlWorkShopId,Remark,Address,Estate,Locks FROM warehousedata WHERE Id=? LIMIT 1';
    ...
    {
	   $sql = 'SELECT Id,Name,CheckSign,BlWorkShopId FROM warehousedata WHERE Estate=1';
    ...
    function get_warehouse($getSign,$semiSign,$setTypeId,$params='') {
	    ...
	    $query = $this->db->get('warehousedata');
