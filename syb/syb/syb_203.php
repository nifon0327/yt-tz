...
$Parameters="";
//add by cabbage 20141128 在iphone上呈現時，是依據company做排序
...
echo"
	...
	<tr><td height='450px'>";
		...
		A.Month,A.StockId,A.OrderQty,A.Price,A.Amount,(A.Amount*C.Rate) AS AmountRMB,A.Estate,A.BuyerId,B.Forshort,C.Symbol,D.StuffCname,A.CompanyId 
		...
		for($j=$i;$j<27;$j++){//补空行
			echo"
			<tr bgcolor='#ECEAED' align='center' onmouseover=\"this.style.background='#F6C'; \" onmouseout =\"this.style.background='#ECEAED'; \"><td width='50' height='20' class='A0111'>$j</td><td width='80'  class='A0101'>&nbsp;</td><td width='100'  class='A0101'>&nbsp;</td><td width='100'  class='A0101'>&nbsp;</td><td width='200' class='A0101'>&nbsp;</td><td width='80' class='A0101'>&nbsp;</td><td width='80' class='A0101'>&nbsp;</td><td width='50' class='A0101'>&nbsp;</td><td width='50' class='A0101'>&nbsp;</td><td width='80' class='A0101'>&nbsp;</td><td width='80' class='A0100'>&nbsp;</td></tr>";
			}
		...
		<tr bgcolor='#36C' align='center' style='Color:#FFF'><td height='20' class='A0111' colspan='2'>合计</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0100'>&nbsp;</td><td  class='A0101' align='right'>¥$SumAmount</td></tr>
		</table>
		";
	echo"</td></tr>";
	}
...
//未结付表结束
		...
		//读取记录
		$checkSql=mysql_query("SELECT 
		A.Month,A.StockId,A.OrderQty,A.Price,A.Amount,(A.Amount*C.Rate) AS AmountRMB,A.Estate,A.BuyerId,B.Forshort,C.Symbol,D.StuffCname
		FROM $DataIn.cw1_tkoutsheet A
		LEFT JOIN $DataIn.trade_object B ON B.CompanyId=A.CompanyId 
		LEFT JOIN $DataPublic.currencydata C ON C.Id=B.Currency
		LEFT JOIN $DataIn.stuffdata D ON D.StuffId=A.StuffId
