...
$checkSql=mysql_query("
						SELECT  A.Id,A.Content,A.Operator,A.Bill,A.Date,C.Symbol,A.Amount,(A.Amount*C.Rate) AS AmountRMB,B.Name AS ItemName 
	...
	do{
		...
		$AmountRMB=number_format($AmountRMB);
		 ...
		 if($Bill==1){
			...
			$detailList[$i - 1]["FilePath"] = "/download/cwadminicost/".$Bill;
