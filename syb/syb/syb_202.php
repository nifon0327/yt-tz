...
$Parameters=$Parameters==1?" AND P.GysPayMode=1":" AND P.GysPayMode!=1";//GysPayMode=1 现金，其余月结
...
$checkSql=mysql_query("
	...
	WHERE 1 AND A.Date>='2008-07-01' $MonthSTR $EstateSTR  $Parameters ORDER BY A.Date DESC,A.Id DESC
",$link_id);
