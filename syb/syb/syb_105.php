<?php 
//电信
//代码共享-EWEN 2013-09-05 加入HZ642的明细记录
//汇兑损益+HZ642
...
switch($DataT){
	...
	case "W":
		$DataTSTR="未结付记录"; 
		$MonthSTR=" AND DATE_FORMAT(A.PayDate,'%Y-%m')=1";
		break;
	case "A":
		$DataTSTR="全部记录"; 
		break;
...
<td width='40' class='A1001'>转出<br>货币</td>
<td width='80' class='A1001'>转出金额</td>
<td width='80' class='A1001'>汇率</td>
<td width='40' class='A1001'>转入<br>货币</td>
<td width='80' class='A1001'>转入金额</td>
<td width='80' class='A1001'>结汇凭证</td>
<td  class='A1001'>备注</td>
<td width='80' class='A1001'>损益金额</td>
</tr>
<tr>
...
";
	//读取记录
$checkSql=mysql_query("SELECT A.PayDate,A.OutAmount,A.Rate,A.InAmount,A.BillNumber,A.Bill,A.Remark,
					  B.Symbol AS OutCurrency,C.Symbol AS InCurrency,(A.InAmount*C.Rate-A.OutAmount*B.Rate) AS Amount
FROM $DataIn.cw5_fbdh A
LEFT JOIN $DataPublic.currencydata B ON B.Id=A.OutCurrency
LEFT JOIN $DataPublic.currencydata C ON C.Id=A.InCurrency
WHERE A.PayDate>='2008-07-01'  $MonthSTR ORDER BY A.Id DESC
",$link_id);
$i=1;
$SumAmount=0;
if($checkRow=mysql_fetch_array($checkSql)){
	do{
		...
		echo"
			...
			<td width='40' class='A0101' align='center'>$OutCurrency</td>
			<td width='80' class='A0101' align='center'>$OutAmount</td>
			<td width='80' class='A0101'  align='center' >$Rate</td>
			<td width='40' class='A0101' align='center'>$InCurrency</td>
			<td width='80' class='A0101' align='right'>$InAmount</td>
			<td width='80' class='A0101' bgcolor='#ECEAED'>$BillNumber</td>
...
for($j=$i;$j<27;$j++){//补空行
	...
	<td width='40' class='A0101'>&nbsp;</td>
	<td width='80' class='A0101'>&nbsp;</td>
	<td width='80' class='A0101' bgcolor='#ECEAED'>&nbsp;</td>
	<td class='A0101'>&nbsp;</td>
...
echo"<br>
<table cellspacing='0' border='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word;width:1110px;height:230px' align='center'>
<tr bgcolor='#36C' align='center' style='Color:#FFF'>
<td width='50' height='20' class='A1011'>序号</td>
...
<div style='width:1111px;height:200px;overflow-x:hidden;overflow-y:none;margin-left:-1px'>
<table cellspacing='0' border='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word;width:1110px' align='center'>";
//读取记录
