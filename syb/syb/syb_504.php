...
";
//读取记录
$checkSql=mysql_query("SELECT S.Id,S.Mid,S.Content,S.Amount,S.Bill,S.ReturnReasons,S.Date,S.Estate,S.Locks,S.Operator,C.Symbol AS Currency,C.PreChar,C.Rate,S.TotalRate,S.Time,M.Name,B.Name AS Branch,M.ComeIn,D.outDate,S.AveAmount,S.Number,S.PaySign,D.Reason AS LeaveReason,T.Name AS TypeName
 ...
 WHERE 1 $MonthSTR $EstateSTR AND S.TypeId=1",$link_id);
$i=1;
$SumAmount=0;
if($checkRow=mysql_fetch_array($checkSql)){
	...
	do{
       ...
       $RMBAmount=sprintf("%.2f",$RMBAmount);
       ...
       $Rate =$TotalRate."个月";
		...
		echo"
			...
			<td width='30' class='A0101' align='right'>$Currency</td>
			...
			<td width='81' class='A0100' align='right'>$RMBAmount</td>
			</tr>";
		$i++;
