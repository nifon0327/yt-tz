...
$T="<br><table border='0' cellspacing='0' bgcolor='#CCCCCC' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word;font-size:9px;'>
	<tr>
		<td width='50' class='A1111' align='center' height='19'>日期</td>
		<td width='80' class='A1101' align='center'>星期</td>
		...
		<td width='110' class='A1101' align='center'>夜班次数</td>
	</tr>
	<tr>
	<td colspan='10' height='431' class='A0011' valign='top'><div style='width:800;height:431;overflow-x:hidden;overflow-y:scroll'>
	<table border='0' width='100%' cellspacing='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word;font-size:9px;'>
	";
//记录内容
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
for($i=0;$i<$Days;$i++){//日循环
	...
	$T.="<tr>
		<td class='A0101' align='center' width='48'>$j</td>
		<td class='A0101' align='center' width='80'>$weekInfo</td>
		<td class='A0101' align='center' width='80'><div $DateTypeColor>$DateType$ddInfo</div></td>
		<td class='A0101' align='center' width='80'><span $AIcolor>$aiTime</span></td>
		<td class='A0101' align='center' width='80'><span $AOcolor>$aoTime</span></td>
		<td class='A0101' align='center' width='80'>$ATime</td>
		<td class='A0101' align='center' width='80'>$BTime</td>
		<td class='A0101' align='center' width='80'>$CTime</td>
		<td class='A0101' align='center' width='80'>$DTime</td>
		<td class='A0101' align='center' width='110'>$YBs</td>
		</tr>";
	}//end for
