...
if($ChickIn==""){//正常:签到检查
	...
	$ChickIn=$CheckTime;
	$CheckNext= mysql_query("SELECT CheckTime,CheckType FROM $DataIn.checkiotemp WHERE 1 and Number=$Number and CheckTime>'$CheckTime' order by CheckTime limit 0,1",$link_id);
