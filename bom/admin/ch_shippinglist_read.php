...
if($DeliverySign==0 && $DeliverySign!=""){
	 $Th_Col="选项|60|序号|40|出货流水号|70|客户|90|Invoice名称|110|Invoice|80|PI编号|80|出货方量|70|出货日期|100|货运信息|100|操作员|50|PI操作员|80|生成时间|100";
...
echo"<select name='Pagination' id='Pagination' onchange='CencelPage()'><option value='1' $Pagination1>分页</option><option value='0' $Pagination0>不分页</option></select>
  	$CencalSstr <span class='ButtonH_25' onclick=batchCreatePI()>生成PI</span>" ;
//步骤5：
...
$mySql="SELECT 
M.Id,M.CompanyId,M.BankId,M.Number,M.PINO,M.PIcreator,M.PIcreatetime,M.InvoiceNO,M.InvoiceFile,M.Wise,M.Date,M.Estate,M.Locks,M.Sign,M.Remark,M.ShipType,M.Ship,M.Operator,C.Forshort,C.PayType,S.InvoiceModel,S.LabelModel,S.OutSign ,T.Type as incomeType,F.Forshort AS bgForshort,C.SaleMode,T.BgBillNum,T.Attached AS BgAttached 
...
if($myRow = mysql_fetch_array($myResult)){
	...
	do{
       ...
       $BgBillNum = "<img location.href=\"#\"' style='CURSOR: pointer' onclick='upMainData(\"Ch_shippinglist_upshipType\",\"$Id\")' src='../images/edit.gif' title='上传报关单' width='13' height='13'><span class='yellowB'>$BgBillNum</span>";
        ...
        // 出货数量+方量
        $sListSql = "SELECT sum(P.Weight) AS Weight
