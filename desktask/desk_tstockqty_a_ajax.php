...
//$TypeId=$TempId;
$mySql="
SELECT K.tStockQty,K.oStockQty,D.StuffId,D.StuffCname,U.Name AS UnitName,D.Price,D.Estate,D.Gfile,D.Gstate,D.Picture,D.Gremark,P.Forshort
...
WHERE 1 $SearchRows and K.tStockQty>0  AND  M.blSign=1 AND B.CompanyId='$CompanyId' AND D.Estate>0 ORDER BY D.Estate DESC,D.StuffCname,D.StuffId";  // 
...
if($myRow = mysql_fetch_array($myResult)){
		echo"<table id='$TableId' width='$tableWidth' cellspacing='1' border='1' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word'>
			<tr bgcolor='#CCCCCC'>
				...
				<td width='45' align='center'>单价</td>
	...
	do{
		...
		*/	
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_tstockqty_b\");' 
