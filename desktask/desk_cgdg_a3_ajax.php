...
$mySql="SELECT count(*) AS Nums,S.BuyerId,M.Name
		...
		WHERE 1 AND S.Mid=0 AND S.Estate='0' AND E.Id IS NULL AND (S.FactualQty>0 OR S.AddQty>0) $SearchRows GROUP BY S.BuyerId ORDER BY S.BuyerId
		";
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_cgdg_b3\");' id='ThisImg_$DivNum$i' name='ThisImg_$DivNum$i' src='../images/showtable.gif' width='13' height='13' style='CURSOR: pointer'>";
