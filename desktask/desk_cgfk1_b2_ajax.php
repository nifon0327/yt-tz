...
SELECT left(K.Month,4) AS theYear,SUM(K.Qty*K.Price) AS Amount
	...
	WHERE 1 AND K.CompanyId='$CompanyId' AND K.Estate=2 GROUP BY left(K.Month,4) ORDER BY K.Month DESC
	";
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_cgfk1_c2\");' id='ThisImg_$DivNum$i' name='ThisImg_$DivNum$i' src='../images/showtable.gif' width='13' height='13' style='CURSOR: pointer'>";
