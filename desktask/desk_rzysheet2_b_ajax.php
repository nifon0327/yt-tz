...
WHERE S.Estate>0 AND G.StuffId='$TempStuffId' GROUP BY DATE_FORMAT(M.OrderDate,'%Y-%m') ORDER BY M.OrderDate
";
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$TempId="$TempStuffId|$Month";
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_rzysheet2_c\");' 
