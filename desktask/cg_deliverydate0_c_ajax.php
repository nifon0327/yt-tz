...
//订单列表
$sListResult = mysql_query("SELECT M.Id,M.Date,D.StuffCname,D.Gfile,S.POrderId,S.StuffId,S.Price,U.Name AS UnitName,(S.AddQty+S.FactualQty) AS cgQty,S.StockId 
