...
$mySql="
SELECT DATE_FORMAT(KM.PayDate,'%Y') AS theYear,SUM(KS.Qty*KS.Price) AS Amount
	...
	WHERE 1 AND KM.CompanyId='$CompanyId' GROUP BY DATE_FORMAT(KM.PayDate,'%Y') ORDER BY KM.PayDate DESC
	";
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_cgfk1_c4\");' id='ThisImg_$DivNum$i' name='ThisImg_$DivNum$i' src='../images/showtable.gif' width='13' height='13' style='CURSOR: pointer'>";
