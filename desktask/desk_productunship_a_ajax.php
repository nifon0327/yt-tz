...
//参数拆分
$mySql="SELECT SUM(S.Qty) AS Qty,D.ProductId,D.cName
FROM $DataIn.yw1_ordersheet S
LEFT JOIN $DataIn.productdata D ON D.ProductId = S.ProductId
LEFT JOIN $DataIn.producttype T ON T.TypeId = D.TypeId
WHERE S.Estate>0 AND T.TypeId='$TempId' GROUP BY S.ProductId ORDER BY S.ProductId DESC";
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_productunship_b\");' 
