...
$mySql="SELECT right(K.Month,2) AS theMonth,K.Month,SUM(K.Qty*K.Price) AS Amount
	...
	WHERE 1 AND K.CompanyId='$CompanyId' AND K.Estate=3 AND left(K.Month,4)='$theYear' GROUP BY right(K.Month,2) ORDER BY K.Month DESC
	";
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_cgfk_d3\");' id='ThisImg_$DivNum$i' name='ThisImg_$DivNum$i' src='../images/showtable.gif' width='13' height='13' style='CURSOR: pointer'>";
