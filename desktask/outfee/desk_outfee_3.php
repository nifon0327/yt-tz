...
echo"<table id='$TableId' width='$tableWidth' cellspacing='1' border='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word'>
	<tr bgcolor='#99FF99'>
		...
		<td width='80' align='center'>分类</td>
		<td width='40' align='center'>状态</td>
		<td width='50' align='center'>请款人</td>
		<td width='70' align='center'>请款日期</td>
	</tr></table>";
$SearchRows=" AND S.Estate='3' AND S.Did=0 AND DATE_FORMAT(S.Date,'%Y-%m')='$MonthTemp'";
$mySql="SELECT S.Id,S.TypeId,S.CompanyId,S.Amount,S.Remark,S.Date,S.Estate,S.Locks,S.Operator,P.Forshort,C.Symbol
	...
	do{
		...
		$Estate="<div align='center' class='redB'>未付</div>";
			...
			<tr bgcolor='#FFFFFF'>
				...
				<td width='400' align='center'>$Remark</td>
                <td width='80' > $Type</td>
