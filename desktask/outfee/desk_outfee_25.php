...
$mySql="SELECT P.Forshort,P.CompanyId,C.Symbol,SUM(S.Amount) AS Amount
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_outfee_25_ajax\");' 
