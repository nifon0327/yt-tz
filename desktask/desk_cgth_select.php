          ...
          value="<=">&lt;=</OPTION>
                ...
                <TR>
                  ...
                  <TD><select name=value[] id="value[]" style="width: 274px;">
				    <option value="">全部</option>
                    <?php   
					$checkSql = "SELECT P.CompanyId,P.Forshort,P.Letter FROM $DataIn.trade_object P,$DataIn.bps B 
					WHERE B.CompanyId=P.CompanyId GROUP BY B.CompanyId ORDER BY P.Letter";
