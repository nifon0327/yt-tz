...
//有未请款的年份
$mySql="SELECT count(*) AS Nums,S.CompanyId,P.Forshort,P.Letter,I.Tel,I.Fax,C.Symbol
		...
		WHERE 1 AND S.Mid=0 AND E.Type='2' AND (S.FactualQty>0 OR S.AddQty>0) $SearchRows AND S.BuyerId='$BuyerId'
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$showPurchaseorder="<img onClick='SandH(\"$DivNum\",$i,this,\"$TempId\",\"desk_cgdg_c1\");' id='ThisImg_$DivNum$i' name='ThisImg_$DivNum$i' src='../images/showtable.gif' width='13' height='13' style='CURSOR: pointer'>";
