...
//步骤2：
ChangeWtitle("$SubCompany 模板文件查询");			//需处理
...
//步骤4：需处理
$CheckTb="$DataPublic.workmodelfile";
?>
	...
	<tr>
		<td class="A0011">
			<TABLE width="600" border=0 align="center">
              <TBODY>
                <TR>
                  <TD width="108" align="right"><p>模板说明
                      <input name="Field[]" type="hidden" id="Field[]" value="Note">
                  </p>
                  </TD>
...
<TR>
                  <TD width="108" align="right"><p>文件名称
...
至
  <INPUT name=LastDate class=textfield id="LastDate" style="width:180px;" onfocus="WdatePicker()" readonly>
  <input name="table[]" type="hidden" id="table[]" value="A">
