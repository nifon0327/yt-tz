...
//$LockSql=" LOCK TABLES $DataIn.info3_gmmsg WRITE";$res=@mysql_query($LockSql);
//删除领料记录
$delSql = "DELETE FROM $DataIn.info3_gmmsg WHERE Id IN ($Ids)"; 
...
//$OPTIMIZE=mysql_query("OPTIMIZE TABLE $DataIn.info3_gmmsg");
//操作日志
