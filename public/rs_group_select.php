...
//步骤2：
ChangeWtitle("$SubCompany 小组资料查询");			//需处理
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
                <TR>
                  <TD width="105" align="right">小组名称
                      <input name="Field[]" type="hidden" id="Field[]" value="GroupName">
                  </TD>
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <TD><INPUT name=value[] class=textfield id="value[]"  style="width:177px"onfocus="WdatePicker()" readonly>
至
  <INPUT name=DateArray[] class=textfield id="DateArray[]"  style="width:177px" onfocus="WdatePicker()" readonly>
  <input name="table[]" type="hidden" id="table[]" value="A">
