...
//步骤2：
ChangeWtitle("$SubCompany 更新行政分类");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT TypeId,AuditType,FirstId,Name,Amount,Remark FROM $DataPublic.adminitype WHERE Id='$Id'",$link_id));
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
    ...
    <tr>
	    <td height="31" scope="col" align="right">审核分类</td>
	    <td scope="col"><?php 
         include "../model/subselect/admini_audittype.php";
		?></td>
	    </tr>
		<tr>
            <td height="13" scope="col" align="right">分类ID</td>
            <td width="460" scope="col"><?php  echo $TypeId?></td></tr>
		<tr>
		...
		<tr>
            <td height="42" scope="col" align="right">默认金额</td>
            <td scope="col"><input name="Amount" type="text" id="Amount" value="<?php  echo $Amount?>" style="width:380px;" dataType="Currency" msg="不合要求"></td></tr>
        <tr>
