...
SELECT NULL,BranchId,JobId,Number,'$CheckTime','$CheckType','1', '0','1','1','0','$KrSign', NULL,'$Operator',0,'$Operator',NOW(),'$Operator',NOW(),null FROM $DataPublic.staffmain WHERE 1 $NumberSTR 
