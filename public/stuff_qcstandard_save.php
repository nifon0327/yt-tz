...
if($Attached!=""){//有上传文件
	...
	if($OperationResult=="Y"){
		...
		$Date=date("Y-m-d");
		$IN_recode="INSERT INTO $DataIn.stuffqcstandard (Id,TypeId,Title,Picture,IsType,Estate,Date,Locks,Operator) VALUES (NULL,'$TypeId','$Title','$PreFileName','$IsType','1','$Date','0','$Operator')";
