...
<table width="<?php  echo $tableWidth?>" height="306" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="NoteTable">
  <tr>
    ...
    <tr>
     ...
     <?php 
	  $result = mysql_query("SELECT S.StuffId,S.StuffCname FROM $DataIn.stuffqcimg D LEFT JOIN $DataIn.Stuffdata S ON S.StuffId=D.StuffId WHERE D.QcId=$Id order by S.StuffId",$link_id);
