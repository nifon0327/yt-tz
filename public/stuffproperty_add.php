...
//步骤2：
ChangeWtitle("$SubCompany 新增配件属性");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td class="A0011">
      <table width="760" border="0" align="left" cellspacing="5">
		<tr>
            <td width="120" height="30" align="right" scope="col">属性名称</td>
	...
	-->
		<tr>
            ...
            <td><textarea name="Remark" style="width:380px;" rows="2" id="Remark"></textarea></td>
        </tr>
