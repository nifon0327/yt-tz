...
$upDataSheet="$DataPublic.sc4_funmodule";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$Date=date("Y-m-d");
		$SetStr="cSign='$cSign',ModuleName='$ModuleName',Parameter='$Parameter',Place='$Place',OrderId='$OrderId',Estate='$Estate',Locks='0',Date='$Date',Operator='$Operator'";
