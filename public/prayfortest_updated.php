<?php 
//步骤1  $DataIn.cwdyfsheet/ $DataIn.cwdyfmain 二合一已更新电信---yang 20120801
include "../model/modelhead.php";
$nowWebPage=$funFrom."_updated";
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤2：
$Log_Item="开发费用";		//需处理
$upDataSheet="$DataIn.cwdyfsheet";	//需处理
$upDataMain="$DataIn.cwdyfmain";	//需处理
$Log_Funtion="更新";
...
$SetStr="CompanyId='$CompanyId',ItemName='$ItemName',TypeID='$TypeID',Description='$Description',Amount='$Amount',Currency='$Currency',ModelDetail='$ModelDetail',Remark='$Remark',Provider='$Provider',Date='$upDate' $BillSTR";
