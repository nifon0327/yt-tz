...
$upSql=mysql_query("SELECT L.StockId,L.Qty,L.StuffId,D.StuffCname,IFNULL(S.OrderQty,SM.OrderQty) AS OrderQty,U.Decimals,L.Type,L.sPOrderId 
...
LEFT JOIN $DataIn.cg1_stuffcombox SM ON SM.StockId = L.StockId  
