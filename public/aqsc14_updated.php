...
$upDataSheet="$DataPublic.aqsc14";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$SetStr="Caption='$Caption',Model='$Model',Unit='$Unit',Qty='$Qty',Price='$Price',Amount='$Amount',Handler='$Handler',Checker='$Checker',UseDate='$UseDate',Date='$DateTime',Operator='$Operator',Locks='0' $AttachedSTR";
