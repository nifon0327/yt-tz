...
//步骤3：//需处理
$upData = mysql_fetch_array(mysql_query("SELECT * FROM $DataPublic.zwwp2_subtype WHERE Id='$Id'",$link_id));
$Name=$upData["TypeName"];
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td class="A0011">
		<table width="760" border="0" align="center" cellspacing="5">
            ...
            <tr>
          		<td height="40" align="right" scope="col">分类说明</td>
          		<td scope="col"><input name="Remark" type="text" id="Remark" value="<?php  echo $Remark?>" style="width: 380px;"  Msg="未填写或格式不对"></td>
        	</tr>
      	</table>
        </td></tr>
</table>
