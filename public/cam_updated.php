...
//步骤2：
$Log_Item="摄像头监控信息";		//需处理
$upDataSheet="$DataPublic.ot2_cam";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
          $SetStr= "Floor='$Floor',Info='$Info',Name='$Name',IP='$IP',OutIP='$OutIP',Port='$Port',Params='$Params',`From`='$cFrom',`Order`='$cOrder'";
