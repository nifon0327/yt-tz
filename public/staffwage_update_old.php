...
SELECT 
S.Number,S.Dx,S.Gljt,S.Gwjt,S.Jj,S.Shbz,S.Zsbz,S.Jtbz,S.Jbf,S.Jbjj,S.Ywjj,S.Yxbz,S.taxbz,S.Jz,S.Sb,S.Kqkk,S.Gjj,S.Ct,S.dkfl,S.RandP,S.Otherkk,S.Amount,S.Remark,S.Currency ,M.Name 
...
$Amount=$Dx+$Jbf+$Gljt+$Gwjt+$Jj+$Jbjj+$Ywjj+$Shbz+$Zsbz+$Jtbz+$Yxbz+$taxbz-$Kqkk-$dkfl-$Jz-$Sb-$Gjj-$Ct-$RandP-$Otherkk;
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
	<table width="700" border="0" align="center" id="NoteTable">
        ...
        <tr>
            ...
            <td> &nbsp;+
            <input name="Jbjj" type="text" class="inR0100" id="Jbjj" value="<?php  echo $Jbjj?>" size="5" readonly></td>
             <td width="320" scope="col">&nbsp;</td>
          </tr>   
          <tr>
            <td align="right" valign="top">额外奖金</td>
            <td> &nbsp;+
            <input name="Ywjj" type="text" class="inR0100" id="Ywjj" value="<?php  echo $Ywjj?>" size="5" onchange="javascript:CheckNum(this,1)" onfocus="toTempValue(this.value)">
            </td>
          ...
          <tr>
            ...
            <td> &nbsp;-
              <input name="Jz" type="text" class="inR0000" id="Jz" value="<?php  echo $Jz?>" size="5" onchange="javascript:CheckNum(this,1)"></td>
               <td width="320" scope="col">&nbsp;</td>
          </tr>
          <tr>
...
<tr>
            ...
            <td> &nbsp;-
            <input name="Ct" type="text" class="inR0100" id="Ct" value="<?php  echo $Ct?>" size="5" readonly></td>
             <td width="320" scope="col">&nbsp;</td>
          </tr>          <tr>
...
function GetAmount()
{
	...
	var TaxAmount=(Dx+Gljt+Gwjt+Jj+Jbjj+Ywjj+Shbz+Zsbz+Jbf+Yxbz+Jtbz-Kqkk-dkfl-Sb-Gjj-Ct-Otherkk)*1;
	...
	*/
	...
	if(TaxAmount >3500 && TaxAmount<= 5000){
	      ...
	      TaxAmount=TaxAmount>10000?10000:TaxAmount;
	      RandP =  (TaxAmount-baseTax )*0.2-555;
	}
	...
	*/
	...
	taxbz=0;
	var Amount=Dx+Gljt+Gwjt+Jj+Jbjj+Ywjj+Shbz+Zsbz+Jbf+Yxbz+Jtbz+taxbz-Jz-Sb-Gjj-Ct-Kqkk-dkfl-Otherkk-RandP;
