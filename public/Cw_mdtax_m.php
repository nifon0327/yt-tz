...
//$sumCols="5";
$From=$From==""?"read":$From;
ChangeWtitle("$SubCompany 免抵退税收益明细表审核");
$funFrom="cw_mdtax";


$Th_Col="选项|60|序号|40|国税时间|60|免抵退税金额|80|免抵退税发票号|90|结付银行|100|收款日期|70|扫描附件|60|供应商税款|140|报关费用|140|行政费用|140|备注|250|期末留抵税额|80|状态|50|结付凭证|60|操作人|50";
