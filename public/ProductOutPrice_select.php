	...
	<TABLE width="600" border=0 align="center">
         <TBODY>
          ...
          value="<=">&lt;=</OPTION>
				...
				<TR>
                  <TD align="right">是否电子类
                    <input name="Field[]" type="hidden" id="Field[]" value="dzSign"></TD>
                  <TD><div align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
          ...
          value="<=">&lt;=</OPTION>
                ...
                <TR>
                  ...
                  <TD ><select name="value[]" id="value[]" size="1" style="width: 274px;">
                    <?php  
					echo"<option value='' selected>全部</option>";
					$result = mysql_query("SELECT * FROM $DataIn.trade_object WHERE 1 AND ObjectSign IN (1,2) AND Estate=1 order by Id",$link_id);
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <input name="table[]" type="hidden" id="table[]" value="PM">
