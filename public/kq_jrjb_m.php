...
if($From!="slist"){
	$SearchRows ="";	
	   ...
	   // $cSignTB="M";$SelectFrom=5;$SharingShow2="Y";
	  //选择公司
...
$mySql="SELECT S.Id,S.Number,S.Month,S.oHours,S.oWage,S.xHours,S.xWage,S.fHours,S.fWage,S.oRandP,S.Amount,S.Date,S.Estate,S.Locks,S.Operator,M.Name,J.Name AS Job,B.Name AS Branch,S.cSign
