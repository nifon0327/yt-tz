...
*/
$inRecode="INSERT INTO $DataIn.kqrqdd
	SELECT NULL,Number,'$GDate','$XDate','0','$Operator',1,0,'$Operator',NOW(),'$Operator',NOW(),null FROM $DataPublic.staffmain
	WHERE 1 $NumberSTR AND  Estate='1' AND ComeIn<='$GDate' 
	AND Number NOT IN (SELECT Number FROM $DataIn.kqdata WHERE Month='$thisMonth' ORDER BY Number)";
//echo $inRecode;AND cSign='$Login_cSign'
