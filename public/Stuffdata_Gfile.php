...
<link rel='stylesheet' href='../model/$Login_WebStyle/read_line.css'>
<link rel='stylesheet' href='../model/sharing.css'>
	...
	do{
		...
		*/		
		...
		if($Picture==2){
			...
			$StuffCname="<span onClick='OpenOrLoad(\"$d\",\"$f\",\"\",\"stuff\")' style='CURSOR: hand;color:#0000CC' title='图片未审核'>$StuffCname</span>";
			}
		else{
		...
		*/	
		...
		title='显示或隐藏产品关联的情况.' width='13' height='13' style='CURSOR: hand'>";
