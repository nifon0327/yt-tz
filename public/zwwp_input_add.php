...
//步骤2：
ChangeWtitle("$SubCompany 新增总务物品入库记录");//需处理
...
$CustomFun="<span onclick='SearchRecord()' $onClickCSS>加入申购单</span>&nbsp;";
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr valign="bottom">
	  <td height="25" colspan="7" align="center" class="A0011">入库主单信息</td>
	</tr>
	<tr bgcolor='<?php  echo $Title_bgcolor?>'>
		...
		<td align="center" class="A1111">供 应 商</td>
	  	...
	  	<td align="center" class="A1101">凭证号码</td>
	...
	<tr>
		...
		<td align="center" class="A0101"><input name="rkDate" type="text" id="rkDate" value="<?php  echo date("Y-m-d")?>" size="8" maxlength="10"></td>
	...
	<tr>
		...
		<td colspan="5" align="center" valign="bottom">入库明细资料
...
function CheckForm(){
	...
	if(Message!=""){
		...
		document.form1.action="zwwp_input_save.php";
...
function SearchRecord(){
	...
	var num=Math.random();  
	BackStockId=window.showModalDialog("zwwp_input_s1.php?r="+num+"&Jid="+Jid+"&Bid="+Bid+"&tSearchPage=zwwp_input&fSearchPage=zwwp_input&SearchNum=2&Action=2","BackStockId","dialogHeight =500px;dialogWidth=930px;center=yes;scroll=yes");
	if (BackStockId){
