...
?>
	...
	<table width="450" border="0" cellspacing="0">
		<tr>
		  <td colspan="2" align="center" valign="top"><?php  echo $SubName?></td>
		</tr>
		
		<tr>
		  <td width="100" height="25" align="center">日期:</td>
	  	  <td><input name="MaintainDate" type="text" id="MaintainDate"  style="width:80" onfocus="WdatePicker()" dataType="Date" format="ymd" msg="日期不正确" readonly value="<?php  echo $CycleDate?>"></td>
	    </tr>
