...
//步骤2：
ChangeWtitle("$SubCompany 新增安全生产软件投入");//需处理
...
<tr>
    ...
    <td valign="top" class='A0001'><input name="UseDate" type="text" id="UseDate" value="" style="width:380px;" maxlength="60" dataType="Date" Msg="未填写" onfocus="WdatePicker()" readonly></td>
  </tr>
  <tr>
    ...
    <td valign="top" class='A0001'><input name="Amount" type="text" id="Amount" value="" style="width:380px;" maxlength="60" dataType="Currency" Msg="未填写"></td>
    </tr>
    <tr>
      <td height="30" align="right" valign="top" class='A0010'>经手人: </td>
    <td valign="top" class='A0001'><input name="Handler" type="text" id="Handler" value="" style="width:380px;" maxlength="60" dataType="Require" Msg="未填写"></td>
    </tr>
    <tr>
    ...
    <td valign="top" class='A0001'><textarea name="Remark" id="Remark" style="width:380px;" datatype="Require" msg="未填写"></textarea></td>
  </tr>
    <tr>
