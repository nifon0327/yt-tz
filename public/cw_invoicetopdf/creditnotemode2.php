	...
	$eurTableNo="eurTableNo".strval($pi);
     if($addSign==0){  //新加一页
		...
		include "cw_invoicetopdf/invoicepublicHeaderS.php";  //页头
		{
			...
			$pdf->SetXY($CurMargin,72);   //第一个表modify by zx 2011-0129 $ConTableBegin_Y值在 invoicepublicHeader.php     $pdf->SetXY($CurMargin,72);  
		...
		//表标题
		{
			...
			<td width=15 align=center height=$RowsHight valign=middle style=bold>序号</td>
			<td width=30 align=center valign=middle style=bold>PO#</td>
			<td width=93 align=center valign=middle style=bold>产品描述</td>
			<td width=19 align=center valign=middle style=bold>数量</td>
			<td width=19 align=center valign=middle style=bold>单价</td>
			<td width=19 align=center valign=middle style=bold>金额</td>
			</tr></table>" ;			
