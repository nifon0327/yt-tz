...
$OperationResult="Y";
$Name=FormatSTR($Name);
$inRecode="INSERT INTO $DataPublic.branchdata (Id,cSign,Name,TypeId,SortId,Color,Picture,Estate,Locks,Date,Operator) VALUES (NULL,'7','$Name','$TypeId','$SortId','','0','1','0','$DateTime','$Operator')";
