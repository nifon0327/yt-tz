...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
   ...
   <TR>
                  <TD align="top">实物库存
                    <input name="Field[]" type="hidden" id="Field[]" value="tStockQty">
                  </TD>
                  <TD align="top">
   ...
   <TR>
          ...
          value="<=">&lt;=</OPTION>
                ...
                value="isNum" /></TD>
  				...
  				<TR>
                  <TD>分类图片上传(分类)
                  <input name="Field[]" type="hidden" id="Field[]" value="Picjobid"></TD>
                  <TD><SELECT name=fun[] id="fun[]" style="width: 60px;">
                    <OPTION value==>=</OPTION>
                    <OPTION 
          value=!=>!=</OPTION>
			...
			?>		 
                ...
                value="isNum" />                 
   				...
   				<TR>
                  <TD>图片上传
                  <input name="Field[]" type="hidden" id="Field[]" value="PJobid"></TD>
                  <TD><SELECT name=fun[] id="fun[]" style="width: 60px;">
                    <OPTION value==>=</OPTION>
                    <OPTION 
          value=!=>!=</OPTION>
			...
			?>		 
                ...
                value="isNum" />                 
 				...
 				<TR>
                  <TD>图档上传(分类)
                  <input name="Field[]" type="hidden" id="Field[]" value="GicJobid"></TD>
                  <TD><SELECT name=fun[] id="fun[]" style="width: 60px;">
                    <OPTION value==>=</OPTION>
                    <OPTION 
          value=!=>!=</OPTION>
