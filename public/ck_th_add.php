...
//步骤2：
ChangeWtitle("$SubCompany 新增退换记录");//需处理
$nowWebPage =$funFrom."_add";	
$toWebPage  =$funFrom."_save";	
$_SESSION["nowWebPage"]=$nowWebPage; 
$Parameter="fromWebPage,$fromWebPage,funFrom,$funFrom,From,$From,Pagination,$Pagination,Page,$Page";
//步骤3：
$tableWidth=1120;$tableMenuS=500;
$CustomFun="<span onclick='SearchRecord()' $onClickCSS>加入退换配件</span>&nbsp;";
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr bgcolor='<?php  echo $Title_bgcolor?>'>
		...
		<td class="A1101" width="60" align="center">退换数量</td>
		<td class="A1101" width="250" align="center">退换原因</td>
		<td class="A1100" width="300" align="center">上传图片</td>
		<td width="10" class="A0001" bgcolor="#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
		<td width="10" class="A0010" height="432">&nbsp;</td>
		<td colspan="7" align="center" class="A0111">
		<div style="width:1110;height:100%;overflow-x:hidden;overflow-y:scroll">
			<table width='1110' cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="ListTable">
...
function CheckForm(){
	...
	if(Message!=""){
		...
		document.form1.action="ck_th_save.php";
...
function SearchRecord(){
	...
	var num=Math.random();  
	BackStuffId=window.showModalDialog("ck_th_s1.php?r="+num+"&Jid="+Jid+"&tSearchPage=ck_th&fSearchPage=ck_rk&SearchNum=2&Action=2","BackStuffId","dialogHeight =500px;dialogWidth=930px;center=yes;scroll=yes");
	if (BackStuffId){
		...
		for(var i=0;i<Rowslength;i++){
			...
			if(Message==""){
				...
				oTD.innerHTML="<input type='file' name='Picture[]' id='Picture'>";
				oTD.className ="A0100";
				oTD.align="center";
				oTD.width="300";						
				}
