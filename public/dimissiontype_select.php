...
//步骤2：
ChangeWtitle("$SubCompany 离职分类查询");			//需处理
		...
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
				<TR>
                  <TD width="89">分类I D
                    <input name="Field[]" type="hidden" id="Field[]" value="Id"></TD><TD width="126" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate">
                ...
                <TR>
				  ...
				  <select name=value[] id="value[]" style="width: 380px;">
                    ...
                    <?php 
					$CheckTb="$DataPublic.dimissiontype";
