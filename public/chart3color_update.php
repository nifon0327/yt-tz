<?php 
//步骤1 $DataIn.branchdata 二合一已更新
include "../model/modelhead.php";
//步骤2：
ChangeWtitle("$SubCompany 更新产品类型图例颜色");//需处理
...
//步骤3：//需处理
$upData = mysql_fetch_array(mysql_query("SELECT C.TypeName,B.ColorCode 
FROM $DataIn.chart3_color B
LEFT JOIN $DataIn.producttype C ON C.TypeId=B.TypeId
WHERE B.Id='$Id'",$link_id));
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td class="A0011">
      <table width="760" border="0" align="center" cellspacing="5">
        <tr>
          <td width="150" height="40" align="right" scope="col">产品类型</td>
          <td scope="col"><?php  echo $TypeName?></td><input type='hidden' name='TypeName' id='TypeName' value="<?php  echo $TypeName?>"/>
        </tr>
        <tr><td colspan="2">
