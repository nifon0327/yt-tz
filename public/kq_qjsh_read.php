...
if($From!="slist"){
	...
	$date_Result = mysql_query("SELECT DATE_FORMAT(StartDate,'%Y-%m') AS Month FROM $DataPublic.kqqjsheet WHERE 1 GROUP BY DATE_FORMAT(StartDate,'%Y-%m') order by StartDate DESC",$link_id);
