...
//步骤2：
$Log_Item="配件属性";		//需处理
$upDataSheet="$DataIn.stuffpropertytype";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
        ...
        $ActionId=$ActionId==""?0:$ActionId;		$SetStr="TypeName='$Name',TypeColor='$SelColor',rColor='$RGB[r]',gColor='$RGB[g]',bColor='$RGB[b]',MainType='$MainType',ActionId='$ActionId',Remark='$Remark',Date='$DateTime',Operator='$Operator',Locks='0'";
