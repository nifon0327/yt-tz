...
//步骤2：
ChangeWtitle("$SubCompany 底薪资料查询");			//需处理
	...
	<tr>
		<td class="A0011">
          ...
          value=!=>!=</OPTION>
              ...
              <TBODY>
                <TR>
                  <TD width="105" align="right">预设底薪
                    <input name="Field[]" type="hidden" id="Field[]" value="Dx">
                  </TD>
          ...
          value="<=">&lt;=</OPTION>
                ...
                <TR>
                  <TD align="right">生活补助
                    <input name="Field[]" type="hidden" id="Field[]" value="Shbz">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          ...
          value="<=">&lt;=</OPTION>
                ...
                <TR>
                  <TD align="right">住宿补助
                    <input name="Field[]" type="hidden" id="Field[]" value="Zsbz">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
