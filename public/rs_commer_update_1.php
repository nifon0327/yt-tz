...
//步骤3：//需处理
$MyRow = mysql_fetch_array(mysql_query("SELECT S.Id,S.Month,S.mAmount,S.cAmount,S.Estate,M.Name,S.TypeId,S.ValidMonth 
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
	<table width="600" height="120" border="0" align="center" cellspacing="5">
		...
		<tr>
		  <td height="18" align="right" valign="middle" scope="col">到期月份</td>
		  <td valign="middle" scope="col"><?php  echo $ValidMonth?></td>
	    </tr>
