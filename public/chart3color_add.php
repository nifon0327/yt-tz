...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="110" height="30" align="right" class="A0010">产品类型</td>
    <td class="A0001"><select name="TypeId" Id="TypeId" size="1" style="width: 268pt;" dataType="Require" msg="未选择产品分类"><option value="" selected>请选择</option>
        <?php 
		$cResult = mysql_query("SELECT TypeId,TypeName FROM $DataIn.producttype WHERE Estate=1 ORDER BY SortId",$link_id);
		if($cRow = mysql_fetch_array($cResult)){
			do{
				echo"<option value='$cRow[TypeId]'>$cRow[TypeName]</option>";
