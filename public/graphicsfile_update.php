...
//步骤2：
ChangeWtitle("$SubCompany 更新标准图文档");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"] = $nowWebPage;
//步骤3：//需处理
$upData = mysql_fetch_array(mysql_query("SELECT * FROM $DataIn.doc_standarddrawing WHERE Id='$Id'",$link_id));
$FType=$upData["FileType"];
$FileRemark=$upData["FileRemark"];
$FileName=$upData["FileName"];
$Comd=$upData["CompanyId"];
$PType=$upData["ProductType"];
//步骤4：
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
	  <td height="35" align="right">图档客户： </td>
	...
	<tr>
	  <td height="35" align="right">产品类型： </td>
	  <td ><select name="ProductType" id="ProductType" style="width:400px" datatype="Require"  msg="未选择类型">
