...
if($Attached!=""){//有上传文件
	...
	if ($Attached!=""){		
		...
		$IN_recode="INSERT INTO $DataPublic.aqsc14 (Id,Caption,Model,Attached,Unit,Qty,Price,Amount,Handler,Checker,UseDate,Date,Estate,Locks,Operator) VALUE (NULL,'$Caption','$Model','$PreFileName','$Unit','$Qty','$Price','$Amount','$Handler','$Checker','$UseDate','$DateTime','1','0','$Operator')";
