...
//步骤2：
ChangeWtitle("$SubCompany 供应商资料查询");			//需处理
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
			  <TR>
                <TD>类&nbsp;&nbsp;&nbsp;&nbsp;型
                    <input name="Field[]" type="hidden" id="Field[]" value="cSign"></TD>
                ...
                <TD><select name=value[] id="value[]" style="width: 380px;">
                    ...
                    <option value="0">共享供应商</option>
                    <option value="<?php  echo $Login_cSign?>"><?php  echo $Login_cSign?>楼供应商</option>
                  </select>
