...
//步骤2：
ChangeWtitle("$SubCompany 更新报废记录");//需处理
...
function CheckForm(){
	var Message="";
	var oldQty=Number(document.form1.oldQty.value);								//原报废数量
...
<tr><td class="A0011">
        <table width="688" border="0" align="center" cellspacing="5" id="NoteTable">
          ...
          <tr>
			...
			<?php 
			//员工资料表
			$PD_Sql = "SELECT M.Number,M.Name FROM $DataPublic.staffmain M LEFT JOIN $DataIn.usertable U ON U.Number=M.Number WHERE M.Estate=1 and M.JobId in ('3', '11', '14', '4')";
		...
		<tr>
		  ...
		  <td scope="col"><input name="Attached" type="file" id="Attached" size="52" DataType="Filter" Accept="jpg" Msg="文件格式不对,请重选" Row="9" Cel="1"></td>
	    </tr>
          <tr>
