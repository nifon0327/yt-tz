...
$selectIpadSql = "Select * From $DataPublic.attendanceipadsheet Where Id=$Id";
$selectIpadResult = mysql_query($selectIpadSql);
$selectIpadRow = mysql_fetch_assoc($selectIpadResult);
$floor = $selectIpadRow['Floor'];
$name = $selectIpadRow['Name'];
$cSign = $selectIpadRow['cSign'];
$Identifier = $selectIpadRow['Identifier'];
        ...
        <table width="760" border="0" align="center" cellspacing="5">
            <tr>
                ...
                while($floorRow = mysql_fetch_assoc($floorResult)){
                    ...
                    $selectState = $floorName == $floor?'selected':'';
                    echo "<option value='$floorName' $selectState>$floorName</option>";
                }
                echo "</SELECT>";
                ?>
                </td>
            ...
            <tr>
                ...
                <td scope="col"><input name="Name" type="text" id="Name" style="width:380px" value="<?php echo $name?>"></td>
            </tr>
            <tr>
                ...
                <Select id='cSign' name='cSign'>
                    <?php
                        $cSign7State = $cSign == '7'?'selected':'';
                        $cSign3State = $cSign == '3'?'selected':'';
                        echo "<option value='7' $cSign7State>包裝</option>";
                        echo "<option value='3' $cSign3State>皮套</option>";
                    ?>
                </Select></td></tr>
            <tr>
                <td width="150" height="40" align="right" scope="col">ipad识别码</td>
                <td scope="col"><input name="Identifier" type="text" id="Identifier" style="width:380px" value="<?php echo $Identifier?>"></td>
            </tr>
      </table>
</td></tr></table>
<?php 
