...
//步骤2：
ChangeWtitle("$SubCompany 新增公积金资料");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
	...
	<tr>
	  ...
	  <input name="sMonth" type="text" id="sMonth" value="<?php  echo date("Y-m")?>" size="34" maxlength="7" dataType="Month" msg="月份格式不对"></td>	  
	  	...
	  	<tr>
	  <td width="77" height="3" align="right" valign="middle" scope="col">公积金类型</td>
	...
	<tr>
	  ...
	  <td valign="middle" scope="col">
	    <select name="ListId[]" size="18" id="ListId" multiple style="width: 200px;" onclick="SearchRecord('staff','<?php  echo $funFrom?>',2,12)" dataType="PreTerm" Msg="没有指定员工" readonly>
        </select>
	    </td>
	</tr>
<tr>
