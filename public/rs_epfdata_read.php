...
$ColsNumber=12;				
$tableMenuS=500;
ChangeWtitle("$SubCompany 公积金资料");
$funFrom="rs_epfdata";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|40|序号|40|员工姓名|60|公积金类型|100|部门|70|职位|70|起始月份|70|结束月份|70|缴费记录|60|备注|200|状态|40|设置日期|70|操作员|60";
$Pagination=$Pagination==""?1:$Pagination;
$Page_Size = 100;
$ActioToS="1,2,3,4,5,6,7,8,38";
//步骤3：
...
$mySql="SELECT S.Id,S.Number,S.sMonth,S.eMonth,S.Note,S.Date,S.Estate,S.Locks,S.Operator,
	...
	FROM $DataPublic.epfdata S 
    LEFT JOIN $DataPublic.staffmain M ON S.Number=M.Number
    LEFT JOIN $DataPublic.rs_sbtype T  ON S.Type=T.Id
	WHERE 1  $SearchRows  ORDER BY  M.Estate DESC,S.Estate DESC,M.BranchId,M.JobId,M.Number,S.Id DESC";	//AND M.cSign='$Login_cSign' 
//echo $mySql;
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		$ValueArray=array(
			...
			array(0=>"<a href='../public/staff_gjjview.php?f=$ViewNumber' target='_blank'>查看</a>",1=>"align='center'"),
