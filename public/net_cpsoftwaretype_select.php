<?php 
//电信-ZX  2012-08-01
//步骤1 $DataPublic.net_softwaretype 二合一已更新
include "../model/modelhead.php";
//步骤2：
ChangeWtitle("$SubCompany 软件分类查询");			//需处理
...
//步骤4：需处理
$CheckTb="$DataPublic.net_softwaretype";
?>
		...
		<td class="A0011">
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <TD width="343"><INPUT name=value[] class=textfield id="value[]" size=40>
                    <input name="table[]" type="hidden" id="table[]" value="dimissiontype">
