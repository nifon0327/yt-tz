...
//步骤2：
ChangeWtitle("$SubCompany 客户退款查询");			//需处理
	  ...
	  <TR>
          ...
          value="<=">&lt;=</OPTION>
				  ...
				  <select name=value[] id="value[]" style="width: 274px;">
					...
					WHERE 1 AND S.Mid>0 AND D.TypeId='9104' GROUP BY S.BuyerId ORDER BY S.BuyerId",$link_id);
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <TD><select name=value[] id="value[]" style="width: 274px;">
					...
					WHERE 1 AND S.Mid>0  AND D.TypeId='9104'  GROUP BY S.CompanyId ORDER BY P.Letter",$link_id);
