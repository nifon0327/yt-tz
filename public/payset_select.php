...
//步骤2：
ChangeWtitle("$SubCompany 薪资基础数据查询");			//需处理
...
至
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate"></TD>
                  ...
                  <TD width="118" align="right">介 绍 人
          ...
          selected>=</OPTION>
			 ...
			 <?php 
			 $Result1 = mysql_query("SELECT M.Number,M.Name 
			 FROM $DataPublic.staffmain M ,$DataPublic.staffmain I 
			 WHERE I.Introducer=M.Number AND M.Estate=1 
			 GROUP BY I.Introducer
			 ORDER BY M.BranchId,M.JobId,M.Id",$link_id);
...
<TR>
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <TD width="343"><select name=value[] id="value[]" style="width: 274px;">
                   <option value="" selected>全部</option>
                   <?php 
			$J_Result=mysql_query("SELECT Id,Name FROM $DataPublic.jobdata ORDER BY Id",$link_id);
			...
			?>			  
                ...
                value="isNum" />
                  ...
                  <TD width="118" align="right">员工 I D
                ...
                <TR>
                  ...
                  <TD>
					  <select name=value[] id="value[]" style="width: 274px;">
						...
						<?php 
						$outResult=mysql_query("SELECT * FROM $DataPublic.kqtype ORDER BY Id",$link_id);
