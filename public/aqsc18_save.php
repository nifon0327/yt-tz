...
if($Attached!=""){//有上传文件
	...
	$PreFileName="18_".$datelist.$FileType;
	$Attached=UploadFiles($OldFile,$PreFileName,$FilePath);
	if ($Attached!=""){		
		$Caption=FormatSTR($Caption);
		$Checker=FormatSTR($Checker);
		$IN_recode="INSERT INTO $DataPublic.aqsc18 (Id,Caption,Attached,Checker,Date,Estate,Locks,Operator) VALUE (NULL,'$Caption','$PreFileName','$Checker','$DateTime','1','0','$Operator')";
