...
//步骤2：
ChangeWtitle("$SubCompany 安全管理制度汇编记录查询");			//需处理
	...
	<tr>
		<td class="A0011"><p>&nbsp;</p>
			<TABLE width="572" border=0 align="center">
              <TBODY>
				<TR>
                  <TD width="89" align="right">分类 I D
                    <input name="Field[]" type="hidden" id="Field[]" value="Id"></TD><TD width="92" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
