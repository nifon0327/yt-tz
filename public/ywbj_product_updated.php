...
//步骤2：
$Log_Item="报价产品资料";		//需处理
$upDataSheet="$DataIn.ywbj_productdata";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
			$Remark=FormatSTR($Remark);//去连续空格,去首尾空格
			$SetStr="CompanyId='$CompanyId',TypeId='$TypeId',Remark='$Remark',Date='$DateTime',Operator='$Operator',Locks='0'";
