...
//步骤2：
ChangeWtitle("$SubCompany 新增补仓记录");//需处理
...
$CustomFun="<span onclick='SearchRecord()' $onClickCSS>加入补仓配件</span>&nbsp;";
...
$GYS_Sql ="SELECT M.CompanyId,P.Forshort,P.Letter 
	...
	WHERE 1 GROUP BY M.CompanyId ORDER BY P.Letter";
...
function CheckForm(){
	...
	if(Message!=""){
		...
		document.form1.action="ck_bc_save.php";
...
function SearchRecord(){
	...
	var num=Math.random();  
	BackStuffId=window.showModalDialog("ck_bc_s1.php?r="+num+"&Jid="+Jid+"&tSearchPage=ck_th&fSearchPage=ck_bc&SearchNum=2&Action=2","BackStuffId","dialogHeight =500px;dialogWidth=930px;center=yes;scroll=yes");
	if (BackStuffId){
		...
		for(var i=0;i<Rowslength;i++){
			...
			if(Message==""){
				...
				oTD.innerHTML="<input type='text' name='thQTY[]' id='thQTY' size='4' class='I0000L' value='"+FieldArray[2]+"' onblur='Indepot(this,"+FieldArray[2]+")' onfocus='toTempValue(this.value)'>";
				oTD.className ="A0101";
				oTD.align="center";
				oTD.width="60";
