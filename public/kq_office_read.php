...
$mySql="SELECT C.Id,C.CheckTime,C.CheckType,C.dFrom,C.Estate,C.Locks,C.ZLSign,C.KrSign,
C.Number,M.Name,M.BranchId,M.JobId,G.GroupName
...
WHERE 1 $SearchRows AND (M.BranchId NOT IN ( 6, 7, 8 ) AND M.JobId NOT IN ( 10, 38 )) ORDER BY  M.BranchId,M.GroupId,M.Number,C.CheckTime";
...
if($myRow = mysql_fetch_array($myResult)){
	...
	do{
		...
		include "kqcode/kq_office_".$CheckType.".php";
