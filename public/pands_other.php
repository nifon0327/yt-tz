...
//步骤2：
ChangeWtitle("$SubCompany BOM的其它功能操作");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
    ...
    <tr>
      ...
      <td align="right" class="A0100">            <input name="ALType" type="hidden" id="ALType" value="<?php  echo $ALType?>">
                <span class="redB">本页操作请谨慎,修改后的产品需审核</span></td>
    </tr>
    <tr>
      <td width="241">指定产品
       </td>
    ...
    <tr>
      <td width="241" rowspan="9" align="center" valign="top" class="A0100"><select name="ListId[]" size="21" id="ListId" multiple style="width: 230px;" onclick="SearchRecord('productdata','<?php  echo $funFrom?>',2,6)">
      </select></td>
