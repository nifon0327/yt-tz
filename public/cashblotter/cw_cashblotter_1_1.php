...
FROM $DataIn.cw1_fkoutmain A LEFT JOIN $DataPublic.my2_bankinfo B ON B.Id=A.BankId WHERE A.Id='$Id_Remark'",$link_id);
...
if($checkRow=mysql_fetch_array($checkSql)){
	...
	if($checkSheetRow=mysql_fetch_array($checkSheetSql)){
		...
		do{
			...
			$Operator=($checkSheetRow["Operator"]=="")?"&nbsp;":$checkSheetRow["Operator"];
