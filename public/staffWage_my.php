...
else
{
	...
	$sumCols="11,15,22,23,24,25,29";		//求和列
...
//步骤6：需处理数据记录处理
//初始化
$sumDx=$sumGljt=$sumGwjt=$sumJj=$sumShbz=$sumZsbz=$sumJtbz=$sumJbf=$sumYxbz=$sumtaxbz=$sumJz=$sumSb=$sumGjj=$sumCt=$sumKqkk=$sumdkfl=$sumRandP=$sumOtherkk=$sumAmount=$sumTotal=$sumJbjj=0;
$i=1;
...
S.Kqkk,S.dkfl,S.RandP,S.Otherkk,S.Amount,S.Estate,S.Remark,S.Locks,M.Name,M.ComeIn,M.Estate AS mEsate,M.WorkAdd,M.Id As PID,B.Name AS Branch,J.Name AS Job,E.GroupName
...
if($myRow = mysql_fetch_array($myResult)){
	do{
		...
		{
			$checkKqDataSql = "Select * From $DataIn.kqdataother Where Number = '$Number' and Month = '$SMonth'";
