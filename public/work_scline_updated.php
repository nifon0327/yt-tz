...
//步骤2：
$Log_Item="生产线设置";		//需处理
$upDataSheet="$DataPublic.workscline";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		$Name=FormatSTR($Name);
		$Remark=FormatSTR($Remark);$SetStr="Name='$Name',WorkShopId='$WorkShopId',Remark='$Remark',Date='$DateTime',Operator='$Operator',Locks='0'";
