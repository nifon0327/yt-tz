...
//步骤2：
ChangeWtitle("$SubCompany 商业险的其它功能操作");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
    ...
    <tr>
      <td  height="27" colspan="2" class="A0000">1、员工意外险替换：将员工A的商业险替换为员工B的 </td>
    </tr>
    <tr>
    <td class="A0100">&nbsp;</td>
      <td height="27"  align="left" class="A0100">
          将月份为:
            ...
            的商业险替换姓名为<input name="NewName" type="text" id="NewName" onclick="SearchData('<?php  echo $funFrom?>',1,111,2)" size="15" readonly>的商业险&nbsp;&nbsp;&nbsp;&nbsp; 
            <!--<input type="button" name="Submit" value="开始替换" onClick="CheckForm()">-->
      </td>
    </tr>
<tr><td colspan="2" height="5">&nbsp;</td></tr>
 ...
 <tr><td colspan="2">
          <table><tr>
            ...
            <tr>
               <td align="right"  >&nbsp;</td>
             <td >&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  value="新&nbsp;增&nbsp;" onclick="SearchRecord('Rs_commer','<?php  echo $funFrom?>',2,61)"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  value="删&nbsp;除"  onClick="delListRow()"></td>
  </tr>
            </table></td>
 </tr>
