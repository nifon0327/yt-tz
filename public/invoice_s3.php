...
$Th_Col="选项|60|序号|40|出货流水号|80|客户|90|Invoice名称|110|Invoice文档|80|外箱标签|60|出货金额|80|出货日期|80|货运信息|120|付款账号|100|报关方式|80|How to Ship|90|操作员|50";
$ColsNumber=17;
$tableMenuS=600;
...
if($myRow = mysql_fetch_array($myResult)){
	...
	do{
		...
		case "1"://选择产品以便进行操作
			...
			break;
		case"2"://来自新增订单
			$Bdata=$Number."^^".$Forshort."^^".$InvoiceNO."^^".$Amount."^^".$Date."^^".$Declaration;
			break;
		case "6"://多选框
		...
		*/
		...
		/*
		$BankId="<img location.href=\"#\"' style='CURSOR: pointer' onclick='upMainData(\"Ch_shippinglist_upbankID\",\"$Id\")' src='../images/edit.gif' alt='更新银行账号' width='13' height='13'>
