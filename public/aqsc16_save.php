...
if($Attached!=""){//有上传文件
	...
	$PreFileName="16_".$datelist.$FileType;
	$Attached=UploadFiles($OldFile,$PreFileName,$FilePath);
	if ($Attached!=""){		
		$Caption=FormatSTR($Caption);
		$Checker=FormatSTR($Checker);
		$IN_recode="INSERT INTO $DataPublic.aqsc16 (Id,TypeId,Caption,Attached,Checker,Date,Estate,Locks,Operator) VALUE (NULL,'$TypeId','$Caption','$PreFileName','$Checker','$DateTime','1','0','$Operator')";
