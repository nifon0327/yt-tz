		...
		if ($page==1 || $page==3){
			...
			if($myrow = mysql_fetch_array($Result)){//输出图片
				   ...
				   // include "submodel/select_datain_read.php";
				    ...
				    $ComeTime="<span class='style3'> ".$ComeArray[0]."</span>年<span class='style3'>".$ComeArray[1]."</span>月<span class='style3'>".$ComeArray[2]."</span>日";
				    $WorkName=   $myrow["WorkName"];
				     ...
				     $Job=$J_Result["Name"];
              	     if ($myrow["Photo"]==1) {
		                      $photoFile="<img src='../download/staffphoto/p".$Number.".jpg' width='165' height='196' style='margin-top:0px;margin-left:-1px;''>";
                               }
		              else{
                              $photoFile="<img src='../download/staffphoto/p".$Number.".jpg' width='165' height='196' style='margin-top:0px;margin-left:-1px;''>";
                             }
                ...
                echo "<div style= 'position:absolute; left:12px; top:15px; color:#000; font-weight:bold'>$WorkName</div> ";
				echo" <div style='margin-left:-10px;'>
						<table width='$CardW' height='292' border='0' cellspacing='0' style='margin-left:-2px;'>
							<tr>
								<td colspan='2'  valign='top' align='center'><div style='width:165px;height:196px;overflow:hidden;' id='myAwesomeElement'>$photoFile</div></td>
							</tr>
                        	<tr><td height='40' align='left' colspan='2' valign='middle'>
								<span class='style8'>&nbsp;&nbsp;&nbsp;$myrow[Name]</span></td>
                        	</tr>
							<tr><td valign='top' colspan='2' height='25' align='center'><span class='style9'>入职:</span>$ComeTime </td></tr>
							<tr><td valign='top' colspan='2' height='25' align='center'><span class='style10'>$CompanyNameStr</span></td></tr>
						</table>
						</div>";
				if($page==3){
