...
//步骤2：
ChangeWtitle("$SubCompany 新增安全生产证书");//需处理
...
<table width="<?php  echo $tableWidth?>"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="NoteTable">
  <tr>
    ...
    <td valign="top" class='A0001'><input name="EndDate" type="text" id="EndDate" value="" style="width:380px;" maxlength="60" dataType="Date" Msg="未填写" onfocus="WdatePicker()" readonly></td>
  </tr>
    <tr>
