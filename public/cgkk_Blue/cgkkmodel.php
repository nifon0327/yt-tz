...
<td width=9 align=center height=8 valign=middle >序号</td>
<td width=20 align=center valign=middle >采购单号</td>
<td width=70 align=center valign=middle >配件名称</td>	
<td width=15 align=center valign=middle >数量</td>
<td width=15 align=center valign=middle >单价</td>		
<td width=15 align=center valign=middle >金额</td>
<td width=40 align=center valign=middle >扣款原因</td>
</tr></table>";
...
<tr >
<td width=9 align=center height=$RowsHight valign=middle style=bold> </td>	
<td width=20 valign=middle>  </td>
<td width=70 align=center valign=middle style=bold>  </td>
<td width=15 align=center valign=middle style=bold>  </td>	
<td width=15 align=center valign=middle style=bold>  </td>		
<td width=15 align=center valign=middle style=bold>  </td>	
<td width=40 align=center valign=middle style=bold> </td></tr></table>" ;
...
for ($pi=1;$pi<=$Counts;$pi=$pi+1){  //1.循环输出
     ...
     if($addSign==0){  //2.新加一页
		...
		include "cgkk_Blue/HeaderS.php";  //页头
	...
	if(($$eurTableNo)!=""){   //输出表的内容。
		...
		if($$eurAppFileNo!=""){
			...
			$pdf->Image($$eurAppFileNo,$CurMargin+1,$appFileY,13,13,"jpg");
	...
	if($pi==$Counts) //说明最后一条记录情况,有了统计，则要计算统计的高度。
	{
		...
		if(($$eurTableNo)!=""){
			$tmpTableY=$pdf->GetY();
			{
				...
				$tmpTableY=$MaxContainY-$TotalH-15;
	...
	if($addSign==0)	{
	    if($pi==$Counts){ //最后一页
			include "cgkk_Blue/FooterS.php";  //最后固定页脚
		}
		else {
