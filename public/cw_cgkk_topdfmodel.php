...
<td width=24 align=center valign=middle style=bold></td>
<td width=70 align=center valign=middle style=bold></td>			
<td width=17 align=center valign=middle style=bold></td>	
<td width=17 align=center valign=middle style=bold></td>
<td width=17 align=center valign=middle style=bold></td>
<td width=40 align=center valign=middle style=bold></td>
</tr></table>" ;
$pageNo=0;
$DateMDY=date("d-M-y"); 
...
for ($pi=1;$pi<=$Counts;$pi=$pi+1){  //循环输出
	$eurTableNo="eurTableNo".strval($pi);
     if($addSign==0){  //新加一页
		...
		$pageNo=$pageNo+1;
		$pdf->FloorSign=0;		
		$Com_Pack_PI="DebitNote";
		include "cw_cgkk_topdfHeader.php";  //页头	
		
		{
			...
			<tr >
			<td width=20 bgcolor=#CCCCCC align=center height=$RowsHight valign=middle style=bold>供应商</td>	
			<td width=40 align=center valign=middle style=bold>$Forshort</td>
			<td width=20 bgcolor=#CCCCCC align=center valign=middle style=bold>采购</td>			
			<td width=35 align=center valign=middle style=bold>$CgName</td>	
		...
		//***************************************************************表标题
		{
			...
			<td width=24 align=center valign=middle style=bold>采购单流水号</td>
			<td width=70 align=center valign=middle style=bold>配件名</td>			
			<td width=17 align=center valign=middle style=bold>数量</td>
			<td width=17 align=center valign=middle style=bold>单价</td>				
			<td width=17 align=center valign=middle style=bold>金额</td>
			<td width=40 align=center valign=middle style=bold>扣款原因</td>
	...
	if($isSeal==1){
		include "cw_cgkk_topdfSeal.php";  //封印	
	 }
}
