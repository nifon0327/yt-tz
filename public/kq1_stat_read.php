...
$sumCols="";		//求和列
$Th_Col="选项|40|序号|30|月份|50|部门|50|职位|50|员工ID|50|姓名|50|应到|40|实到|40|1.5倍|50|2倍工时|50|3倍工时|50|迟到次数|40|迟到次数|40|事假|40|病假|40|有薪|40|无薪|40|缺勤工时|40|无效工时|40|旷工工时|40|有薪工时|40|夜班次数|40";
 ...
 <table border='0'    cellspacing='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word; border-top-width:0px' >
    <tr height='20' class='' align='center'>
     ...
     <td width='50' rowspan="2" class='A1101'>3倍薪<br>工时</td>
      ...
      <td width='40' rowspan='2' class='A1101'>夜班<br>次数</td>
    </tr>
...
//  C.CheckTime LIKE '$chooseMonth%'
	...
	if($chooseMonth >= "2014-03" && $chooseMonth != "2014-06")
	{
...
WHERE 1 $SearchRows ORDER BY K.Month DESC,M.Estate DESC,M.BranchId,M.JobId,K.Number";
	...
	do{
		...
		//分离职和未离职
		if($Estate==1){//在职
			$Name="<a href='kq1_checkio_count.php?Number=$Number&CheckMonth=$Month&CountType=1' target='_blank'><span class='greenB'>$Name</span></a>";
			}
		else{			//离职
			$Name="<a href='kq1_checkio_count.php?Number=$Number&CheckMonth=$Month&CountType=1' target='_blank'><span class='redB'>$Name</span></a>";
			}
		//是否已生成薪资，是，则强制锁定
		$LockRemark="";
 ...
 <table border='0'    cellspacing='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word; border-top-width:0px' >
    <tr height='20' class='' align='center'>
     ...
     <td width='50' rowspan="2" class='A0101'>3倍薪<br>工时</td>
      ...
      <td width='40' rowspan='2' class='A0101'>夜班<br>次数</td>
    </tr>
    <tr class='' align='center'>
