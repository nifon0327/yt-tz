...
//步骤4：需处理
$CheckTb="$DataPublic.staffworkadd";
?>
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
			  <tr>
			    <td align="right">地点名称
			      <input name="Field[]" type="hidden" id="Field[]3" value="Name" /></td>
          ...
          value="!=">!=</option>
			    ...
			    <td><input name="value[]2" class="textfield" id="value[]3" style="width:380px;" />
			  ...
			  <tr>
			    <td align="right">排序
			      <input name="Field[]" type="hidden" id="Field[]" value="ExtNoFirst" /></td>
			    <td align="center"><select name="fun[]" id="fun[]2" style="width: 60px;">
			      <option value="=" 
