...
$ColsNumber=6;				
$tableMenuS=600;
ChangeWtitle("$SubCompany 损益表主项目");
$funFrom="pandlmain";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|50|序号|50|项目名称|100|背景颜色|100|可用|60|操作员|80";
...
$mySql="SELECT * FROM $DataPublic.sys8_pandlmain A WHERE 1 $SearchRows ORDER BY A.Id";
