...
$sumCols="4";		//求和列
$From=$From==""?"m":$From;
ChangeWtitle("$SubCompany 测试费用待审核列表");
$funFrom="prayfortest";
//$Th_Col="选项|40|序号|35|项目ID|60|费用说明|435|费用|60|备注|40|单据|40|供应商|150|状态|40|请款人|50|请款日期|75";
//$Th_Col="选项|40|序号|40|项目ID|60|费用分类|80|请款日期|75|请款金额|60|货币类型|60|机型|120|请款说明|450|凭证|40|请款人|50|状态|40|供应商|140|备注|40";
$Th_Col="选项|40|序号|40|费用分类|80|请款日期|75|请款金额|60|货币类型|60|请款说明|450|凭证|40|请款人|50|状态|40";
...
$mySql="SELECT S.Id,S.ItemId,K.Name as KName,S.Date,S.Amount,C.Name as CName,S.ModelDetail,S.Description,S.Remark,S.Provider,S.Bill,S.Estate,S.Locks,S.Operator
