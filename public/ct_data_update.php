...
//步骤2：
ChangeWtitle("$SubCompany 更新餐厅资料");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT Name,Tel FROM $DataPublic.ct_data WHERE Id='$Id' LIMIT 1",$link_id));
$Name=$upData["Name"];
$Tel=$upData["Tel"];
//步骤4：
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
	<table width="650" border="0" align="center" cellspacing="5">
		...
		<tr>
            <td height="42" scope="col" align="right">联系电话</td>
            <td scope="col"><input name="Tel" type="text" id="Tel" value="<?php  echo $Tel?>" style="width:380px;" dataType="Tel" msg="不合要求"></td></tr>
      </table>
</td></tr></table>
<?php 
//步骤5：
