...
//$LockSql=" LOCK TABLES $DataIn.sc2_msg WRITE";$res=@mysql_query($LockSql);
//删除领料记录
$delSql = "DELETE FROM $DataIn.sc2_msg WHERE Id IN ($Ids)"; 
...
//$OPTIMIZE=mysql_query("OPTIMIZE TABLE $DataIn.sc2_msg");
//操作日志
