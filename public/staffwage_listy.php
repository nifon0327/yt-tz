...
<body>
<?php 
$mySql="SELECT X.Id,X.KqSign,X.BranchId,X.Number,X.Dx,X.Gljt,X.Gwjt,X.Jj,X.Jbjj,X.Shbz,X.Zsbz,X.Jtbz,X.Jbf,X.Yxbz,X.taxbz,X.Jz,X.Sb,X.Kqkk,X.RandP,X.Ct,
...
<tr valign="bottom">
	...
	<td width="35" align="center" >其它奖金</td>
...
<tr height="10">
  <td colspan="24" class="GZbottom" align="right">&nbsp;备注:<?php  echo $Remark ?></td>
 </tr>
<tr height="8">
  <td colspan="24"></td>
  </tr>
