...
//步骤2：
ChangeWtitle("$SubCompany 外部人员查询");			//需处理
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
				<TR>
                  <TD width="89" align="right">人员编号
                    <input name="Field[]" type="hidden" id="Field[]" value="Number"></TD><TD width="94" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <TD width="375"><INPUT name=value[] class=textfield id="value[]" style="width:380px;">
