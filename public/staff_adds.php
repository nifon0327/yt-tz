...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
        ...
        <tr>
            <td align="right" scope="col" id="red">姓&nbsp;&nbsp;&nbsp;&nbsp;名</td>
        ...
        <tr>
          <td align="right" scope="col" id="red">性 &nbsp;&nbsp;&nbsp;别</td>
          <td scope="col">
          <select name="Sex" id="Sex" style="width:380px" dataType="Require"  msg="未选择性别" >
            ...
            <option value="0">女 </option>
                ...
                <tr>
            <td height="23" align="right" scope="col" id="red">民&nbsp;&nbsp;&nbsp;&nbsp;族</td>
            <td scope="col">
            <select class=selet id=Nation style="width:380px" size=1 name=Nation dataType="Require"  msg="未选择民族">
             ...
             ?>
                ...
                <tr>
                  <td align="right" scope="col" id="red">籍&nbsp;&nbsp;贯</td>
...
<tr>
          ...
          <tr>
            ...
            <td width="113" align="right" id="red">出生日期</td>
          ...
          <tr>
          <td align="right" id="red">员工类别</td>
          <td><?php  $SelectWidth="380px"; include "../model/subselect/FormalSign.php"; ?></td>
          </tr>
          <tr>
