...
//步骤2：
ChangeWtitle("$SubCompany 关帐日期查询");			//需处理
...
//步骤4：需处理
$CheckTb="$DataPublic.sys_closingdate";
?>
		...
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
				<TR>
                  <TD width="89">关帐月份
                    <input name="Field[]" type="hidden" id="Field[]" value="Month"></TD><TD width="126"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
