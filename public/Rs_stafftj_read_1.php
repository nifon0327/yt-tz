...
$Th_Col="选项|40|序号|40|所属公司|60|体检类型|60|员工姓名|60|部门|60|职位|60|入职日期|70|金额|60|备注|250|凭证|30|体检日期|80|合格与否|60|报告单上传|70|结付状态|60|登记日期|70|操作员|60";
$Pagination=$Pagination==""?0:$Pagination;
$Page_Size = 100;
$ActioToS="1,2,3,4,7,8,14,13";
...
$mySql="SELECT 
	S.Id,S.Number,S.Month,S.Amount,S.Locks,S.Date,S.Operator,S.Estate,S.Mid,P.Name,B.Name AS BranchName,J.Name AS JobName,S.Remark,S.Attached ,S.tjType,P.ComeIn,S.CheckT,S.tjDate,S.HG,S.cSign
	 FROM $DataIn.cw17_tjsheet S
	LEFT JOIN $DataPublic.staffmain P ON S.Number=P.Number
    LEFT JOIN $DataPublic.branchdata B ON B.Id=P.BranchId
    LEFT JOIN $DataPublic.jobdata J ON J.Id=P.JobId
	WHERE 1 $SearchRows ORDER BY S.tjDate DESC";
...
$GDnumber= array("①","①","②","③","④","⑤","⑥","⑦","⑧","⑨","⑩");
	do{
            ...
            $tjDate="<img location.href=\"#\"' style='CURSOR: hand' onclick='upMainData(\"Rs_stafftj_tjDate\",\"$Id\")' src='../images/edit.gif' title='更新体检时间' width='13' height='13'><span class='yellowB'>$tjDate</span>";	
           ...
           $HG=$myRow["HG"];
            switch($HG){
                 case 1: 
                   $HG="<img location.href=\"#\"' style='CURSOR: hand' onclick='upMainData(\"Rs_stafftj_hg\",\"$Id\")' src='../images/edit.gif' title='更新合格与否' width='13' height='13'><span class='greenB'>合格</span>";
                       break;
                 case 0:
                      $HG="<img location.href=\"#\"' style='CURSOR: hand' onclick='upMainData(\"Rs_stafftj_hg\",\"$Id\")' src='../images/edit.gif' title='更新合格与否' width='13' height='13'><span class='redB'>不合格</span>";
                       break;
               }
		...
		// echo $ReportAttached;
         if($ReportAttached!=""){
		      ...
		      $d1=anmaIn("download/tjfile/",$SinkOrder,$motherSTR);		
               $FileReport="<img location.href=\"#\"' style='CURSOR: hand' onclick='upMainData(\"Rs_stafftj_tjfile\",\"$Id\")' src='../images/edit.gif' title='上传体检报告' width='13' height='13'><a href=\"openorload.php?d=$d1&f=$f2&Type=&Action=6\" target=\"download\"  style='CURSOR: hand;color:#FF6633'>View</a>";
               }
        else {
               $FileReport="<img location.href=\"#\"' style='CURSOR: hand' onclick='upMainData(\"Rs_stafftj_tjfile\",\"$Id\")' src='../images/edit.gif' title='上传体检报告' width='13' height='13'>";
                }
		$ValueArray=array(
