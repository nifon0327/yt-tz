...
$funFrom="modelfee_th";
if($Estate==3){
      $Th_Col="选项|60|序号|40|模具项目|280|最低配件数量|80|配件已采购数|80|退回金额|80|供应商|80|备注|250|凭证|40|状态|40|更新日期|65|请款人|50";
     }
else{
$Th_Col="选项|60|序号|40|结付银行|80|模具项目|280|退回金额|80|供应商|80|备注|250|凭证|40|状态|40|更新日期|65|请款人|50";
}
...
if($From!="slist"){
	...
	switch($Estate){
		case "0":			$EstateSTR0="selected";$ActioToS="1";		break;
		case "3":			$EstateSTR3="selected";$ActioToS="1,18,15";		break;
		}	
...
echo"<select name='Pagination' id='Pagination' onchange='CencelPage()'><option value='1' $Pagination1>分页</option><option value='0' $Pagination0>不分页</option></select>
  	$CencalSstr";
if($Estate==3) include "../model/selectbank1.php";
//步骤5：
include "../model/subprogram/read_model_5.php";
$i=1;
$j=($Page-1)*$Page_Size+1;
List_Title($Th_Col,"1",0);
$mySql="SELECT M.Id,M.Mid,M.Moq,M.ItemName ,M.OutAmount ,M.Remark,M.Operator,M.Date,M.Locks,M.Estate,S.Provider,B.Title  
	...
	do{
       ...
       $Provider =$myRow["Provider"];	
		...
		if($Bill==1){
         ...
         switch($Estate){
				case "3":
					$pEstate="<div align='center' class='yellowB' title='审核通过'>√.</div>";
                   break;
                case "0":
					$pEstate="<div align='center' class='greenB' title='已结付'>√.</div>";
                    $LockRemark="已结付!";
					break;
				}
			//配件已采购数量
...
if($Estate==3){
		$ValueArray=array(
			...
			array(0=>$pEstate,1=>"align='center'"),	
