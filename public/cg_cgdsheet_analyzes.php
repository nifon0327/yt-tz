...
//步骤3：
$tableWidth=1017;$tableMenuS=500;
...
$StockResult = mysql_query("SELECT 
	S.Id,S.StockId,S.POrderId,S.StuffId,S.Price,S.OrderQty,S.StockQty,S.AddQty,S.FactualQty,S.CompanyId,S.BuyerId,S.Level,
...
<table width='980' cellspacing='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word; border:1px solid #e7e7e7' bgcolor='#f5f5f5'>
	<tr <?php  echo $Fun_bgcolor?>>
		<td width='10' class='A0010' bgcolor='#FFFFFF' height='25'>&nbsp;</td>
		<td width='50' class='A1111' align='center' height='25'>操作</td>
...
<input name='oldLevel' type='hidden' id='oldLevel' value='<?php  echo $Level?>'>
...
function CheckForm(ALType){
	...
	if(Message!=""){
		...
		document.form1.action="cg_cgdsheet_updated.php";
