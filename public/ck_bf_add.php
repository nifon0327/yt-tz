...
//步骤2：
ChangeWtitle("$SubCompany 新增报废记录");//需处理
    ...
    <tr>
      <td class="A0011">
        <table width="688" border="0" align="center" cellspacing="5" id="NoteTable">
          <tr>
            <td width="64" align="right">报废日期</td>
            <td>
          ...
          <tr>
            ...
            <td>
              ...
              <select name="Type" id="Type" style="width: 500px;" dataType="Require" msg="未选择分类">
                  ...
                  $Ck8_Sql = "SELECT Id,TypeName FROM  $DataIn.ck8_bftype WHERE 1 AND Estate=1 AND mainType=1 ";
          ...
          <tr>
            ...
            <td scope="col">
              <input name="Attached" type="file" id="Attached" size="52" DataType="Filter" Accept="jpg" Msg="文件格式不对,请重选" Row="6" Cel="1">
            </td>
          </tr>
          <tr>
