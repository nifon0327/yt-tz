...
ChangeWtitle("$SubCompany 更新REACH法规图");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT TypeId,Title,Picture,IsType,Estate FROM $DataIn.stuffreach WHERE Id=$Id order by Id",$link_id));
...
<table width="<?php  echo $tableWidth?>" height="180" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="NoteTable">
  ...
  <tr>
    <td width="100" align="right" class='A0010'>认证图说明: </td>
    ...
    <tr>
      <td class='A0010' align="right">认证图存档: </td>
    <td class='A0001'><input name="Attached" type="file" id="Attached" size="67" dataType="Filter" msg="文件格式不对" accept="pdf" Row="3" Cel="1"></td>
    </tr>
    ...
    <tr>
         ...
         <td class='A0001'>"新设为【类】REACH法规图"将清除已与配件存在的对应连接关系。</td>
     </tr>
</table>
<?php 
//步骤5：
