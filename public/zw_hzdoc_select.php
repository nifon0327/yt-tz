...
//步骤2：
ChangeWtitle("$SubCompany 行政文件查询");			//需处理
			...
			<TABLE width="600" border=0 align="center">
			  <TR>
                ...
                <TD><select name=value[] id="value[]" style="width: 274px;">
                  <?php 
					//分类表
					$PD_Sql = "SELECT D.TypeId,T.Name FROM $DataIn.zw2_hzdoc D LEFT JOIN $DataPublic.zw2_hzdoctype T ON T.Id=D.TypeId GROUP BY D.TypeId ORDER BY D.TypeId";
              ...
              <TBODY>
                <TR>
                  <TD width="108" align="right"><p>文件说明
