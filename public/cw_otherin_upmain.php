...
$upDataMain="$DataIn.cw4_otherinmain";
ChangeWtitle("$SubCompany 更新其他收入结付资料");
$fromWebPage=$funFrom."_cw";		
$nowWebPage =$funFrom."_upmain";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：
$MainResult = mysql_query("SELECT PayDate,PayAmount,Payee,Receipt,Checksheet,Remark,Locks,BankId FROM $upDataMain WHERE Id='$Mid' LIMIT 1",$link_id);
...
$Parameter="ActionId,20,Mid,$Mid,oldPayDate,$PayDate,funFrom,$funFrom,From,$From,Estate,0,Pagination,$Pagination,Page,$Page,fromWebPage,$fromWebPage,PayAmount,$PayAmount";
//步骤4：//需处理
?>
