<?php 
//mc 验厂文件 ewen 2013-08-03 还需处理
/*
2013-05前记录按原方法处理

2013-05后记录：
工作日、周六的正常班：签退记录显示不超过20:30；临时班：上班时间显示不超过10小时的签退时间
周日、法定假日的记录不显示
...
//是否存在调班？是,则工作日变休息日,休息日变工作日
		...
		switch($CheckType){
				...
				break;
				case "O":
					$EndTimeGap=strtotime($CheckTime)-strtotime(substr($CheckTime,0,10)." 20:00:00");
