...
//步骤2：
ChangeWtitle("$SubCompany 生产登记");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_register";	
...
if($upRow = mysql_fetch_array($upResult)){
	...
	//已完成数量
	$CheckCfQty=mysql_fetch_array(mysql_query("SELECT SUM(C.Qty) AS cfQty FROM $DataIn.sc1_cjtj C WHERE C.POrderId='$POrderId' AND C.TypeId='$ItemId'",$link_id));
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
	<table width="80%" height="143" border="0" cellpadding="5" cellspacing="0" align="center">
      ...
      <tr>
        ...
        <td valign="middle" scope="col" class="A0101"><input name='Date' type='text' id='Date' size='79' maxlength='7' value="" onfocus="WdatePicker()"></td>
      </tr>
      <tr>
        <td height="25" align="right" scope="col" class="A0111">本次登记数量</td>
        <td valign="middle" scope="col" class="A0101"><input name='NowQty' type='text' id='NowQty' onfocus="toTempValue(this.value)" onblur="Outdepot(this)" value="" size='79' max="<?php  echo $UnPQtys?>" min="0" dataType="Range"  msg="格式不对"></td>
      </tr>
      <tr>
