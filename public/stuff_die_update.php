...
ChangeWtitle("$SubCompany 更新配件模具关系");//需处理
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
$Id=$Id==""?$StuffId:$Id;//重置
$Parameter="fromWebPage,$fromWebPage,funFrom,$funFrom,From,$From,Pagination,$Pagination,Page,$Page,StuffId,$Id";
//步骤3：
...
$StuffCname=$P_Row["StuffCname"];

$SelectCode=" ($Id) &nbsp;<b>  $StuffCname  </b><input name='StuffCname' type='hidden' id='StuffCname' value='$StuffCname'><input name='StuffId' type='hidden' id='StuffId' value='$Id'>";
include "../model/subprogram/add_model_pt.php";
?>
<table border="0" width="<?php    echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr bgcolor='<?php    echo $Title_bgcolor?>' >
		<td width="10" class="A0010" height="25">&nbsp;</td>
		<td height="25"  width='850' class="A0111">
		...
		<td   height="336" class="A0111">
			...
			<?php   
       $S_Result = mysql_query("SELECT G.GoodsId,G.GoodsName,G.Attached,G.Price,M.Forshort
		...
		if($S_Row=mysql_fetch_array($S_Result)) {//如果设定了产品配件关系
			...
			$j=1;
			do{
                 $GoodsId=$S_Row["GoodsId"];
				$GoodsName=$S_Row["GoodsName"];
				$GoodsForshort=$S_Row["Forshort"];
				$GoodsPrice=$S_Row["Price"];

				echo"<tr>
				<td align='center' class='A0101' width='40' height='25' onmousedown='window.event.cancelBubble=true;'>
				 <a href='#' onclick='deleteRow(this.parentNode)' title='删除当前行'>×</a>
				</td>
		   			<td align='center' class='A0101' width='50'>$j</td>
		   			<td class='A0101' width='50' align='center'>$GoodsId</td>
				   <td class='A0101' width='350' >$GoodsName</td>
				   	<td class='A0101'  width='150'>$GoodsForshort</td>
				   <td class='A0101' align='center'>$GoodsPrice</td>
