...
ChangeWtitle("$SubCompany 主产品分类");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
$upData = mysql_fetch_array(mysql_query("SELECT * FROM $DataPublic.stuffmaintype WHERE Id='$Id'",$link_id));
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td class="A0011">
      <table width="760" border="0" cellspacing="5">
        <tr>
          <td width="120" height="40" align="right" scope="col">分类名称</td>
