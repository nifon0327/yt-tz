...
//步骤2：
ChangeWtitle("$SubCompany 新增请假分类");//需处理
	...
	<table width="650" border="0" align="center" cellspacing="5">
		<tr>
          <td width="100" height="31" align="right" scope="col">分类名称</td>
            <td scope="col"><input name="Name" type="text" id="Name" style="width:380px;" maxlength="16" title="必选项,在20个汉字内." dataType="LimitB" min="1" max="16" msg="未填写或超出16个字"></td></tr>
          <tr>
            <td align="right" valign="top">备 &nbsp;&nbsp;&nbsp;注</td>
            <td><textarea name="Remark" style="width:380px;"  rows="6" id="Remark" dataType="Require" Msg="未填写备注"></textarea></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input name="Days" type="text" id="Days" style="width:380px;" maxlength="2" dataType="Number" Msg="未填写或超出许可值"></td>
          </tr>
          <tr>
