	...
	<tr><td class="A0011">
      <table width="760" border="0" cellspacing="5">
        <tr>
          ...
          <td scope="col"><input name="Name" type="text" id="Name" title="可输入2-16个字节(每1中文字占2个字节，每1英文字母占1个字节)" value="" style="width:380px;" maxlength="16" DataType="LimitB"  Max="16" Min="2" Msg="没有填写或字符不在2-16个字节内"></td>
        </tr>
        <tr>
          <td width="100" height="40" align="right" scope="col">项目序号</td>
          <td scope="col"><input name="SortId" type="text" id="SortId" title="输入数字" value="" style="width:380px;" maxlength="16" DataType="Number"  Msg="没有填写或格式不对"></td>
        </tr>
      </table>
</td></tr></table>
