<?php 
//电信-joseph
//步骤1 $upDataSheet="$DataPublic.branchdata"; 二合一已更新
...
//步骤2：
$Log_Item="物品分类";		//需处理
$upDataSheet="$DataPublic.zw_goodstype";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		$Name=FormatSTR($Name);
		$SetStr="Name='$Name',mainType='$mainType',Remark='$Remark',Date='$DateTime',Operator='$Operator',Locks='0'";
