...
//步骤2：
ChangeWtitle("$SubCompany 等级津贴查询");			//需处理
		...
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
                <TR>
                  <TD width="89">等&nbsp;&nbsp;&nbsp;&nbsp;级
                      <input name="Field[]" type="hidden" id="Field[]" value="Grade">
                  </TD>
...
<TR>
                  <TD>岗位津贴
                      <input name="Field[]" type="hidden" id="Field[]" value="Subsidy">
                  </TD>
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate">
                ...
                <TR>
				  ...
				  <select name=value[] id="value[]" style="width:380px;">
                    <?php 
					$CheckTb="$DataPublic.gradesubsidy";
