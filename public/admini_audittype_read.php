...
$ColsNumber=10;	
$tableMenuS=600;
ChangeWtitle("$SubCompany 行政审核分类");
$funFrom="admini_audittype";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|50|序号|50|分类名称|150|审核人|80|可用|60|更新日期|150|操作员|80";
...
$mySql="SELECT A.Id,A.Name,A.Estate,A.Locks,A.Date,A.Operator,B.Name AS StaffName
     FROM $DataPublic.admini_audittype A 
