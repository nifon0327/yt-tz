	...
	do{
		...
		if(($aiTime!="" || $aoTime!="") || $GTime>0) {
			...
			$inRecode1="INSERT INTO $DataIn.kqrtj 
					SELECT NULL,Number,'$GTime','$WorkTime','$GJTimeAll','$XJTimeAll','$FJTimeAll','$InLates','$OutEarlys','$QjTime1','$QjTime2','$YXJhours','$QjTime3','$QQTime','$YBs','$KGTime','$CheckDate','0',10,'$Operator',NOW(),'$Operator',NOW()
