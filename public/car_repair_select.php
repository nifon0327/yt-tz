...
//步骤2：
ChangeWtitle("$SubCompany 车辆维修记录查询");			//需处理
	...
	<tr>
		<td class="A0011">
          ...
          value="&lt;=">&lt;=</option>
              ...
              <?php 
             $CarSql=mysql_query("SELECT DISTINCT A.CarId,B.CarNo from $DataPublic.car_repair A LEFT JOIN $DataPublic.cardata B ON B.Id=A.CarId ",$link_id);
		     if($CheckRow=mysql_fetch_array($CarSql)){
		      ...
		      ?>
			   ...
			   <TR>
                  <TD align="right">维修人
                      <input name="Field[]" type="hidden" id="Field[]" value="Reperson">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <OPTION value== 
                  ...
                  <option value="" selected>请选择</option>
					<?php 
					$PersonSql=mysql_query("select DISTINCT Reperson FROM  $DataPublic.car_repair",$link_id);
			   ...
			   <tr>
                   <td align="right">维修费用
                      <input name="Field[]" type="hidden" id="Field[]" value="Recharge ">
                   </td>
