...
//步骤2：
$Log_Item="关帐日期设置";		//需处理
$upDataSheet="$DataPublic.sys_closingdate";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$SetStr="ClosingDate='$ClosingDate',Remark='$Remark',Date='$Date',Locks='0',Operator='$Operator',modifier='$Operator',modified='$DateTime'";
