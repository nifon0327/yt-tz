...
//步骤2：
ChangeWtitle("$SubCompany 报修项目查询");			//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    至
      ...
      <input name="types[]" type="hidden" id="types[]" value="isDate">
              ...
              <TBODY>
                <TR>
                  <TD width="105" align="right">报修事项
                    <input name="Field[]" type="hidden" id="Field[]" value="Remark1">
                  </TD>
          ...
          value=!=>!=</OPTION>
                ...
                <TR>
                  <TD align="right">处 理 人
                      <input name="Field[]" type="hidden" id="Field[]" value="Servicer">
                  </TD>
                  <TD align="center"><select name="fun[]" id="fun[]" style="width: 60px;">
                      <option value="=" selected>=</option>
                      <option value="!=">!=</option>
                  ...
                  <TD><select name=value[] id="value[]" style="width: 274px;">
                      <option value="" selected>全部</option>
                      <option value="10002">廖文远</option>
                      <option value="10045">李耀文</option>
                                      </select>
                      <input name="table[]" type="hidden" id="table[]" value="B">
                      <input name="types[]" type="hidden" id="types[]"
                value="isNum" />
                ...
                <TR>
                  <TD align="right">报修状况
                    <input name="Field[]" type="hidden" id="Field[]" value="Remark2">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <option value="LIKE" selected>包含</option>
          ...
          value=!=>!=</OPTION>
                ...
                <TR>
                  <TD align="right">备&nbsp;&nbsp;&nbsp;&nbsp;注
                    <input name="Field[]" type="hidden" id="Field[]" value="Remark3">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <option value="LIKE" selected>包含</option>
