...
S.Id,S.Mid,S.Number,S.Month,S.oHours,S.oWage,S.xHours,S.xWage,S.fHours,S.fWage,S.oRandP,S.Amount,
S.Date,S.Estate,S.Locks,S.Operator,P.Name,J.Name AS Job,B.Name AS Branch,BK.Title,M.cSign
 	FROM $mainData M
...
if($mainRows = mysql_fetch_array($mainResult)){
	...
	do{
		...
		if($midDefault!="" && $midDefault==$Mid){//同属于一个主ID，则依然输出明细表格
			...
			$m=$m+2;
			echo"<td  class='A0001' width='$Field[$m]' align='center'>$oWage</td>";
			$m=$m+2;
			echo"<td  class='A0001' width='$Field[$m]' align='center'>$oHours</td>";
			$m=$m+2;
			...
			$m=$m+2;
			echo"<td  class='A0001' width='$Field[$m]' align='center'>$oRandP</td>";
			$m=$m+2;
