...
//步骤2：
ChangeWtitle("$SubCompany 新增显示屏记录");//需处理
     ...
     <td class='A0011'>
	  <table width="700" border="0" align="center" cellspacing="5">
        ...
        <td scope="col"><input name="Floor" type="text" id="Floor" style="width:380px"  dataType="Require"  msg="未填写"></td>
         ...
         <td scope="col"><input name="Port" type="text" id="Port" style="width:380px" dataType="Require"  msg="未填写"></td>
         </tr>
         <tr>
         <td scope="col" align="right">URL</td>
         <td scope="col"><input name="Url" type="text" id="Url" style="width:380px" dataType="Require"  msg="未填写"></td>
         </tr>
     </table>
    </td>
  </tr>
