...
//步骤2：
$Log_Item="工作地点";		//需处理
$upDataSheet="$DataPublic.staffworkadd";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		$Name=FormatSTR($Name);
		$SetStr="Name='$Name',ExtNoFirst='$ExtNoFirst',Address='$Address',ColorValue='$SelColor',Date='$DateTime',Operator='$Operator',Locks='0'";
