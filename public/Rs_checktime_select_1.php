<?php 
//电信-ZX  2012-08-01
//步骤1 $DataPublic.redeployg 二合一已更新
include "../model/modelhead.php";
//步骤2：
ChangeWtitle("$SubCompany 考勤调动资料查询");           //需处理
...
<TR>
          ...
          value=!=>!=</OPTION>
                ...
                <TR>
                  <TD width="119" align="right">原始时间
                      <input name="Field[]" type="hidden" id="Field[]" value="oldChecktime">
                  </TD>
