...
$title = $TypeId=='1'?'社保':'公积金';
$objPHPExcel->getActiveSheet()->getRowDimension('1')->setRowHeight(20);
$objPHPExcel->getActiveSheet()->mergeCells("A1:O1"); 
$objPHPExcel->getActiveSheet()->setCellValue("A1", "$title $chooseMonth 资料表");
...
$mySql="SELECT A.TypeId,A.Month,A.mAmount,A.cAmount, B.Name
        ...
        WHERE A.Month='$chooseMonth' AND A.TypeId=$TypeId";
// echo $mySql;
// exit();
...
header('Content-Disposition: attachment;filename='.$title.' '.$chooseMonth.'xlsx');
