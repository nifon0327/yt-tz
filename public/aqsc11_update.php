...
ChangeWtitle("$SubCompany 安全生产证书更新");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT * FROM $DataPublic.aqsc11 A WHERE A.Id='$Id' ORDER BY A.Id LIMIT 1",$link_id));
...
<tr>
    <td width="100" height="30" align="right" valign="top" class='A0010'>证书类型</td>
	  <td valign="top" class='A0001'><?
            include "../model/subselect/aqsc11type.php";
			?></td>
    </tr>
    <tr>
      <td height="30" align="right" valign="top" class='A0010'>证书说明</td>
    ...
    <tr>
      <td height="30" align="right" valign="top" class='A0010'>有效日期至</td>
    <td valign="top" class='A0001'><input name="EndDate" type="text" id="EndDate" value="<?php echo $upData["EndDate"];?>" style="width:380px;" maxlength="60" dataType="Date" Msg="未填写" onfocus="WdatePicker()" readonly></td>
  </tr>
    <tr>
      <td height="30" align="right" valign="top" class='A0010'>证书附件</td>
