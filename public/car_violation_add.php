...
//步骤2：
ChangeWtitle("$SubCompany 新增违规记录");//需处理
    ...
    <tr>
     <td class='A0011'>
      ...
      <tr>
        ...
        <td><input name="Person" type="text" id="Person" style="width:380px" maxlength="10" dataType="Require"  msg="未填写"></td>
         </tr>	  
	  	 <tr>
        <td width="101" align="right">违规费用</td>
        <td><input name="Charge" type="text" id="Charge" style="width:380px" maxlength="10" dataType="Currency"  msg="未填写"></td>
         </tr>	  
	  
	  	 <tr>
        <td width="101" align="right">违规时间</td>
        <td><input name="Date" type="text" id="Date" style="width:380px" value="<?php  echo Date("Y-m-d")?>" onfocus="WdatePicker()" readonly></td>
         </tr>	  
	   <tr>
        <td width="101" align="right">原因</td>
        <td><textarea name="Reason" style="width:380px" rows="3" id="Reason" dataType="Require"  msg="未填写"></textarea></td>
         </tr>	
	 </table>
    </td>
  </tr>
