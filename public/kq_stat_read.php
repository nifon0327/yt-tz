...
?>
 <table border='0'    cellspacing='0' style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word; border-top-width:0px' >
    <tr height='20' class='' align='center'>
      ...
      <td width='90' colspan="3" class='A1101'>1.5倍薪工时</td>
      <td width='90' colspan="3" class='A1101'>2倍薪工时</td>
      <td width='90' colspan="3" class='A1101'>3倍薪工时</td>
...
K.WXhours,K.KGhours,K.dkhours,K.YBs,K.Locks,M.Name,M.Estate,B.Name AS Branch,J.Name AS Job, C.GroupName
FROM $DataIn.kqdata K 
LEFT JOIN $DataIn.staffmain M ON M.Number=K.Number 
