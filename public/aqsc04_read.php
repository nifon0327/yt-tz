...
ChangeWtitle("$SubCompany 安全生产培训教程");
$Th_Col="选项|45|序号|45|分类|80|教程名称|400|附件|40|应用记录|60|更新日期|80|操作员|60";
//步骤3：
include "../model/subprogram/read_model_3.php";
if($From!="slist"){
	$SearchRows ="";
	//类型
    $TypeResult = mysql_query("SELECT * FROM  $DataPublic.aqsc04_type WHERE Estate='1' ORDER BY Id",$link_id);
...
FROM $DataPublic.aqsc04 A
LEFT JOIN $DataPublic.aqsc04_type B ON B.Id=A.TypeId 
