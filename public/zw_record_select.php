<?php 
/*
$DateSharing.net_cpdata
$DateSharing.staffmain
二合一已更新
*/
//步骤1
include "../model/modelhead.php";
//步骤2：
ChangeWtitle("$SubCompany 资产资料查询");			//需处理
              ...
              <TBODY>
                ...
                <TR>
                  ...
                  <TD width="366"><select name=value[] id="value[]" style="width: 274px;">
                    <?php 
					$stSql = "SELECT Id,Name FROM $DataIn.net_facilitytype WHERE Estate=1 and Id IN(1,2,6) order by Id";
