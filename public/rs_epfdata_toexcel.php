...
$objPHPExcel->getActiveSheet()->setCellValue("A1", "公积金".date("Y-m")."资料表");
...
$mySql="SELECT A.TypeId,A.Month,A.mAmount,A.cAmount, B.Name
        ...
        WHERE A.Month='$currentMonth' AND A.TypeId=2";
...
header('Content-Disposition: attachment;filename=公积金'.$currentMonth.'.xlsx');
