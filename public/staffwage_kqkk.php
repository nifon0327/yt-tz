...
if ($Number!=""){
   ...
   if ($Kqkk>0){
    ...
    echo "迟到、早退次数扣款:&nbsp;&nbsp;" . ($InLates+$OutEarlys)*20 . "</br></br>";								//迟到、早退次数扣款
    echo "不在职扣款:&nbsp;&nbsp;" . intval($Wxkk). "</br></br>";												//不在职扣款
    echo "事假、缺勤、旷工扣补助:&nbsp;&nbsp;($SJhours+$QQhours+$KGhours)*25=" . intval(($SJhours+$QQhours+$KGhours)*25)	. "</br></br>";											//事假、缺勤、旷工扣补助
    echo "事假、缺勤、旷工扣底薪:&nbsp;&nbsp;($SJhours+$QQhours+$KGhours)*$oneHours=" . intval($DxKk)	. "</br></br>";											//事假、缺勤、旷工扣底薪
