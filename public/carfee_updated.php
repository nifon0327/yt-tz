...
//步骤2：
$Log_Item="车辆费用";		//需处理
$upDataSheet="$DataIn.carfee";	//需处理
$upDataMain="$DataIn.carfeemain";	//需处理
$Log_Funtion="更新";
...
switch ($ActionId){
	...
	default:
		...
		if($Estate==0){
			$SetStr="TypeId='$TypeId',FirstId='$FirstId',Content='$Content',modifier='$Operator',modified='$DateTime' $BillSTR";
			}
		else{
			
			$SetStr="cSign = '$cSign',TypeId='$TypeId',FirstId='$FirstId',CarId='$CarId',Date='$theDate',Amount='$Amount',
			Currency='$Currency',sCourses='$sCourses',eCourses='$eCourses',Content='$Content'  $BillSTR";
			}
