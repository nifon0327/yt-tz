...
$ColsNumber=16;				
$tableMenuS=550;
ChangeWtitle("$SubCompany 显示屏管理列表");
$funFrom="display";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|50|序号|30|楼层|60|设备编号|60|显示屏名称|100|IP|100|端口号|50|URL|350|状态|30";
...
if($From!="slist"){
	...
	$camResult = mysql_query("SELECT DISTINCT C.WorkAdd,W.Name  FROM  $DataPublic.ot2_display C 
...
$mySql="SELECT C.*,W.Name AS WorkAddName 
    FROM $DataPublic.ot2_display C 
    LEFT JOIN $DataPublic.staffworkadd W ON C.WorkAdd=W.Id
   WHERE 1 $SearchRows ORDER BY C.WorkAdd,C.Floor";
//echo $mySql;
