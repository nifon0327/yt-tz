...
$From=$From==""?"m":$From;
if($StuffType!=9040){
	$Th_Col="选项|55|序号|40|配件Id|50|配件名称|320|图档|30|图档日期|70|历史<br>订单|40|QC图|40|认证|40|开发|40|品检</br>方式|40|状态|30|参考买价|60|单位|40|装箱数量|60|配件类型|60|默认供应商|100|采购|50|交货<br>周期|40|送货</br>楼层|40|规格|120|主产品<br>重(g)|50|在库|55|可用库存|55|最低库存|55|购买选择|50|备注|30|更新日期|80|下单需求|80|图片职责|80|图档职责|80|图档审核|60|操作|50";
	}
else{
	$Th_Col="选项|55|序号|40|配件Id|50|配件名称|280|图档|30|图档日期|70|历史<br>订单|40|QC图|40|认证|40|开发|40|品检</br>方式|40|状态|30|参考买价|60|单位|40|装箱数量|60|配件类型|60|默认供应商|100|采购|50|交货<br>周期|40|送货</br>楼层|40|规格|120|主产品<br>重(g)|50|承重<br>(kg)|40|在库|55|可用库存|55|最低库存|55|购买选择|50|备注|30|更新日期|80|下单需求|80|图片职责|80|图档职责|80|图档审核|60|操作|50";
	}
...
G.ForcePicSign,G.jhDays AS TypeJhDays,D.Name AS UnitName,B.CompanyId
