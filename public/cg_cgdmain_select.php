    ...
    至
      ...
      <input name="types[]" type="hidden" id="types[]"
          ...
          value="<=">&lt;=</OPTION>
                ...
                <TD><INPUT name=value[] class=textfield id="value[]" size=18 onfocus="set_weekdate(this,'')" readonly>
    至
      <INPUT name=DateArray[] class=textfield id="DateArray[]" size=18 onfocus="set_weekdate(this,'')" readonly>
      <input name="table[]" type="hidden" id="table[]" value="S">
      <input name="types[]" type="hidden" id="types[]"
                value="isDate" />
                </TD>
...
function set_weekdate(el,StockId){
	  ...
	  var saveFun=function(){
			     if (weekdate.Value>0){
						   ...
						   thisele.value=tempDeliveryDate;
						   /*
