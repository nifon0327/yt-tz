...
$inRecode= "INSERT INTO $DataIn.ck8_bfsheet  SELECT NULL,'$ProposerId',StuffId,'$Qty','$LocationId','$Remark','$Type','0','','','2','$bfDate','1','0','$Operator','$DateTime',0,'$Operator','$DateTime','$Operator','$DateTime'
