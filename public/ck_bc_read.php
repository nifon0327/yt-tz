...
function zhtj(obj){
	...
	document.form1.action="ck_bc_read.php";
...
$ColsNumber=14;
$tableMenuS=500;
ChangeWtitle("$SubCompany 物料补仓列表");
$funFrom="ck_bc";
$From=$From==""?"read":$From;
$sumCols="5";			//求和列,需处理
$MergeRows=3;
$Th_Col="操作|40|补仓日期|70|送货单号|75|选项|40|序号|40|配件Id|50|配件名称|300|单位|40|补仓数量|60|备注|60";

//必选，分页默认值
$Pagination=$Pagination==""?1:$Pagination;	//默认分页方式:1分页，0不分页
$Page_Size = 300;							//每页默认记录数量
//$ActioToS="1,2,3,4,7,8";
$ActioToS="1,3,4,7,8"; //开送货单新增，不能直接新增
//步骤3：
...
if($From!="slist"){	//非查询：过滤采购、结付方式、供应商、月份
	...
	$providerSql = mysql_query("SELECT M.CompanyId,P.Forshort,P.Letter 
			FROM $DataIn.ck3_bcmain M,$DataIn.trade_object P 
