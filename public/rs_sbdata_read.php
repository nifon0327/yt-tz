...
$Th_Col="选项|40|序号|40|员工ID|50|员工姓名|60|社保类型|100|部门|70|职位|70|起始月份|70|结束月份|70|缴费记录|60|备注|200|状态|40|设置日期|70|操作员|60";
...
$mySql="SELECT S.Id,S.Number,S.sMonth,S.eMonth,S.Note,S.Date,S.Estate,S.Locks,S.Operator,
	...
	FROM $DataIn.sbdata S 
    LEFT JOIN $DataIn.staffmain M ON S.Number=M.Number
    LEFT JOIN $DataIn.rs_sbtype T  ON S.Type=T.Id
	WHERE 1  $SearchRows   ORDER BY  M.Estate DESC,S.Estate DESC,M.BranchId,M.JobId,M.Number,S.Id DESC";	
//echo $mySql;
