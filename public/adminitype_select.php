...
//步骤2：
ChangeWtitle("$SubCompany 行政分类查询");			//需处理
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
			  <tr>
			    <td>审核分类
			      <input name="Field[]2" type="hidden" id="Field[]2" value="AuditType" /></td>
			    ...
			    <td>
			      <?php 
					include "../model/subselect/admini_audittype.php";//EWEN 2012-11-02
					?>
              ...
              <TBODY>
				<TR>
                  <TD width="89">分类 I D
                    <input name="Field[]" type="hidden" id="Field[]" value="TypeId"></TD><TD width="126"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
...
<TR>
                  <TD width="89">默认金额
                    <input name="Field[]" type="hidden" id="Field[]" value="Amount"></TD><TD width="126"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
