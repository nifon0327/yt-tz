<?php 
//步骤1 二合一已更新$DataIn.电信---yang 20120801
include "../model/modelhead.php";
//步骤2：
ChangeWtitle("$SubCompany 新增配件图文档");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id='NoteTable'>
	...
	<tr>
	  <td height="35" class='A0010' align="right">图档供应商： </td>
	...
	<tr>
	  <td height="35" class='A0010' align="right">配件类型： </td>
	  <td class='A0001'><select name="StuffType" id="StuffType" style="width:400px" datatype="Require"  msg="未选择类型">
	    <option value="" selected="selected">请选择</option>
	    <?php 
