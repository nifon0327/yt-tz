...
//步骤2：
ChangeWtitle("$SubCompany 员工体检费用查询");			//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		<td class="A0011"><TABLE width="600" border=0 align="center">
            ...
            <TR>
              <TD align="right">体检日期
                      <input name="Field[]" type="hidden" id="Field[]" value="tjDate">
              </TD>
              <TD align="center">
          ...
          value="<=">&lt;=</OPTION>
			...
			?>
                ...
                value="isNum" />
                        ...
                        <TR>
              <TD align="right">体检类别
                      <input name="Field[]" type="hidden" id="Field[]" value="tjType">
              </TD>
              <TD align="center">
                  <SELECT name=fun[] id="fun[]" style="width: 60px;">
                    <OPTION value== 
