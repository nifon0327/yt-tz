...
ChangeWtitle("$SubCompany 安全事故");
$Th_Col="选项|45|序号|30|事故说明|300|附件|50|审核人|60|状态|40|更新日期|70";
//步骤3：
...
$mySql="SELECT A.Id,A.Caption,A.Attached,A.Checker,A.Date,A.Estate,A.Locks,A.Operator FROM $DataPublic.aqsc18 A WHERE 1 $SearchRows ORDER BY A.Id ASC";
