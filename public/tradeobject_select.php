...
//步骤2：
ChangeWtitle("$SubCompany 交易对象资料查询");			//需处理
$nowWebPage =$funFrom."_select";	
$toWebPage  ="temptb_model";
$_SESSION["nowWebPage"]=$nowWebPage; 
$Parameter="fromWebPage,$fromWebPage,funFrom,$funFrom,From,$From,Pagination,$Pagination,Page,$Page,ObjectSign,$ObjectSign";
$tableMenuS=500;
$tableWidth=850;
//步骤3：
	...
	<tr>
		<td class="A0011">
          ...
          value=!=>!=</OPTION>
				...
				<TR>
                  <TD>付款方式
                      <input name="Field[]" type="hidden" id="Field[]" value="GysPayMode">
