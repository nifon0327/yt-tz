...
//步骤2：
$Log_Item="功能模块";		//需处理
$upDataSheet="$DataIn.sys_clientfunmodule";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$SetStr="ModuleName='$ModuleName',Oby='$Oby',Parameter='$Parameter',Remark='$Remark',Estate='$Estate',Locks='0',Date='$DateTime',Operator='$Operator'";
