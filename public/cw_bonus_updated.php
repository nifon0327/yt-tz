...
//步骤2：
$Log_Item="其它奖金费用";		//需处理
$upDataSheet="$DataIn.cw20_bonussheet";	//需处理
$upDataMain="$DataIn.cw20_bonusmain";	//需处理
$Log_Funtion="更新";
...
switch ($ActionId){
	...
	default:
		...
		if($Estate==0){
			$SetStr="TypeId='$TypeId',Content='$Content' $BillSTR";
			}
		else{	
			$SetStr="Number='$Number',Date='$theDate',Amount='$Amount',Currency='$Currency',Content='$Content'  $BillSTR";
			}
