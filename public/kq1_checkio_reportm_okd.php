					...
					case "O"://#1 有区别
						...
						if($CheckMonth>"2013-04"){//按新的计算方式显示
							...
							if($pbType==1){//临时班
								...
								if($CheckTime != "" && $DateType == "X" && ($Number == "10125" || $Number == "10224" || $Number == "10295" || $Number == "10325" || $Number == "10763" || $Number == "11092" || $Number == "11204" || $Number == "10043"))
								{	
									//echo "hi";
									continue;
								}
