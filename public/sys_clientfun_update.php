...
$upRow = mysql_fetch_array(mysql_query("SELECT * FROM $DataIn.sys_clientfunmodule WHERE Id='$Id'",$link_id));
$Estate=$upRow["Estate"];
$Oby=$upRow["Oby"];
$TempPlace="EstateSTR".strval($Estate);
$$TempPlace="selected";
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td class="A0011">
		...
		<tr>
            ...
            <td width="460" scope="col"><input name="ModuleName" type="text" id="ModuleName" style="width:380px;" maxlength="30" value="<?php  echo $upRow["ModuleName"]?>" title="可输入1-25个字节(每1中文字占2个字节，每1英文字母占1个字节)" DataType="LimitB"  Max="25" Min="1" Msg="没有填写或字符超出25字节">
			</td>
		</tr>
		<tr>
			<td height="29" align="right" scope="col">连接参数</td>
		...
		<tr>
		  ...
		  <td scope="col"><input name="Oby" type="text" id="Oby" style="width:380px;" maxlength="100" value="<?php  echo $Oby?>" title="可输入不超过100个字节的参数(每1英文字母占1个字节)"  Max="100" Msg="字符超出100个字节"></td>
		  </tr>
		<tr>
