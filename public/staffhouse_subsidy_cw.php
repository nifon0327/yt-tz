...
$funFrom="staffhouse_subsidy";			//必选参数：功能模块
...
switch($Estate){
	case "0":			//已结付处理		
		...
		$MergeRows=7;
		$Th_Col="更新|35|结付日期|70|结付凭证|35|结付备注|35|结付总额|60|结付银行|100|所属公司|60|选项|40|序号|35|部门|70|职位|70|员工ID|60|员工姓名|80|申请金额|60|凭证|40|备注|180|状态|50|请款人|60|请款日期|70";
		$EstateSTR0="selected";
		$ActioToS="1,15,16";
        $sumCols="6";			//求和列,需处理
	...
	default:			//未结付处理
		ChangeWtitle($SubCompany.$Log_Item."未结付记录");
         $Th_Col="选项|40|序号|40|所属公司|60|申请月份|70|部门|70|职位|70|员工ID|60|员工姓名|100|补助金额|60|凭证|60|备注|200|状态|40|更新日期|70|操作人|60";
		$Estate=3;
		$EstateSTR3="selected";
