...
//步骤2：
ChangeWtitle("$SubCompany 员工购房补助信息查询");			//需处理
...
//步骤4：需处理
$CheckTb="$DataIn.staff_housesubsidy";
?>
	...
	<tr>
		<td class="A0011">
			<TABLE width="572" border=0 align="center">
              <TBODY>
                <TR>
                  <TD width="105" align="right"><p>员工姓名
          ...
          value=!=>!=</OPTION>
                ...
                value="isStr" />
                	...
                	<TR>
                  <TD width="105" align="right"><p>小孩姓名
                      <input name="Field[]" type="hidden" id="Field[]" value="ChildName">
                  </p>
                  </TD>
                  <TD width="87" align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
