...
//步骤2：
ChangeWtitle("$SubCompany 安全生产证书查询");			//需处理
...
至
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate">
                ...
                <TR>
                  ...
                  <TD width="81" align="center"><select name="fun[]" id="fun[]" style="width: 60px;">
                    <option value="=" 
          ...
          value=!=>!=</OPTION>
                  ...
                  <TD width="397"><INPUT name=value[] class=textfield id="value[]" style="width:380px;">
                    <input name="table[]" type="hidden" id="table[]" value="A">
                    <input name="types[]" type="hidden" id="types[]"
                value="isStr" />
</TD>
