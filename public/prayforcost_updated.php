...
switch ($ActionId){
	...
	default:
		...
		$SetStr="ItemId='$ItemId',TypeID='$TypeID',Description='$Description',Amount='$Amount',Currency='$Currency',ModelDetail='$ModelDetail',Remark='$Remark',Provider='$Provider',Date='$upDate' $BillSTR";
