...
<?php 
	...
	for($i=0;$i<count($checkid);$i++){
			...
			if ($Id!=""){
				...
				S.Mobile,S.Dh,S.Bank,S.Note,M.cSign
				...
				$Job=$J_Result["Name"];
                if ($myrow["Photo"]==1) {
		             $photoFile="<div id ='icon'><img  src='../download/staffphoto/p".$Number.".jpg' width='125' height='162' style='margin-top:5px;margin-left:3px;'></div>";
                     }
		        else{
