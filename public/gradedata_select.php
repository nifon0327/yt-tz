...
//步骤2：
ChangeWtitle("$SubCompany 职位等级范围查询");			//需处理
		...
		<td class="A0011">
          ...
          value="<=">&lt;=</OPTION>
				  ...
				  <select name=value[] id="value[]" style="width:380px;">
                    <?php 
					$jSql = "SELECT Name,Id FROM $DataPublic.jobdata 
                ...
                <TR>
                  <TD>最低等级
                      <input name="Field[]" type="hidden" id="Field[]" value="Low">
                  </TD>
...
<TR>
                  <TD><p>最高等级
                      <input name="Field[]" type="hidden" id="Field[]" value="Hight">
                  </p>
                  </TD>
                  <TD><SELECT name=fun[] id="fun[]" style="width: 60px;">
                    <OPTION value== 
