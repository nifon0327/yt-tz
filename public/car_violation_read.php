...
$ColsNumber=11;				
$tableMenuS=550;
ChangeWtitle("$SubCompany 车辆违规记录列表");
$funFrom="car_violation";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|50|序号|40|使用公司|60|车辆类型|60|违规车辆|60|违规人|60|违规费用|60|违规时间|80|原因|300|";
...
$mySql="SELECT * FROM $DataPublic.car_violation A WHERE 1 $SearchRows ORDER BY A.Id DESC";
...
if($myRow = mysql_fetch_array($myResult)){
	do{	
	   ...
	   $ValueArray=array(
			...
			array(0=>$Person,1=>"align='center'"),
			array(0=>$Charge,1=>"align='center'"),
