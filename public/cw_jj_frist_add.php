...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
	...
	?>
        ...
        <tr>
        <td align="right">考勤类别</td>
        <td><select name="chooseKqSign" id="chooseKqSign" style="width:275px">
                   <option value='' $kqSelectSign>全部</option>
                   <option value='1' $kqSelectSign1>固定薪</option>
                   <option value='2' $kqSelectSign2>非固定薪</option>
                   </select>
        <td>
        </tr>
      <tr>
