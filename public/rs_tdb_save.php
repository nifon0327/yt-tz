...
$inRecode = "INSERT INTO $DataPublic.redeployb SELECT NULL,Number,'$BranchId','$ActionIn','$Month','$Remark','$Date','0','$Operator', '1', '0', '$Operator','$DateTime' ,'$Operator', '$DateTime' FROM $DataPublic.staffmain WHERE 1 $NumberSTR ";
