...
//步骤2：
ChangeWtitle("$SubCompany 供应商税款查询");			//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    至
      ...
      <input name="types[]" type="hidden" id="types[]" value="isDate">
                ...
                <TR>
                  <TD align="right">发 票 号
                    <input name="Field[]" type="hidden" id="Field[]" value="InvoiceNUM">
                  </TD>
                  <TD><div align="center">
                      <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <option value="LIKE" selected>包含</option>
                ...
                <TR>
                  <TD align="right">发票凭证
                    <input name="Field[]" type="hidden" id="Field[]" value="InvoiceFile">
                  </TD>
                  <TD><div align="center">
                      <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <OPTION value== selected>=</OPTION>
                  ...
                  <TD><select name=value[] id="value[]" style="width: 274px;">
				    ...
				    <TR>
                  <TD align="right">会计发票确认
                    <input name="Field[]" type="hidden" id="Field[]" value="InvoiceCollect">
                  </TD>
                  <TD><div align="center">
                      <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <OPTION value== selected>=</OPTION>
				 ...
				 <TR>
                      <TD align="right">收到发票日期
                                    <input name="Field[]" type="hidden" id="Field[]" value="Getdate">
                                  </TD>
                                  <TD align="center">
                                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                                        <OPTION value== 
