...
//步骤2：
$Log_Item="行政分类";		//需处理
$upDataSheet="$DataPublic.adminitype";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$SetStr="Letter='$Letter',Name='$Name',AuditType='$AuditType',FirstId='$FirstId',Amount='$Amount',Remark='$Remark',Date='$DateTime',Locks='0',Operator='$Operator'";
