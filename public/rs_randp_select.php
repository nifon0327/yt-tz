...
//步骤2：
ChangeWtitle("$SubCompany 奖惩记录查询");			//需处理
...
<TR>
            ...
            <input name="Field[]" type="hidden" id="Field[]" value="BranchId"></TD><TD width="87" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
          ...
          value="<=">&lt;=</OPTION>
                ...
                value="isNum" />
                  ...
                  <input name="Field[]" type="hidden" id="Field[]" value="JobId"></TD><TD width="87" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
          ...
          value="<=">&lt;=</OPTION>
			...
			?>			  
                ...
                value="isNum" />
                  ...
                  <input name="Field[]" type="hidden" id="Field[]" value="Number"></TD><TD width="87" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
...
<TR>
          ...
          value=!=>!=</OPTION>
                ...
                value="isStr" />
                  ...
                  <TD width="89" align="right">奖惩类别
                  <input name="Field[]" type="hidden" id="Field[]" value="Type"></TD><TD width="87" align="center"><select name="fun[]" id="fun[]" style="width: 60px;">
                ...
                value="isStr" />
                				               ...
                				               <TR>
                                                 <TD align="right">奖惩原因
                                                 <input name="Field[]" type="hidden" id="Field[]" value="Content"></TD><TD align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                                                     <option value="LIKE" selected>包含</option>
                                                     <OPTION value==>=</OPTION>
                                                     <OPTION 
          value=!=>!=</OPTION>
...
<TR>
                  <TD width="89" align="right">奖惩金额
            <input name="Field[]" type="hidden" id="Field[]" value="Amount"></TD><TD width="87" align="center"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
