...
$ColsNumber=8;				
$tableMenuS=600;
ChangeWtitle("$SubCompany 货币列表");
$funFrom="currency";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|40|序号|40|货币说明|100|货币符号|80|货币简写|80|汇率|120|状态|60|设置日期|120|操作|60";
...
$mySql="SELECT * FROM $DataPublic.currencydata A WHERE 1 $SearchRows ORDER BY A.Estate DESC,A.Id";
