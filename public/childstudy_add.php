...
//步骤2：
ChangeWtitle("$SubCompany 新增小孩信息");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class='A0011'>
	<table width="650" border="0" align="center" cellspacing="5">
            ...
            <td scope="col"><input name="ChildName" type="text" id="ChildName"  size="50" dataType="Require" Msg="未填写"></td></tr> 
			<tr>
		<tr>
		  ...
		  <select name="Sex" id="Sex" style="width:380px" dataType="Require"  msg="未选择性别" >
            ...
            <td scope="col"><input name="StartSchool" type="text" id="StartSchool"  size="50" dataType="Require" Msg="未填写"></td></tr>
			<!--<tr>
