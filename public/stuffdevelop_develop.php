...
//步骤3：//需处理
$upData =mysql_fetch_array(mysql_query("SELECT S.StuffId,S.StuffCname,S.Estate,S.DevelopState,P.GroupId,P.Number,P.dFile, 
...
if ($Targetdate!="" && $Targetdate!="0000-00-00" )
{
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td class="A0011">
	...
	<table width="800" border="0" align="center" cellspacing="5">
            ...
            <td><select name="DevelopNumber" id="DevelopNumber" style="width:480px"  dataType="Require"  msg="未选择">
			   ...
			   if ($GroupId=="" || $DevelopNumber=="") {
				    ...
				    $StaffSql = mysql_query("SELECT M.Number,M.Name
							...
							WHERE  (M.BranchId='5' OR M.GroupId='102')  AND M.Estate='1'  AND M.GroupId='$GroupId' ORDER BY M.Number",$link_id);
        ...
        <tr>
            <td align="right">业务说明</td>
            <td><textarea name="Remark" style="width:480px" rows="4" id="Remark" readonly="readonly"><?php echo $Remark?></textarea></td>
        </tr>
        <tr>
            <td align="right">开发说明</td>
            <td><textarea name="KfRemark" style="width:480px" rows="4" id="KfRemark"><?php echo $KfRemark?></textarea></td>
        </tr>        
        
        <!--
        <tr>
            <td align="right">开发文档</td>
            <td><input name="developfile" type="file" id="developfile" size="60" DataType="Filter"  msg="非法的文件格式" accept="pdf,psd,eps,jpg,ai,cdr,rar,zip"></textarea></td>
        </tr>
        -->
