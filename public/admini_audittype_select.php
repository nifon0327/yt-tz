...
//步骤2：
ChangeWtitle("$SubCompany 行政审核分类查询");			//需处理
...
//步骤4：需处理
$CheckTb="$DataPublic.admini_audittype";
$SelectFrom=4;
?>
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		<td class="A0011">
            ...
            <TBODY>    
               <tr>
                  <td align="right">审 核 人
                    <input name="Field[]2" type="hidden" id="Field[]2" value="Number" /></td>
