...
//步骤2：
ChangeWtitle("$SubCompany 公告查询");			//需处理
	...
	<tr>
		<td class="A0011">
			<TABLE width="600" border=0 align="center">
              <TBODY>
                <TR>
                  <TD width="108"><p align="right">标题内容
          ...
          value=!=>!=</OPTION>
                  ...
                  <TD width="382"><INPUT name=value[] class=textfield id="value[]" size=40>
