...
$inRecode = "INSERT INTO $DataPublic.redeployk SELECT NULL,Number,'$KqSign','$ActionIn','$Month','$Remark','$Date','0','$Operator', '1', '0', '$Operator','$DateTime' ,'$Operator', '$DateTime' FROM $DataPublic.staffmain WHERE 1 $NumberSTR ";
