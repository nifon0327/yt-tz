...
ChangeWtitle("$SubCompany 工作地点");//需处理
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_update";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
$upData = mysql_fetch_array(mysql_query("SELECT * FROM $DataPublic.staffworkadd WHERE Id='$Id'",$link_id));
$Name=$upData["Name"];
$ExtNoFirst=$upData["ExtNoFirst"];
$Address=$upData["Address"];
$ColorValue=$upData["ColorValue"];
$tableWidth=850;
$tableMenuS=500;
	...
	<tr><td class="A0011">
      <table width="760" border="0" align="left" cellspacing="5">
        ...
        <tr>
            ...
            <td scope="col" ><input name="ExtNoFirst" type="text" id="ExtNoFirst" value="<?php echo $ExtNoFirst;?>" style="width:380px;" DataType="Number" Msg="没有填写或格式不对"></td>
		</tr>
        <tr>
            <td width="120" height="40" align="right" valign="top" scope="col">地址</td>
            <td scope="col" ><textarea name="Address" rows="4" id="Address" style="width:380px;" tdatatype="Require" msg="没有填写"><?php echo $Name;?></textarea></td>
		</tr>
      </table>
</td></tr></table>
    	...
    	<table border="0" cellpadding="0" cellspacing="0" class="colTab">
            ...
            <td width="120" >&nbsp;</td>
    			...
    			<td width="60" valign="top">
    				选中颜色：
        			<table ID=ShowColor width="50" height="24" cellspacing="0" cellpadding="0" ><tr><td bgcolor="<?php echo $ColorValue;?>"></td></tr></table>
    			</td>
    			<td valign="top">&nbsp;
					颜色代码：<br>
    				<INPUT TYPE=TEXT class="colInp" name="SelColor" ID="SelColor" value="<?php echo $ColorValue;?>" SIZE=7 onKeyUp="inpCol(this)">
				</td>
             </tr>
