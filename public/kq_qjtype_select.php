...
//步骤2：
ChangeWtitle("$SubCompany 请假分类查询");			//需处理
...
<TR>
                  <TD width="89">底薪比例
                    <input name="Field[]" type="hidden" id="Field[]" value="dxTimes"></TD><TD width="126"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
          ...
          value="<=">&lt;=</OPTION>
                  ...
                  <TD width="343"><select name=value[] id="value[]" style="width:380px;" >
...
<TR>
                  <TD width="89">津贴比例
                    <input name="Field[]" type="hidden" id="Field[]" value="jtTimes"></TD><TD width="126"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
...
至
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate">
                  ...
                  <TD width="89">许可天数
                    <input name="Field[]" type="hidden" id="Field[]" value="Days"></TD><TD width="126"><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          selected>=</OPTION>
                      <OPTION value=">">&gt;</OPTION>
                      <OPTION 
