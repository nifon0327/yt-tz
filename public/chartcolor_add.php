...
//步骤2：
ChangeWtitle("$SubCompany 新增客户图例颜色样品");//需处理
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="110" height="30" align="right" class="A0010">客&nbsp;&nbsp;&nbsp;&nbsp;户&nbsp;</td>
    <td class="A0001"><select name="CompanyId" Id="CompanyId" size="1" style="width: 268pt;" dataType="Require" msg="未选择客户"><option value="" selected>请选择</option>
        <?php 
		$cResult = mysql_query("SELECT A.CompanyId,A.Forshort 
							   FROM $DataIn.trade_object A
							   LEFT JOIN $DataIn.chart2_color B ON B.CompanyId=A.CompanyId 
							   WHERE   A.ObjectSign IN(1,2)  AND A.Estate=1 AND B.CompanyId IS NULL ORDER BY Forshort",$link_id);
		if($cRow = mysql_fetch_array($cResult)){
			$i=1;
			do{
				echo"<option value='$cRow[CompanyId]'>$i $cRow[Forshort]</option>";
				$i++;
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td class="A0011">
      <table width="760" border="0" align="center" cellspacing="5">
        <tr><td colspan="2">
     <table bgcolor="#ffffff" text="#000000" vlink="#0033CC" alink="#800080"  link="#0033cc" topmargin="0">
