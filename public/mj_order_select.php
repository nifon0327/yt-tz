...
//步骤2：
ChangeWtitle("$SubCompany 门禁指令查询");			//需处理
	...
	<tr>
		<td class="A0011">
          ...
          value=!=>!=</OPTION>
			...
			<TR>
                  <TD>开门指令
                      <input name="Field[]" type="hidden" id="Field[]" value="OpenKeys">
                  </TD>
          ...
          value=!=>!=</OPTION>
                ...
                value="isStr" />
				 ...
				 <TR>
                  <TD>关门指令
                      <input name="Field[]" type="hidden" id="Field[]" value="CloseKeys">
                  </TD>
                  <TD><SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <option value="LIKE" selected>包含</option>
                      <OPTION value==>=</OPTION>
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate">
                ...
                <TR>
				  ...
				  <select name=value[] id="value[]" style="width:380px;">
                     	...
                     	<?php 
					 	 $CheckTb="$DataPublic.accessguard_order";
