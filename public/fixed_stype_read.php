...
$ColsNumber=8;				
$tableMenuS=600;
ChangeWtitle("$SubCompany 固定资产分类");
$funFrom="fixed_stype";
$nowWebPage=$funFrom."_read";
$Th_Col="选项|80|序号|40|分类名称|200|排序字母|80|设置日期|150|状态|80|操作员|80";
...
$FromDir=$DirArray['1'];
$mySql="SELECT * FROM $DataPublic.oa1_fixedmaintype A WHERE 1 $SearchRows ORDER BY A.Estate DESC,A.Letter";
...
if($myRow = mysql_fetch_array($myResult)){
	do {
		...
		$URL="fixed_stype_ajax.php";
        $theParam="MainTypeID=$Id";
		//echo "$theParam";
