...
<body>
<?php 
$mySql="SELECT X.Id,X.KqSign,X.BranchId,X.Number,X.Dx,X.Gljt,X.Gwjt,X.Jj,X.Jbjj,X.Ywjj,X.Shbz,X.Zsbz,X.Studybz,X.Jtbz,X.Jbf,X.Yxbz,X.taxbz,X.Jz,X.Sb,X.Kqkk,X.RandP,X.Ct,
...
if($myRow = mysql_fetch_array($myResult)) {
	...
	do{
		...
		$Gljt=$myRow["Gljt"];
		$Gwjt=$myRow["Gwjt"];
		$Shbz=$myRow["Shbz"]+$myRow["Zsbz"];
		//$Zsbz=$myRow["Zsbz"];
		$Jtbz=$myRow["Jtbz"];
		$Studybz=$myRow["Studybz"];
		$Jbf=$myRow["Jbf"];
		$Yxbz=$myRow["Yxbz"];
		$taxbz=$myRow["taxbz"];
		$Kqkk=$myRow["Kqkk"];
...
<tr valign="bottom">
	...
	<td width="45" align="center" >加班费</td>
	<td width="45" align="center">绩效<br>奖金</td>
	<td width="45" align="center">额外<br>奖金</td>
    <td width="60" align="center" >生活/住<br>宿补助</td>
	<td width="35" align="center" >交通<br>补助</td>
	<td width="35" align="center" >就学<br>补助</td>
...
<tr>
	...
	<td align="center"><?php  echo $Studybz?></td> 
