...
ChangeWtitle("$SubCompany 应急预案");
$Th_Col="选项|45|序号|30|预案分类|60|预案名称|200|附件|50|审核人|60|状态|40|更新日期|70";
//步骤3：
...
$mySql="SELECT A.Id,A.Caption,A.Attached,A.Checker,A.Date,A.Estate,A.Locks,A.Operator,B.Name FROM $DataPublic.aqsc16 A 
LEFT JOIN $DataPublic.aqsc16_type B ON B.Id=A.TypeId
