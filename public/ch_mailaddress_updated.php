...
$upDataSheet="$DataIn.ch10_mailaddress";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		...
		$Date=date("Y-m-d");
		$SetStr="LinkMan='$LinkMan',CompanyId='$CompanyId',Forshort='$Forshort',Termini='$Termini',Tel='$Tel',Fax='$Fax',ZIP='$ZIP',Address='$Address',Remark='$Remark',Date='$Date',Operator='$Operator'";
