...
//步骤2：
ChangeWtitle("$SubCompany 样品寄送地址查询");			//需处理
		...
		<td class="A0011">
          ...
          selected>=</OPTION>
				  ...
				  <select name=value[] id="value[]" style="width: 274px;">
                    <?php 
					$cSql = mysql_query("SELECT A.CompanyId,C.Forshort 
					FROM $DataIn.ch10_mailaddress A
					,$DataIn.trade_object C WHERE C.CompanyId=A.CompanyId AND C.cSign='$Login_cSign'		
					GROUP BY A.CompanyId ORDER BY C.Estate DESC,C.OrderBy DESC",$link_id);
...
<TR>
  <TD align="right">寄送目的地
        <input name="Field[]" type="hidden" id="Field[]" value="Termini">
  </TD>
  <TD align="center">
    <SELECT name=fun[] id="fun[]" style="width: 60px;">
        <option value="LIKE" selected>包含</option>
