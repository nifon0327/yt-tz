...
//步骤2：
ChangeWtitle("$SubCompany 退换记录查询");			//需处理
		...
		<td class="A0011">
          ...
          selected>=</OPTION>
				  ...
				  <select name=value[] id="value[]" style="width: 274px;">
                    <?php 
					$result = mysql_query("SELECT M.CompanyId,P.Forshort,P.Letter FROM $DataIn.ck2_thmain M,$DataIn.trade_object P WHERE M.CompanyId=P.CompanyId GROUP BY M.CompanyId ORDER BY P.Letter",$link_id);
