...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr><td class="A0011">
        <table width="100%" border="0" align="center" cellspacing="5" id="NoteTable">
			...
			<tr>
				<td align="right">补仓日期</td><td><input name="Date" type="text" id="Date" value="<?php  echo $Date?>" size="87" onfocus="WdatePicker()" title="必选项" datatype="Date" format="ymd" msg="格式不对" readonly></td>
			</tr>
			<?php 
			if($BillNumber!=0){
