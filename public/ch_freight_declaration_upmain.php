<?php 
//电信-zxq 2012-08-01
//$DataIn.cw4_freight 二合一已更新
include "../model/modelhead.php";
$upDataMain="$DataIn.cw4_freight_declaration";
ChangeWtitle("$SubCompany 更新中港报关费用结付资料");
$fromWebPage=$funFrom."_cw";		
$nowWebPage =$funFrom."_upmain";	
$toWebPage  =$funFrom."_updated";	
$_SESSION["nowWebPage"]=$nowWebPage; 
//步骤3：
$MainResult = mysql_query("SELECT PayDate,PayAmount,depotCharge,declarationCharge,checkCharge,Payee,Receipt,Checksheet,Remark,Locks FROM $upDataMain WHERE Id='$Mid' LIMIT 1",$link_id);
if($MainRow = mysql_fetch_array($MainResult)) {
	$PayAmount=$MainRow["PayAmount"];	//结付总额
	$depotCharge=$MainRow["depotCharge"];
	$checkCharge=$MainRow["checkCharge"];
	$declarationCharge=$MainRow["declarationCharge"];
...
$Parameter="ActionId,20,Mid,$Mid,oldPayDate,$PayDate,cashSymbol,$cashSymbol,funFrom,$funFrom,From,$From,Estate,0,Pagination,$Pagination,Page,$Page,fromWebPage,$fromWebPage,PayAmount,$PayAmount,Estate,$Estate";
...
<table border="0" width="<?php  echo $tableWidth?>" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr><td class="A0011">
		...
		<tr>
            <td align="right" scope="col">运费总额</td>
            <td scope="col"><?php  echo $PayAmount?> <?php  echo $cashSymbol?> </td>
		</tr>
		<tr>
		  <td align="right" scope="col">入 仓 费</td>
		  <td scope="col"><?php  echo $depotCharge?> HKD</td>
		  </tr>
		  <tr>
		  <td align="right" scope="col">报 关 费</td>
		  <td scope="col"><?php  echo $declarationCharge?> RMB</td>
		  </tr>
		  <tr>
		  <td align="right" scope="col">商 检 费</td>
		  <td scope="col"><?php  echo $checkCharge?> RMB</td>
		  </tr>
		<tr>
		...
		<tr>
            ...
            <td>
			<input name="Payee" type="file" id="Payee" size="75" title="可选项,JPG格式" DataType="Filter" Accept="jpg" Msg="文件格式不对,请重选" Row="4" Cel="1">
			</td>
		</tr>
            <?php 
			$ReceiptRow=5;
