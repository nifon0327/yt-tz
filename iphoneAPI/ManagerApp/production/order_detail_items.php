...
if ($llQty>$OrderQty) {
 ...
 if ($distriStar==true) {
   ...
   if ($isred==1) {$cellIder="sxsi";$swapDic=array("no"=>"");}
       $tempdata = array("RowSet"=>array("bgColor"=>"$SetColor"),"Title"=>array("Text"=>"$StuffId-$StuffCname","Color"=>"$StuffColor"),"Col1"=>array("Text"=>"$Position"),"Col2"=>array("Text"=>"$OrderQty"),"Col3"=>array("Text"=>"$tStockQty"),"Col4"=>array("Text"=>"$llQty","Color"=>"$llQtyColor"),"Col5"=>array("Text"=>"$Forshort"),"Picture"=>"$ImagePath","star"=>"$StarHid","Prop"=>"$StuffProp","Id"=>"$StuffId");
