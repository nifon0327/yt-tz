...
$indexOf = count($bigJson);					  
for ($a=1; $a<$count; $a++) {
	
	if ('¥0'==($tempArray[$a][$indexOf]) ){
...
$jsonArray=array("SET"=>$SetArray,"ColTitle"=>$MonthArray,"ColData"=>$tempArray,"compIds"=>$bigJson);
