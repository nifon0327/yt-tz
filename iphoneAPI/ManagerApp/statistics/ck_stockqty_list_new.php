...
$WeeksNow = date("W");
$SearchRows=" AND  B.CompanyId='$CompanyId' And T.TypeId='$typeID' AND D.ComboxSign=0  "; 
if ($searching==true) {
	$SearchRows = " and (D.StuffCname like '%$search%' or D.StuffId like '%$search%' )";
	 if ( trim($search)=="" ) {$SearchRows = " and -1=1 "; }
...
D.CheckSign,D.FrameCapacity,B.CompanyId,P.Forshort,max(RK.Date) lastRK,IF((D.SendFloor=17 or D.SendFloor=14),1,0) is47_1F  
						...
						GROUP BY K.StuffId ORDER BY  Date";    //AND D.Estate>0
 // echo $mySql;  
              ...
              $jsonArray[]= array(
	              'printdict'=>$printDict,
					            ...
					            // "Index"=>array("Title"=>"$Days","bgColor"=>""), 
					             ...
					             "Col_B"=>array("Title"=>"$tStockQty","IconType"=>"27","Align"=>"L","Margin"=>"0,0,10,0"),
					             "Col_C"=>array("Title"=>"$oStockQty","IconType"=>"26","Align"=>"L","Margin"=>"35,0,10,0"),
