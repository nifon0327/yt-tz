<?php 
//来料品检
//|| versionToNumber($AppVersion)>=295
$SearchRows=$Floor==3 ?" AND NOT EXISTS(SELECT L.Id FROM $DataIn.qc_mission L WHERE L.Sid=S.Id )":"";
...
if ($LastQty>0){
    ...
    $AddCols[]=array("Title"=>"$LastQty","Frame"=>"90, 2, 60,40","Align"=>"R","Color"=>"#00BB00");
}
?>