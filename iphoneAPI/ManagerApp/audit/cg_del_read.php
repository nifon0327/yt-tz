<?php 
//采单删除审核
 $mySql="SELECT S.Id,S.Mid,S.POrderId,S.StockId,S.StuffId,S.AddQty,S.BuyerId,S.OrderQty,S.StockQty,S.FactualQty,S.Price,S.BuyerId,S.ywOrderDTime,S.StockRemark,
 A.StuffCname,A.TypeId,A.Picture,C.PreChar,U.Name AS UnitName,P.Forshort   
         ...
         WHERE  S.Estate=4  AND T.mainType=1 ORDER BY S.ywOrderDTime";
 ...
 while($myRow = mysql_fetch_array($Result)) 
 {
           ...
           $StockRemark=$myRow["StockRemark"]==""?"":$myRow["StockRemark"];//更新备注
