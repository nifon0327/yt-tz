...
$inRecode = "INSERT INTO $DataIn.lw_checkinout 
SELECT NULL,BranchId,JobId,Number,'$CheckTime','$CheckType','1', '0','0','$KrSign','0','1', 1,NOW(),'$Operator',0,'$Operator',NOW(),'$Operator',NOW() FROM $DataPublic.lw_staffmain WHERE 1 $NumberSTR 
AND KqSign!='3' AND Estate='1'  AND Number NOT IN(SELECT Number FROM $DataIn.lw_kqdata WHERE Month='$theMonth')";
//echo $inRecode;
