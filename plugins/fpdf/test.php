...
include "chinese-unicode.php";		//更新
	...
	$eurTableNo="eurTableNo".strval($pi);
     if($addSign==0){  //新加一页
...

		{
			...
			<td width=39 align=center valign=middle style=bold color=#06F>$ZName</td>
		...
		//表标题
		{
			...
			<td width=8 align=center height=$RowsHight valign=middle style=bold>序号</td>
			<td width=25 align=center valign=middle>PO</td>			
			<td width=35 align=center valign=middle style=bold>产品代码</td>
			<td width=70 align=center valign=middle style=bold>产品描述</td>			
			<td width=19 align=center valign=middle style=bold>数量</td>	
			<td width=19 align=center valign=middle style=bold>单价</td>	
			<td width=19 align=center valign=middle style=bold>金额</td></tr></table>" ;//$eurTableList;
	...
	$eurplNo="plTableNo".strval($pi);
     if($addSign==0){  //新加一页
		...
		//表标题
		{
			...
			<td width=16 align=center height=$RowsHight valign=middle style=bold>箱号</td>
			<td width=25 align=center valign=middle style=bold>PO#</td>
			<td width=35 align=center valign=middle style=bold>产品代码</td>
			<td width=47 align=center valign=middle style=bold>产品描述</td>
			<td width=18 align=center valign=middle style=bold>数量/箱</td>	
			<td width=18 align=center valign=middle style=bold>合计</td>
			<td width=18 align=center valign=middle style=bold>净重(KG)</td>
			<td width=18 align=center valign=middle style=bold>毛重(KG)</td></tr></table>" ;//$eurTableList;
			$pdf->htmltable($eurTableField);
...
/*
define('FPDF_FONTPATH','font/');	//更新
require('chinese-unicode.php');
$pdf=new PDF_Unicode();
$pdf->Open();
$pdf->AddPage();
$pdf->AddUniGBFont('uGB');
$pdf->SetFont('uGB','',20);
...
$pdf->Ln();
$pdf->Cell (240, 10, "<table><tr<td>ABCDEFGHIJKLMNOPabcdefghijklmnopqrstuvwxyz1234567890</td></tr></table>");
$pdf->Ln();

$pdf->SetFont('uGB','',12);
//include "invoicetopdf/".$CompanyId."_in_top.php";
$IL_Table="<table  border=1 >
  <tr bgcolor=#CCCCCC repeat>
    <td width=10 align=center height=6 valign=middle style=bold>NO.</td>
	<td width=15 align=center valign=middle style=bold>為中</td>
	<td width=26 align=center valign=middle style=bold>中共中央总书记</td>
	<td width=94 align=center valign=middle style=bold>Product Description</td>
