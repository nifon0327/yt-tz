<?php
$pdf_publicpath=dirname(__FILE__);
...
$tcpdf_include_dirs = array(realpath($pdf_publicpath.'/tcpdf.php'), '/usr/share/php/tcpdf/tcpdf.php', '/usr/share/tcpdf/tcpdf.php', '/usr/share/php-tcpdf/tcpdf.php', '/var/www/tcpdf/tcpdf.php', '/var/www/html/tcpdf/tcpdf.php', '/usr/local/apache2/htdocs/tcpdf/tcpdf.php', $path."/plugins/tcpdf/tcpdf.php");
...
//$tmp=realpath(dirname(__FILE__).'/tcpdf.php');
/*
//require_once(realpath(dirname(__FILE__).'tcpdf.php'));
