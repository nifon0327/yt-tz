...
switch($Id){
	case 9037:$Name="透明壳";break;
	case 9061:$Name="防尘套";break;
	case 9075:$Name="保护膜";break;
	case 9037:$Name="透明壳";break;
	case 9091:$Name="清水套";break;
	case 9062:$Name="贴皮皮套";break;
	case 9043:$Name="拉绳横/竖皮套";break;
	case 9025:$Name="其他皮套";break;
	case 9096:$Name="Slim皮套";break;
	case 9063:$Name="硅胶套";break;
	case 9008:$Name="拉绑PU皮套";break;
	//case 9091:$Name="清水套"; $KeyWords=" AND D.StuffCname LIKE '%清水套%'";break;
	}
$Tile=$Y."年 ".$Name." 月下单、出货数量统计图";
//$TypeId=9039;
//统计的分类
$StuffStr="AND D.TypeId='$Id'".$KeyWords;
//出货或下单最高金额
