...
switch($TypeId){
	case 8040:$Name="镭雕";$ProductType.=" AND P.cName LIKE '%镭雕%'";
	break;
	}
...
$T1002=imagecolorallocate($image,0,171,57); 	$F1002=imagecolorallocate($image,0,171,57); 	$R1002=imagecolorallocate($image,0,171,57);
...
if($MonthRow=mysql_fetch_array($MonthSql)){
	...
	if($AvgQty>0){
		...
		imagettftext($image,10,0,$imR+10,$imB-$tempY+20,$TextRed,$UseFont,"(出货均线)$mS");
		}
	}
//说明
