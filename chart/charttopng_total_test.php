...
$tmpCount=ceil($Max_Height/400);
$tmpCount=$tmpCount<3?3:$tmpCount;
$unitHeight=($tmpCount-2)*25;
$Height_A=$tmpCount*400*(25/$unitHeight);
...
$clientNumH=$imH+($clientNum+1)*(25/$unitHeight);				//+客户条形图高度
$CimW=$imW-50;
...
$TypeNumH=$clientNumH+($TypeNum+1)*(25/$unitHeight);		//加分类统计的高度
