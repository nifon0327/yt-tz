...
foreach ($Ids as $v) {
    $mySql = "SELECT DISTINCT P.cName,SC.POrderId FROM $DataIn.yw1_scsheet SC
    ...
    //生成二维码图片
    $filename = $PNG_WEB_DIR.$POrderId . '.png';//生成二维码图片

    QRcode::png($value, $filename, $errorCorrectionLevel, $matrixPointSize, 2);

    $logo = 'QRCode/XSN.png';  //准备好的logo图片
