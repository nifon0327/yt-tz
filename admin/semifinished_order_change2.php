...
//步骤4：需处理
$upResult = mysql_query("SELECT G.POrderId,G.StockId,G.OrderQty,G.StockQty,G.AddQty,G.FactualQty,G.Price,
G.StuffId,G.DeliveryWeek,D.StuffCname,D.Picture,T.TypeName,M.PurchaseID
...
function CheckForm(){
    if(confirm("请确认置换的配件是否正确?")){
	    document.form1.action="semifinished_order_updated.php?ActionId=131";
