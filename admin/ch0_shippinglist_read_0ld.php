...
$Page_Size = 100;
$ActioToS="3,4,26,28,38,153,114,174";
$sumCols="7";			//求和列,需处理
...
$mySql="SELECT 
M.Id,M.CompanyId,M.Number,M.InvoiceNO,M.InvoiceFile,M.Wise,M.Date,M.Estate,M.Locks,M.Sign,M.Operator,C.Forshort,D.LabelModel  
...
if($myRow = mysql_fetch_array($myResult)){
	...
	do{
		...
		if($PackingRow=mysql_fetch_array($checkPacking)){
			...
			if ($LabelModel==36  || $LabelModel==46 || $LabelModel==48 ) { //add by zx 2014-08-12,CG_Asia Bigben有主标和侧边标
