...
$tableMenuS=800;
$funFrom="order_ship";
$nowWebPage=$funFrom."_dz";
$Th_Col="操作|55|序号|30|PO|80|中文名|210|&nbsp;|30|Product Code|150|已出数量<br>(下单次数)|70|退货<br>数量|50|单品重<br>(g)|40|成品重<br>(g)|50|Unit|40|Price|55|利润|80|Qty|50|Amount|70|订单利润|60|订单备注|110|生管备注|110|采购备注|110|待出备注|110|Air/Sea|60|交期|70|操作员|55|期限|40|背卡<br>条码|30|PE袋<br>条码|30|白盒<br>坑盒|30|外箱<br>标签|30|报价规则|450";
$ColsNumber=27;
$sumCols="13,14,15";
$unColorCol=0;//不着色列
...
LEFT JOIN $DataIn.ch1_shiptypedata CT ON CT.Mid=CM.Id 
...
WHERE 1  AND S.Estate=0 and P.dzSign =1  AND CM.Date>='$MonthFirstDay' AND  CM.Date<='$MonthLastDay'  AND CM.Estate='0'  AND CT.Type=1";
//echo $mySql;
...
ChangeWtitle($SubCompany.$DefaultClient."电子类报关");
$ActioToS="";
