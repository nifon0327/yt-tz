...
ChangeWtitle("$SubCompany 上传快递签收单");
$fromWebPage=$funFrom."_read";		
$nowWebPage =$funFrom."_expressBack";	
...
$Parameter="ActionId,801,Mid,$Mid,funFrom,$funFrom,From,$From,Pagination,$Pagination,Page,$Page,chooseDate,$chooseDate,CompanyId,$CompanyId";
  ...
  <tr><td class="A0011">
		...
		<tr>
         ...
         <tr>
		  ...
		  <td > <input  type="text" id="ExpressNum" name="ExpressNum" style="width:200px"  dataType="Require"></td>
  		</tr>   
	 <tr>
		  <td align="right" >快递签收单:</td>
