...
*/
$$mcaTableNo=" 
	<table  border=1 bordercolor=#CCCCCC ><tr bgcolor=#CCCCCC>
		<td width=37 height=4 valign=middle style=bold>FORWADER:</td>
		<td width=37 height=4 valign=middle style=bold>TRANSACTOR:</td>
		<td width=75 height=4 valign=middle style=bold>CURRENCY:</td> 
		</tr>
	</table>
...
if ($plRows = mysql_fetch_array($plResult)){
	...
	do{
		...
		$plTableNo="plTableNo".strval($plCounts);   //PLTableNo由于跟Cube合在一起，所以少一条记录，在Packinglist要将 $plCounts-1
		$PL_Note_Bank_Height=53; //预留高度给尾页的Note,BAN	 $CubeSUM
		$$plTableNo="<table  border=1 ><tr>
					<td width=129 valign=middle height=$RowsHight style=bold >CUBE(M3)</td>
		...
		<table  border=0  rules=none bordercolor=#FFF>
		<tr border=0  >
			<td width=0 height=$PL_Note_Bank_Height ></td></tr>
		</table>		
		";

		$plTableCubeValue="<table  border=1 ><tr>		
		<tr >
		<td  width=25 height=$RowsHight valign=middle align=right style=bold>$CubeSUM</td>
		";

		//单独存放统计
		$plTableTotal="<table  border=1 ><tr>		
		<tr bgcolor=#CCCCCC>
		<td  width=195 valign=middle height=$RowsHight style=bold>Total</td>
		</table>	
		";

		//单独存放统计黑值
		$plTableTotaValue="<table  border=1 ><tr>		
		<tr bgcolor=#CCCCCC>
		<td  width=15 height=$RowsHight valign=middle align=right style=bold>$packingSUMQty</td>
...
include "invoicetopdf_new/invoicemodel_1.php";  //只用model1_1.php  //目前只有英文版
...
include "invoicetopdf_new/invoicemodel_mca.php";
...
include "invoicetopdf_new/invoicemodel_cw_1.php";  //目前只有英文版
