...
//检查检讨报告
$CaseReport="&nbsp;";
$checkCaseSql=mysql_query("SELECT E.Picture,E.Title 
			...
			switch($CodeFileEstate){
				...
				case 0://审核通过
					...
					if($CodeType==1){
						...
						$CodeFile="<a href=\"openorload.php?d=$dc&f=$CFile&Type=&Action=6\" target=\"download\"><img src='../images/down.gif' alt='点击下载' width='18' height='18'></a>";
						}
					if($CodeType==2){
...
$BoxFile="<a href='product_boxlable_print.php?p=$ProductId&PO=$OrderPO&POId=$POrderId' target='_blank'><img src='../images/printer.gif' alt='打印外箱标签' width='18' height='18' border='0'></a>";
?>