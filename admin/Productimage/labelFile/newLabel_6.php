...
$curX=20;$curY=120;
$curX=floor($curX+(180-$curFontSize[1])/2);
...
$curX=335;$curY=122;
$curX=floor($curX+(60-$curFontSize[1])/2);
...
if(is_numeric($code) &&  strlen($code)==13){
   ...
   //生成条码//$code=$BoxCode;
    $curX=235;$curY=160;$setWidth=155;
    $lw=1.4;$hi=65;
...
$font2_size=12;
$curX=430;$curY=135;
$curX=floor($curX+(26-12)/2);
$curY=floor($curY-(15-10)/2);
imagettftext($im,$font2_size,90,$curX,$curY,$black,$font2,'Qty:');
$font2_size=18;
imagettftext($im,$font2_size,90,$curX+26,$curY,$black,$font2,$BoxPcs);
//输出装箱数量条码
if (is_numeric($BoxPcs) &&  $BoxPcs>0){
   $barcode = new BarCode128($im,410,250,$BoxPcs,$BoxPcs);
