...
P.MainWeight,E.Months,E.LastMonth,BG.Name AS bgName,S.tStockQty,H.HSCode,B.Name AS buySign
FROM $DataIn.productdata P
LEFT JOIN $DataIn.producttype T ON T.TypeId=P.TypeId
...
if($myRow = mysql_fetch_array($myResult)){
	...
	do{
	  ...
	  if ($ViewSign==1){
		...
		//百分比
		$TempInfo="style='cursor:hand;' onclick='ViewChart($ProductId,1)'";
...
//退货数量
		...
		if($ReturnedQty>0 && $ShipQtySum>0){
			...
			$ReturnedP=
			$TempInfo2="style='cursor:hand;' onclick='ViewChart($ProductId,2)' title=\"退货率：$ReturnedPercent ‰\"";
			}
		else{
			$ReturnedQty="&nbsp;";
			$TempInfo2="";
		...
		if($myTask==1){
			$ValueArray=array(
				...
				array(0=>$TypeName),
				array(0=>$bgName,			1=>"align='center'",2=>"onmousedown='window.event.cancelBubble=true;' onclick='updateJq($i,30,$mProductId,1)' style='cursor:hand'"),
				...
				array(0=>$productsize,2=>"onmousedown='window.event.cancelBubble=true;' onclick='aiaxUpdate($i,38,$mProductId,3)' style='cursor:hand'"),
				array(0=>$bjRemark,1=>"align='left'",2=>"onmousedown='window.event.cancelBubble=true;' onclick='updateJq($i,39,$mProductId,2)' style='cursor:hand'")
				);
			  
			}
		else{
		//1=>"align='center'",2=>"onmousedown='window.event.cancelBubble=true;' onclick='updateJq($i,8,$mProductId,4)' style='cursor:hand'"
			$ValueArray=array(
				array(0=>$Client),
				array(0=>$ProductId,			1=>"align='center'"),
				array(0=>$buySign,			1=>"align='center'"),
				...
				array(0=>$Img_H2,			1=>"align='center'",	2=>"onmousedown='window.event.cancelBubble=true;'"),
				array(0=>$productsize,2=>"onmousedown='window.event.cancelBubble=true;' onclick='aiaxUpdate($i,38,$mProductId,3)' style='cursor:hand'"),
				array(0=>$bjRemark,1=>"align='left'",2=>"onmousedown='window.event.cancelBubble=true;' onclick='aiaxUpdate($i,39,$mProductId,2)' style='cursor:hand'"),
