...
<html><head><META content='MSHTML 6.00.2900.2722' name=GENERATOR>
...
<script language='javascript' type='text/javascript' src='../model/DatePicker/WdatePicker.js'></script></head><html><head><SCRIPT src='../model/pagefun_Sc.js' type=text/javascript></script></head><SCRIPT type=text/javascript>top.document.title="研砼 -  模拟已出订单列表";</script><body onkeydown='unUseKey()' oncontextmenu='event.returnValue=false' onhelp='return false;'>
...
Item NO.: <br /><input name="ItemNO" id="ItemNO" type="text"  value="<?php  echo $eCode  ?>"  />(*表示使用自动生成)
      ...
      <td width="287">Menge/
Quantity: <br /><input name="QuantityNo" id="QuantityNo" type="text"  value="*" />(*表示使用自动生成)</td>
    </tr>
    <tr>
      <td height="166">Auftrags-Nr./PO No.: <br /><input name="PoNo" id="PoNo" type="text"  value="<?php  echo $OrderPO  ?> "/>
      (*表示使用自动生成)</td>
      <td>Karton-Nr./Carton No.: <br /><input name="CartonNo" id="CartonNo" type="text"  value="*" />(*表示使用自动生成)</td>
    </tr>

    <tr>
      <td height="49" colspan="2" align="center"><input type="submit" name="button" id="button" value="提交" /></td>
    </tr>
  </table>
