...
$pdf->SetFont('Arial','B',$TableFontSize);
	if($iTableList!=""){
		...
		<tr bgcolor=#CCCCCC repeat>
			...
			<td width=94 align=center valign=middle style=bold>Item</td>
			<td width=22 align=center valign=middle style=bold>Q'ty</td>
			<td width=25 align=center valign=middle style=bold>Unit</td>
			<td width=28 align=center valign=middle style=bold>Amount</td>
		</tr>".$iTableList."
		<tr bgcolor=#CCCCCC>
