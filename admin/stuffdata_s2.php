...
$Parameter.=",Bid,$Bid,mStuffId,$mStuffId";
//步骤3：需处理
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate"></TD>
                ...
                <TR>
                  ...
                  <TD><select name=value[] id="value[]" style="width: 274px;">				  
					...
					$checkStaff ="SELECT P.Number,P.Name FROM $DataPublic.staffmain P WHERE P.Estate=1 and P.JobId=3 $BuyerIdSTR ORDER BY P.Number";
