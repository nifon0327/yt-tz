...
//步骤2：
ChangeWtitle("$SubCompany 半成品需求单更新");//需处理
	...
	if(TableTemp==ListTable){	//新增需求单列表
		...
		if (message==true){
			...
			if(delRemark!=""){ 
				...
				myurl="semifinished_order_updated.php?StockId="+delStockId+"&ActionId=delStuff&StockRemark="+delRemark;
				var delinfo="";
...
function CheckForm(){
	...
	document.form1.action="semifinished_order_updated.php?ActionId=23";
