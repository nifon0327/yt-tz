...
$mainResult = mysql_query("SELECT M.CompanyId,M.InvoiceNO,M.Wise,M.Notes,M.Terms,M.PaymentTerm,M.Date,U.Symbol,I.Company,I.Fax,I.Address,D.InvoiceModel,D.SoldTo,D.Address AS ToAddress,D.FaxNo,D.SoldFrom,D.FromAddress,
...
if($mainRows = mysql_fetch_array($mainResult)){
	...
	$ModelId=$mainRows["ModelId"];  //ModelId=482
...
$Total=0;
//$Id='184';
$sheetResult = mysql_query("SELECT S.Id,S.POrderId,O.OrderPO,P.cName,P.eCode,P.Description,S.Qty,P.OutPrice as Price,S.Type,S.YandN 
...
$plResult = mysql_query("SELECT L.BoxRow,L.BoxPcs,L.BoxQty,L.FullQty,L.WG,L.POrderId,L.BoxSpec,e.OrderPO,e.eCode,e.BoxCode 
