...
//步骤2：
$Log_Item="退货记录";		//需处理
$upDataSheet="$DataIn.product_returned";	//需处理
$Log_Funtion="更新";
...
switch($ActionId){
	...
	default:
		//不做更新动作
		//$SetStr="Name='$Name',Dx='$Dx',Shbz='$Shbz',Zsbz='$Zsbz',Manager='$Manager',TypeId='$TypeId',SortId='$SortId',Date='$DateTime',Operator='$Operator',Locks='0'";
