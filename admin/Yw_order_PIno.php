...
//$ThisMonth=date("Y-m");
 $Temptoday=date("Y-m-d");
	$SearchRows.=" AND ( left(PI.Leadtime,3)!='201'  OR PI.Leadtime IS NULL )";	
if($From!="slist"){
				...
				$ValueArray=array(
                   ...
                   array(0=>$dcRemark, 		1=>"align='center'",2=>"onmousedown='window.event.cancelBubble=true;' onclick='updateJq($i,18,$POrderId,8)' style='CURSOR: pointer'", 3=>"..."),
                    ...
                    array(0=>$wl_cycle,			1=>"align='center'"),
					 ...
					 array(0=>$Leadtime,			1=>"align='center'", 2=>"onmousedown='window.event.cancelBubble=true;' onclick='updateJq($i,24,\"$PIoId\",4)'",3=>"..."),
...
ChangeWtitle($SubCompany.$DefaultClient."PI未传列表");
