<?php   
		...
		$pdf->Text($CurMargin+3,13,"$OutCompanyName");  // modify by zx 2011-0129  $pdf->Text($CurMargin+3,18,"$E_Company");  
		...
		*/
		...
		$pdf->SetTextColor(0,0,0);
		$pdf->Text($CurMargin+2,20,"Factory Add: $OutAddress ");  //  /modify by zx 2011-0129    $pdf->Text($CurMargin+2,29,"$E_Address $E_ZIP");    7F,Chen Tian Dongfang Dasha
		
		$pdf->Text($CurMargin+2,24,"Tel:    $OutTel    Fax:    $OutFax     URL:   $OutURL ");	//  /modify by zx 2011-0129$pdf->Text($CurMargin+2,33,"Tel:    $E_Tel    Fax:    $E_Fax     URL:   $E_WebSite");
		...
		$pdf->SetFont('Arial','',$TableFontSize); //设回字体大小
		{
			...
			<tr><td width=16 align=left  valign=middle style=bold >SOLD TO:</td><td width=76   align=left height=$RowsHight valign=middle >$SoldFrom,</td><tr>	
			<tr><td width=16></td><td width=76   align=left valign=middle >$FromAddress.</td><tr>	
		...
		//SHIP TO
		{
			...
			<tr><td width=16 align=left style=bold ></td><td width=76   align=left valign=middle >$Address.</td><tr>			
			</table>" ;//$eurTableList;
		}
