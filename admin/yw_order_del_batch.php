...
//if($POrderId!=""){
$logInfoArray = array();
//var_dump($POrderIdArray);die;
foreach (  $POrderIdArray as $POrderId){
...
$IN_res=@mysql_query($IN_recode);
    ...
    $logInfo['Log_Item']=$Log_Item;
    $logInfo['Log_Funtion']=$Log_Funtion;
    $logInfo['Log']=$Log;
    $logInfo['OperationResult']=$OperationResult;
    $logInfo['Operator']=$Operator;
    $logInfo['Login_P_Number']=$Login_P_Number;
    $logInfoArray[]=$logInfo;
    $Log='';
}
//var_dump($logInfoArray);
include "../model/logpage_batch.php";
