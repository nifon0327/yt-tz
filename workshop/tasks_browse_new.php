...
function autoPlay(){
      ...
      if (playPage==2){
       ...
       var url="tasks_read_new.php?Line="+Line+"&Align="+Align;
       //alert(url);
       try {
                var ajax=InitAjax();
                ...
                ajax.onreadystatechange =function(){
                    if(ajax.readyState==4){
                               ...
                               if (ajax.responseText.length>100 && ajax.responseText.indexOf(" <input type='hidden' ")==0){
                                     //alert((ajax.responseText);
