...
<section id='Section1'>
    <?php  
        include "ck_qc_read_new.php"; 
     ?>
</section>
 <input type='hidden' id='Floor' name='Floor' value='<?php echo $Floor;?>'>
 <input type='hidden' id='sceen' name='sceen' value='<?php echo $sceen;?>'>
...
function autoPlay(){
      ...
      var sceen=document.getElementById("sceen").value;
       var url="ck_qc_read_new.php?Floor="+Floor+'&sceen='+sceen;
       var ajax=InitAjax();
