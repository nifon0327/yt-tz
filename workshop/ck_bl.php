...
<section id='Section1'>
    ...
    <?php  
         $TestSign="new";$Line=1;
         include "ck_bl_read.php";
     ?>
</section>
 <input type='hidden' id='Floor' name='Floor' value='<?php echo $Floor;?>'>
 <input type='hidden' id='Line1' name='Line1' value='1'>
 <section id='Section2'>
    <!-- This is the first slide -->
    <?php  
        // include "ck_bl_read.php";
...
<input type='hidden' id='Line2' name='Line2' value='2'>
...
function autoPlay(){
	  ...
	  if (playPage==2){
	   ...
	   var url="ck_bl_read.php?Floor="+Floor+"&Line="+Line+"&TestSign=new";
        var ajax=InitAjax();
