...
function autoPlay(){
	   ...
	   var url="tasks_image_read.php?Line="+Line+"&Floor="+Floor+"&OProductId="+ProductId+"&OPOrderId="+POrderId;
	   //alert(url);
       var ajax=InitAjax();
            ...
            if(ajax.readyState==4){
                   if (ajax.responseText.length>100){
                      document.getElementById(SectionName).innerHTML=ajax.responseText;
                        ...
                        var arrText=ajax.responseText.split("|");
	                     if (arrText.length==2){
	                        document.getElementById("upTimeDiv").innerHTML=arrText[0];
	                        document.getElementById("Qty1").innerHTML=arrText[1];
	                     }
                    }
               }
         }
