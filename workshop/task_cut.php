...
<section id='Section1'>
    <?php  
        include "task_cut_read.php"; 
     ?>
</section>
 <input type='hidden' id='Floor' name='Floor' value='<?php echo $Floor;?>'>
 <input type='hidden' id='scLine' name='scLine' value='<?php echo $scLine;?>'>
...
function autoPlay(){
       ...
       var scLine=document.getElementById("scLine").value;
       var url="task_cut_read.php?Floor="+Floor+'&scLine='+scLine;
       var ajax=InitAjax();
