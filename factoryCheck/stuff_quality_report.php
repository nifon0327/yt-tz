...
include "../model/subprogram/modelfunction.php";
...
$mySql="SELECT S.Id,S.Date,S.StuffId,S.StockId,SUM(S.shQty) AS shQty,SUM(S.checkQty) AS checkQty,SUM(S.Qty) AS Qty,S.AQL,D.StuffCname,D.Picture,D.CheckSign,P.Company,A.Name AS  Operator, A.Number
    ...
    WHERE $SearchRows  GROUP BY S.Date ORDER BY S.Date DESC";  //GROUP BY S.Date ORDER BY S.Date DESC
$j=1;
