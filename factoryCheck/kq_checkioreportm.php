<?php
    ...
    // if($needSign != 'no'){
    //     $signStr =  "AND M.cSign='$Login_cSign'";
    // }
    ...
    if($needSign == 'no'){
        ...
        $CheckStaffSql = "SELECT A.Number,A.Name,A.JobName FROM (
                            ...
                            FROM $DataPublic.staffmain M
                            LEFT JOIN d7check.fakecheckinout C ON  M.Number=C.Number
                            LEFT JOIN $DataPublic.jobdata J ON J.Id=M.JobId
                            LEFT JOIN $DataIn.staffgroup G ON G.GroupId=M.GroupId 
                            WHERE C.CheckTime LIKE '$CheckMonth%' AND (C.BranchId IN (6, 7, 8, 5) OR C.JobId in (10, 35)) AND M.cSign='7' $KqSignStr
                            GROUP BY C.Number 
                            UNION ALL 
                            SELECT M.Number,M.Name,J.Name AS JobName,M.BranchId,M.JobId  
                            FROM $DataPublic.staffmain M
                            ...
                            LEFT JOIN $DataPublic.jobdata J ON J.Id=M.JobId
                            LEFT JOIN $DataIn.staffgroup G ON G.GroupId=M.GroupId 
                            WHERE (Q.StartDate  LIKE '$CheckMonth%'  OR Q.EndDate  LIKE '$CheckMonth%'  OR  (Q.StartDate<'$CheckMonth-01'  AND Q.EndDate>'$CheckMonth-01')) AND (M.BranchId IN ( 6, 7, 8, 5) OR M.JobId = 10) $KqSignStr AND M.cSign='7'
    ...
    $checkSql = mysql_query("SELECT Id FROM $d7check.kqdataother WHERE 1 and Number=$Number and Month='$CheckMonth' ORDER BY Id LIMIT 1",$link_id);
    ...
    <td class='A0101'>".$totleStatistic["defaultWorkHours"]."<input name='Dhours' type='hidden' id='Dhours' value='".isZero($totleStatistic["defaultWorkHours"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["workHours"]."<input name='Whours' type='hidden' id='Whours' value='".isZero($totleStatistic["workHours"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic['workdayOt']."<input name='Ghours' type='hidden' id='Ghours' value='".isZero($totleStatistic['workdayOt'])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic['weekdayOt']."<input name='Xhours' type='hidden' id='Xhours' value='".isZero($totleStatistic['weekdayOt'])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic['holidayOt']."<input name='Fhours' type='hidden' id='Fhours' value='".isZero($totleStatistic['holidayOt'])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["beLate"]."<input name='InLates' type='hidden' id='InLates' value='".isZero($totleStatistic["beLate"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["beEarly"]."<input name='OutEarlys' type='hidden' id='OutEarlys' value='".isZero($totleStatistic["beEarly"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["personalLeave"]."<input name='SJhours' type='hidden' id='SJhours' value='".isZero($totleStatistic["personalLeave"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["sickLeave"]."<input name='BJhours' type='hidden' id='BJhours' value='".isZero($totleStatistic["sickLeave"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["noPayLeave"]."<input name='WXJhours' type='hidden' id='WXJhours' value='".isZero($totleStatistic["noPayLeave"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["annualLeave"]."<input name='YXJhours' type='hidden' id='YXJhours' value='".isZero($totleStatistic["annualLeave"])."'>&nbsp;</td>
    ...
    <td class='A0101'>".$totleStatistic["lackWorkHours"]."<input name='QQhours' type='hidden' id='QQhours' value='".isZero($totleStatistic["lackWorkHours"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["kgHours"]."<input name='KGhours' type='hidden' id='KGhours' value='".isZero($totleStatistic["kgHours"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["noPayHours"]."<input name='WXhours' type='hidden' id='WXhours' value='".isZero($totleStatistic["noPayHours"])."'>&nbsp;</td>
    <td class='A0101'>".$totleStatistic["dkHours"]."<input name='dkhours' type='hidden' id='dkhours' value='".isZero($totleStatistic["dkHours"])."'>&nbsp;</td>
    </tr>";
