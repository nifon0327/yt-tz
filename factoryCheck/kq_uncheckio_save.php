...
$inRecode = "INSERT INTO d7check.fakecheckinout 
SELECT NULL,BranchId,JobId,Number,'$CheckTime','$CheckType','-1', '0','1','1','0','$KrSign', NULL,'$Operator' FROM $DataPublic.staffmain WHERE 1 $NumberSTR 
