...
//日期时间
var DateStr=setInterval("rq.innerHTML=new Date().toLocaleString()+'  &nbsp;星期'+'日一二三四五六'.charAt(new Date().getDay());mainInfo.innerHTML=new Date().toLocaleString().substring(11,20);",1000);
-->
</script>
...
<div id="container0">
	<div id="container1">
		<div id="content">
			...
			<div id="tq">
				<div id="wnmain"><iframe src="../wnlDate/wn.php" id="wnDateFrm" name="wnDateFrm"  frameborder="0" width="100%" height="520" margwidth="0" margheight="0" scrolling="no" allowTransparency="true"></iframe></div>
			</div>
		...
		<div id="TodayLog">
		<div class="content" style="width:200;height:700;overflow-x:hidden;overflow-y:scroll;float:right;">
