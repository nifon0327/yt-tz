...
//步骤2：
ChangeWtitle("$SubCompany 临时排班记录查询");			//需处理
...
<TR>
                  <TD align="right">临时班日期
                      <input name="Field[]" type="hidden" id="Field[]" value="InTime">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <option value="LIKE" selected>包含</option>
...
至
  ...
  <input name="types[]" type="hidden" id="types[]" value="isDate">
                  ...
                  <TD align="right">设迟到时间
                      <input name="Field[]" type="hidden" id="Field[]" value="InLate">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                      <OPTION value== 
          ...
          value="<=">&lt;=</OPTION>
                ...
                <TR>
                  <TD align="right">设早退时间
                      <input name="Field[]" type="hidden" id="Field[]" value="OutEarly">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <OPTION value== 
...
<TR>
                  <TD align="right">中途休息时间
                      <input name="Field[]" type="hidden" id="Field[]" value="RestTime">
                  </TD>
                  <TD align="center">
                    <SELECT name=fun[] id="fun[]" style="width: 60px;">
                        <OPTION value== 
...
<TR>
                  <TD align="right">临时班类别
                      <input name="Field[]" type="hidden" id="Field[]" value="TimeType">
                  </TD>
                  <TD align="center">
				    <select name="fun[]" id="fun[]" style="width: 60px;">
			          <option value="=">=</option>
