...
//步骤2：
ChangeWtitle("$SubCompany 更新公积金资料");//需处理
...
FROM $DataPublic.epfdata S,$DataPublic.staffmain M WHERE 
	...
	<table width="700" border="0" align="center" cellspacing="5">
        <tr>
          ...
          <tr>
           ...
           <tr>
            <td align="right" scope="col">公积金分类</td>
			...
			?>
              ...
              <tr>
            <td align="right" scope="col">缴费起始月份</td>
          ...
          <tr>
            <td align="right" valign="top">缴费结束月份</td>
            <td>
