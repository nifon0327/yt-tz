...
if($DataIn !== 'ac'){
	...
	$inRecode = "INSERT INTO $DataPublic.redeployj SELECT NULL,Number,'$JobId','$ActionIn','$Month','$Remark','$Date','0','$Operator', 1, 0, '$Operator', NOW(), '$Operator', NOW() FROM $DataPublic.staffmain WHERE 1 $NumberSTR ";
}
