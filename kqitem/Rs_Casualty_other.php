    ...
    <td class="A0100">&nbsp;</td>
      <td height="27"  align="left" class="A0100">
          将月份为:
            ...
            的意外险替换姓名为<input name="NewName" type="text" id="NewName" onclick="SearchData('<?php  echo $funFrom?>',1,10,2)" size="15" readonly>的意外险&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" name="Submit" value="开始替换" onClick="CheckForm()">
      </td>
    </tr>
