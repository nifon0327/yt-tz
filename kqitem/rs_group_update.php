	...
	<tr><td class="A0011">
      <table width="760" border="0" align="center" cellspacing="5">
		<tr>
            ...
            <td scope="col"><?php 
			$checkRow = mysql_fetch_array(mysql_query("SELECT TypeId,Name FROM $DataPublic.branchdata WHERE Id='$BranchId' AND Estate=1 AND (cSign=$Login_cSign OR cSign=0 ) ORDER BY Id",$link_id));
			echo $checkRow["Name"];
			?>
			</td>
		</tr>
