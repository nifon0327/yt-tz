...
$mySql="SELECT 
	...
	S.Id,S.Mid,S.Number,S.Month,S.Amount,S.Date,S.Estate,S.Locks,P.Name,B.Title,S.Remark,BD.Name AS BranchName,J.Name AS JobName,S.Attached,S.HostpitalInvoice  
	FROM $mainData M
