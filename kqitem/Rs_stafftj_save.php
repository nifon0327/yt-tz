...
if($_POST['ListId']){//如果指定了操作对象
	...
	for($i=0;$i<$Counts;$i++){
         ...
         $inRecode ="INSERT INTO $DataIn.cw17_tjsheet(Id, Mid,tjType,CheckT,Number,Month,Amount,Remark,Attached,HG,tjDate,Date,Estate,Locks,Operator)VALUES(NULL,0,'$tjType','$CheckTime','$thisId','$Month','$Amount','$Remark','$Attached','$HG','$tjDate','$Date',1,0,'$Operator')";
