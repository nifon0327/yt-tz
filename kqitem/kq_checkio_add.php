...
while(odbc_fetch_row($result)){
	...
	if($CHECKTIME>$LastTime){
		...
		if($CheckSignRow=mysql_fetch_array($CheckSignSql)){
			$IN_recode="INSERT INTO $DataIn.checkinout (Id,USERID,Number,CheckTime,CheckType,dFrom,Estate,Locks,ZlSign,KrSign,Operator) VALUES (NULL,'$USERID','$NUMBER','$CHECKTIME','$CHECKTYPE','0','1','1','0','0','$Operator')";
