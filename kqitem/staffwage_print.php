...
echo"<table border='0' width='$tableWidth' cellpadding='0' cellspacing='0'style='TABLE-LAYOUT: fixed; WORD-WRAP: break-word' bgcolor='#FFFFFF'><tr height='25'>";
	echo"<td class='A0111' align='center' width='230' bgcolor=$Title_bgcolor>合 计</td>";
	echo"<td class='A0101' align='center' width='40'>$sumDx</td>";
	echo"<td class='A0101' align='center' width='40'>$sumJbf</td>";
	echo"<td class='A0101' align='center' width='40'>$sumGljt</td>";
	echo"<td class='A0101' align='center' width='40'>$sumGwjt</td>";
	echo"<td class='A0101' align='center' width='40'>$sumJj</td>";
	echo"<td class='A0101' align='center' width='40'>$sumShbz</td>";
	echo"<td class='A0101' align='center' width='40'>$sumZsbz</td>";
	echo"<td class='A0101' align='center' width='40'>$sumJtbz</td>";
	echo"<td class='A0101' align='center' width='40'>$sumYxbz</td>";
	echo"<td class='A0101' align='center' width='40'>$sumtaxbz</td>";	
	echo"<td class='A0101' align='center' width='40'>$sumKqkk</td>";
