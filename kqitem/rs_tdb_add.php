...
//步骤2：
ChangeWtitle("$SubCompany 新增部门调动记录");//需处理
...
<tr>
	  ...
	  <tr>
	 		<td height="4" align="right" scope="col">2、调出部门</td>
	 		<td valign="middle" scope="col">
			<select name="BranchId" id="BranchId" style="width:430px" onchange="ClearList('ListId')">
			<?php 
	  ...
	  <tr>
	    <td height="9" align="right" scope="col">3、调入部门</td>
	    <td valign="middle" scope="col"><select name="ActionIn" id="ActionIn" style="width:430px" datatype="unSame" toid="BranchId" msg="调入与调出部门不能相同">
          <?php 
			$inResult=mysql_query("SELECT Id,Name FROM $DataPublic.branchdata 
