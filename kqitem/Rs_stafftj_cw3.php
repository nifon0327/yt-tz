...
if($From!="slist"){
	//结付状态	
	$SearchRows="";
	$monthResult = mysql_query("SELECT S.Date FROM $DataIn.cw17_tjsheet S WHERE 1 AND S.Estate='$Estate' group by DATE_FORMAT(S.Date,'%Y-%m') order by S.Date DESC",$link_id);
