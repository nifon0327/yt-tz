...
if (($myRow = @mysql_fetch_array($cursor)) && $myRow['Forshort'] != null) {
    ...
    $button_value = '<button type="submit" class="weui-form-preview__btn weui-form-preview__btn_primary" style="background-color: #990000;color;#fff" onclick="reg(2)">不合格</button><button type="submit" class="weui-form-preview__btn weui-form-preview__btn_primary" style="background-color: #006633;color;#fff" onclick="reg(1)">合格</button>
';
