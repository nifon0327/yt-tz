      ...
      addStackCode: function(stackNo){
        if(regexpat.test(stackNo) == false) {
          ...
          SERVICE.sendSHR(serviceUrl,{action:'getListByStackId',stackNo:stackNo}, function(oData){
            // POP.ShowAlert("垛号正确","确定", function(){
            //   window.location.href = './stack.php?stackId=' + oData.result.stackInfo.StackNo + '&stackNo=' +oData.result.stackInfo.StackNo + '&seatId=' + oData.result.stackInfo.SeatId
            // })
            console.log(oData)
            window.location.href = './stack.php?stackId=' + oData.result.stackInfo.StackNo + '&stackNo=' + oData.result.stackInfo.StackNo + '&seatId=' + oData.result.stackInfo.SeatId + '&random=' + 1000*Math.random();
