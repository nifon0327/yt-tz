...
<body>
    ...
    <div class="row">
        <div id="items" class="col-12 col-lg-3 form-group">
            <label for="reworkdate">返修日期</label>
    ...
    <div class="row">
        <div id="items" class="col-12 col-lg-3 form-group">
            <label for="reworkcompany">产线选择</label>
    ...
    <div id="items" class="row form-group">
        <div class="col-6 col-lg-6">
            <label for="reworkreason">返修原因</label>
...
(function($, POP, SERVICE, undefined){
    ...
    var uploadfileUrl = '<?php $_SERVER['HTTP_HOST']?>/weixin/fanxiuconfirm/controller/upload.php'
    ...
    var module = {
        ...
        bind: function() {
            ...
            _self.doms.save.click(function() {
                ...
                SERVICE.sendSHR(serviceUrl, {action: 'createReworkProduct', companyId:companyId, buildNo:buildId, orderPO:floorId, typeId: productType,productId:ProductID,
                                             reworkDate:reworkDate, workshopId:currreworkcompany,headerId:curroperator,invoicePath:ipath,reworkAnalysis:currreworkreason, pOrderId:currproductionname}, function(data){
                    if(data.result == true){
                        POP.ShowAlert("新增返修构件成功")
                        window.location.href = '<?php $_SERVER['HTTP_HOST']?>/weixin/fanxiuconfirm/view/back.php'
                    }
                    else
                    {
                        POP.ShowAlert("新增返修构件失败")
                    }
                })
            });
