<?php
	...
	class CheckAvatar extends StaffPrototype
	{
		...
		public function insertCheckTime($type, $DataIn, $DataPublic, $link_id){
			...
			$inRecode="INSERT INTO $DataIn.checkinout (Id,Number ,CheckTime,CheckType,dFrom, dFromId,Estate,Locks,ZlSign,KrSign,Operator,BranchId,JobId) 
VALUES (NULL,'".$this->getStaffNumber()."','$insetTime','$type','".$this->dForm."','".$this->dFromId."','1','1','0','".$this->KrSign."','0','".$this->branchId."','".$this->jobId."')";
