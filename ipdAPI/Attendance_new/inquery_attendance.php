<?php
    ...
    for($i=0;$i<$Days;$i++){
        ...
        $workDayOverTime = ($dayAttendanceInfomation["workOtHours"] == "0")?"":$dayAttendanceInfomation["workOtHours"];
        $weekDayOverTime = ($dayAttendanceInfomation["weekOtTime"] == "0")?"":$dayAttendanceInfomation["weekOtTime"];
        $holidayOverTime ="";
