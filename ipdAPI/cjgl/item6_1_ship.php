  ...
  <table width="560" height="100" border="0" cellpadding="0" cellspacing="0" bgcolor="#d6efb5">
    ...
    <tr>
      ...
      <td align="left">
          ...
          ?>
        &nbsp;&nbsp;&nbsp;&nbsp;<input name="InvoiceNO" type="text" id="InvoiceNO" value="<?php echo $NewInvoiceNO ?>" size="30" style="height:30px;font-size:15;"/><input type="hidden" id="CompanyId" name="CompanyId" value="<?php echo $CompanyId ?>"/><input type="hidden" id="IdArray" name="IdArray" value="<?php echo $tempIdArray ?>"/>
      </td>
    </tr>
    <tr>
      <td height="40" align="right">出货日期&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<input name="ShipDate" type="text" id="ShipDate" value="<?php echo date("Y-m-d") ?>" size="30" style="height:30px;font-size:15;" onfocus="WdatePicker()" dataType="Date" format="ymd" msg="日期不正确" readonly>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<input name="Wise" type="text" id="Wise" size="30" style="height:30px;font-size:15;">&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="ShipType" type="checkbox" id="ShipType" style="zoom:150%;position:relative;top:3px;">&nbsp;&nbsp;补货单
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="Notes" cols="44" rows="3" id="Notes"></textarea>
      </td>
    </tr>
    <tr>
      <td height="70" align="right">Terms&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="Terms" cols="44" rows="3" id="Terms"></textarea>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left" valign="middle">
        &nbsp;&nbsp;&nbsp;&nbsp;<input name="PaymentTerm" type="text" id="PaymentTerm" size="30" style="height:30px;font-size:15;">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left"> &nbsp;&nbsp;&nbsp;&nbsp;<select name='BankId' id='BankId' style='width:234px;height:30px;' dataType='Require' msg='未选择'>
              <?php
              $bankResult = mysql_query("SELECT Id,Title FROM $DataPublic.my2_bankinfo WHERE Locks=0", $link_id);
    ...
    <tr>
      ...
      <td height="50" align="left">
        <input type='button' id='updateBtn' value='更新' onclick="createShipList();" style="width:80px;height:27px;font-size:15;"/>
      </td>
    </tr>
  </table>
</form>